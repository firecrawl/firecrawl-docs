...
Por padrão, um monitor de página faz o diff do markdown da página. Para alertar apenas quando um **campo específico** mudar — um preço, uma manchete, um indicador de estoque, os itens de uma lista — adicione o formato `changeTracking` a `scrapeOptions` do target. Consulte [Rastreamento de mudanças](/pt-BR/features/monitoring#change-tracking) para o modo JSON e o modo misto.
