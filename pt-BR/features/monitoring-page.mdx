...
Esta página aborda o alvo `scrape`. Agendamento, objetivos e avaliação, rastreamento de mudanças, notificações e preços são compartilhados entre todos os tipos de monitoramento. Consulte a [visão geral do monitoramento](/pt-BR/features/monitoring).
