...
## Escolha o modelo de interação certo {#choose-the-right-interaction-model}
...
## Interaja usando prompts {#interact-via-prompting}
...
### Mantenha os Prompts Pequenos e Focados {#keep-prompts-small-and-focused}
...
## Executando código {#running-code}
...
## Visualização em tempo real {#live-view}
...
### Visualização em tempo real interativa {#interactive-live-view}
...
## Perfis persistentes com Scrape + Interagir {#persistent-profiles-with-scrape-interact}
...
### Validar a persistência {#validate-persistence}
...
## Quando usar o quê {#when-to-use-what}
...
### Corpo da Requisição (POST) {#request-body-post}
