...
<div id="common-maxage-values">
  ## Valores comuns de maxAge {#common-maxage-values}
</div>
...
### Quando o cache é ignorado {#when-caching-is-bypassed}
...
### Correspondência para acerto de cache {#cache-hit-matching}
