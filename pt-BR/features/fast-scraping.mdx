...
description: "Acelere suas raspagens em significantly com o parâmetro maxAge"
og:title: "Raspagem mais rápida | Firecrawl"
og:description: "Acelere suas raspagens em significantly com o parâmetro maxAge"
---
...
Obtenha seus resultados **até significantly mais rápido** quando você não precisar dos dados absolutamente mais atuais. Controle a frescura via `maxAge`:
...
- **Tempos de resposta significantly mais rápidos** para conteúdo recente
...
Ao rastrear com `maxAge`, cada página do seu rastreamento aproveitará a melhoria de velocidade de significantly se tivermos dados recentes em cache para essa página.
