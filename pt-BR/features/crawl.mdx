---
title: 'Crawlear'
description: 'Rastreie recursivamente um site e extraia o conteúdo de cada página'
og:title: 'Crawlear | Firecrawl'
og:description: 'Rastreie recursivamente um site e extraia o conteúdo de cada página'
icon: 'spider'
---
...
Todas as opções do [endpoint Scrape](/pt-BR/api-reference/endpoint/scrape) estão disponíveis no crawl via `scrapeOptions` (JS) / `scrape_options` (Python). Elas se aplicam a cada página que o crawler coleta, incluindo formatos, proxy, cache, ações, localização e tags.
