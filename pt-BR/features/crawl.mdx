...
<div id="response-handling">
  ### Tratamento de respostas {#response-handling}
</div>
...
<div id="crawl-and-wait">
  ### Crawl e aguarde {#crawl-and-wait}
</div>
...
<div id="start-and-check-later">
  ### Inicie e verifique depois {#start-and-check-later}
</div>
...
<div id="real-time-results-with-websocket">
  ## Resultados em tempo real com WebSocket {#real-time-results-with-websocket}
</div>
...
<div id="verifying-webhook-signatures">
  ### Verificando assinaturas de webhook {#verifying-webhook-signatures}
</div>
...
## Execução e contabilização de resultados {#execution-and-result-accounting}
...
### Lendo os contadores de status {#reading-the-status-counters}
...
### Paginando os resultados {#paging-through-results}
...
### Páginas com falha e bloqueadas {#failed-and-blocked-pages}
...
### O alcance do crawler {#what-the-crawler-is-scoped-to-reach}
...
### Quando os resultados variam entre execuções {#when-results-vary-between-runs}
...
### Como saber quando um rastreamento terminou {#knowing-when-a-crawl-is-done}
