...
Agora você pode escolher em quais formatos deseja o resultado. É possível especificar vários formatos de saída. Os formatos compatíveis são:
...
- Imagens (`images`) — extrai todas as URLs de imagens da página
...
Para mais detalhes sobre as localizações compatíveis, consulte a [documentação de proxies](/features/proxies).
...
Saiba mais sobre o [modo stealth](/features/stealth-mode).