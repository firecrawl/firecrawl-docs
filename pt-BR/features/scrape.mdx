...
<div id="scraping-a-url-with-firecrawl">
  ## Extraindo dados de uma URL com o Firecrawl {#scraping-a-url-with-firecrawl}
</div>

<div id="scrape-endpoint">
  ### endpoint /scrape {#scrape-endpoint}
</div>
...
### Metadados da resposta e códigos de status {#response-metadata-and-status-codes}
...
## Formatos de Scraping {#scrape-formats}
...
<div id="extract-structured-data">
  ## Extraia dados estruturados {#extract-structured-data}
</div>

### endpoint /scrape (com json) {#scrape-with-json-endpoint}
...
<div id="json-format-options">
  ### Opções do formato JSON {#json-format-options}
</div>
...
<div id="extract-brand-identity">
  ## Extrair identidade de marca {#extract-brand-identity}
</div>

<div id="scrape-with-branding-endpoint">
  ### endpoint /scrape (com branding) {#scrape-with-branding-endpoint}
</div>
...
<div id="branding-profile-structure">
  ### Estrutura do Perfil de Branding {#branding-profile-structure}
</div>
...
<div id="combining-with-other-formats">
  ### Combinando com outros formatos {#combining-with-other-formats}
</div>
...
## Extrair dados de produtos {#extract-product-data}
...
### endpoint /scrape (com dados de produto) {#scrape-with-product-endpoint}
...
### Estrutura do objeto `product` {#product-object-structure}
...
### Como a extração de produtos funciona {#how-product-extraction-works}
...
### Combinando com outros formatos {#combining-with-other-formats-2}
...
<div id="audio-extraction">
  ## Extração de áudio {#audio-extraction}
</div>
...
<div id="video-extraction">
  ## Extração de vídeo {#video-extraction}
</div>
...
<div id="question-format">
  ## Formato de pergunta {#question-format}
</div>
...
<div id="highlights-format">
  ## Formato highlights {#highlights-format}
</div>
...
## Ocultação de PII {#pii-redaction}
...
<div id="interacting-with-the-page-with-actions">
  ## Interagindo com a página com ações {#interacting-with-the-page-with-actions}
</div>
...
<div id="location-and-language">
  ## Localização e idioma {#location-and-language}
</div>
...
## Cache e maxAge {#caching-and-maxage}
...
### Frescor e status do item {#freshness-and-item-status}
...
<div id="batch-scraping-multiple-urls">
  ## Scraping em lote de várias URLs {#batch-scraping-multiple-urls}
</div>
...
<div id="zero-data-retention-zdr">
  ## Retenção zero de dados (ZDR) {#zero-data-retention-zdr}
</div>
