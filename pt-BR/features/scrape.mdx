...
Para sites complexos, o Firecrawl oferece um enhanced mode que aumenta as taxas de sucesso ao mesmo tempo em que preserva a privacidade.

Saiba mais sobre o [enhanced mode](/pt-BR/features/enhanced-mode).