...
## Controles da política {#policy-controls}
...
### Conecte seu tenant {#connecting-your-tenant}
...
### Capacidade e comportamento {#capacity-and-behavior}
...
## Configurando a política {#configuring-the-policy}
...
## Substituições por requisição {#per-request-overrides}
...
## Quando uma URL é bloqueada {#when-a-url-is-blocked}
