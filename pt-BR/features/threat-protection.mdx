...
| Status | Quando                                                                                                                        |
| ------ | ----------------------------------------------------------------------------------------------------------------------------- |
| `403`  | Uma solicitação visa um domínio bloqueado pela política (`code: unsafe_domain_blocked`).                                      |
| `403`  | Uma solicitação inclui uma sobrescrita de `threatProtection` enquanto as sobrescritas estão desabilitadas para a organização. |
