...
Oferecemos 5 execuções diárias gratuitas. Enquanto estiver em Research Preview, a cobrança é dinâmica e baseada na quantidade de tokens usados pelo `/agent`. Isso é convertido em créditos. Experimente [aqui](/pt-BR/app/agent).