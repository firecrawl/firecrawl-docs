---
title: "Agente"
description: "Reúna dados em qualquer lugar da web. Descreva o que você quer, o /agent cuida do resto."
og:title: "Agente | Firecrawl"
og:description: "Reúna dados em qualquer lugar da web. Descreva o que você quer, o /agent cuida do resto."
icon: "magic"
sidebarTitle: "Agente"
---
...
Firecrawl `/agent` é uma API mágica que pesquisa, navega e faz scraping até mesmo dos sites mais complexos, encontrando dados em locais de difícil acesso e descobrindo dados em qualquer lugar da internet. Ele realiza em poucos minutos o que levaria muitas horas para um humano e torna o web scraping tradicional obsoleto.

**Basta descrever quais dados você quer e o `/agent` cuida do resto.**

<Warning>
  **Prévia de pesquisa**: Agent está em acesso antecipado (early access). Espere algumas imperfeições. Ele ficará significativamente melhor com o tempo. [Compartilhe feedback →](mailto:product@firecrawl.com)
</Warning>
...
O Firecrawl Agent usa **cobrança baseada no uso**, que acompanha a complexidade da sua solicitação de extração de dados. Você paga com base no trabalho efetivamente realizado pelo Agent, garantindo preços justos tanto ao extrair dados simples quanto informações estruturadas complexas de múltiplas fontes.

<div id="how-agent-pricing-works">
  ### Como funciona o preço do Agent
</div>

Os preços do Agent são **dinâmicos e baseados em tokens** durante o Research Preview:
...
* **Conversão de créditos** converte automaticamente o uso de tokens do Agent em créditos para facilitar a cobrança

<Info>
  O uso de tokens varia de acordo com a complexidade do seu prompt, a quantidade de dados processados e a estrutura do resultado solicitado.
</Info>
...
O uso adicional é cobrado com base no consumo de tokens e convertido em créditos. Cada crédito equivale a 15 créditos, em conformidade com outros endpoints do Firecrawl.
...
Teste o Agent agora em [firecrawl.dev/app/agent](/pt-BR/app/agent) para ver como o uso de tokens escala com seus casos de uso específicos.
