...
## Iniciar uma sessão {#launch-a-session}
...
### Como lidar com downloads de arquivos {#handling-file-downloads}
...
### Sessões persistentes {#persistent-sessions}
...
### Configuração de TTL {#ttl-configuration}
...
### Encerrar a sessão {#close-a-session}
...
### Visualização Interativa Ao Vivo {#interactive-live-view}
...
## Conectando-se ao CDP {#connecting-via-cdp}
...
## Quando usar o navegador {#when-to-use-browser}
