...
<Info>
  Browser Sandbox agora é [Interact](/pt-BR/features/interact), que oferece os mesmos recursos e também pode ser controlado por prompts.
</Info>
...
Para adicionar suporte de navegador a um agente de codificação com IA (Claude Code, Codex, Open Code, Cursor etc.), instale a skill do Firecrawl:
...
O número de sessões de navegador simultâneas permitidas é determinado pelo limite de concorrência do plano da sua equipe.
