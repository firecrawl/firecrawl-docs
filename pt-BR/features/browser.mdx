...
Por padrão, cada sessão do navegador começa em um estado limpo. Com `profile`, você pode salvar o estado do navegador entre sessões. Isso é útil para permanecer logado, preservar preferências ou retomar fluxos de trabalho com várias etapas.
