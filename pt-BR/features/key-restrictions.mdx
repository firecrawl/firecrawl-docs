...
## O que você pode restringir {#what-you-can-restrict}
...
## Configurando uma chave {#configuring-a-key}
...
## Restrições de formato {#format-restrictions}
...
### Ações que retornam conteúdo {#actions-that-return-content}
...
## Restrições de endpoint {#endpoint-restrictions}
