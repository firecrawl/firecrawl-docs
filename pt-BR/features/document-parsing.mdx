...
A Firecrawl atualmente oferece suporte aos seguintes formatos de documentos:
...
- **Documentos PDF** (`.pdf`)
  ...
  - Custa 1 crédito por página. Consulte a [tabela de preços](https://docs.firecrawl.dev/pricing) para mais detalhes.
