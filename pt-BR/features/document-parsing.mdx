...
## Formatos de documentos suportados {#supported-document-formats}
...
## Como usar a análise de documentos {#how-to-use-document-parsing}
...
### Faça upload de documentos com `/v2/parse` {#upload-documents-with-v2parse}
...
<div id="example-scraping-an-excel-file">
  ### Exemplo: Fazendo scraping de um arquivo Excel {#example-scraping-an-excel-file}
</div>

<ScrapeXLSX />

<div id="example-scraping-a-word-document">
  ### Exemplo: Extraindo um documento do Word {#example-scraping-a-word-document}
</div>
