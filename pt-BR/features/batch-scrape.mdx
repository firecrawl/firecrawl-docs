...
<div id='batch-scraping-multiple-urls'>## Coleta em lote de várias URLs</div>
...
<div id='batch-scrape-with-webhooks'>## Extração em lote com webhooks</div>
...
<Note>
  Para ver configurações detalhadas de webhooks, práticas recomendadas de
