...
<div id="crawl-with-change-tracking">
  ## Crawl com rastreio de mudanças {#crawl-with-change-tracking}
</div>
...
<div id="batch-scrape-with-change-tracking">
  ## Raspagem em lote com rastreamento de mudanças {#batch-scrape-with-change-tracking}
</div>
...
<div id="scheduling-change-tracking">
  ## Agendando o rastreio de mudanças {#scheduling-change-tracking}
</div>
...
<div id="cloud-and-serverless-schedulers">
  ### Agendadores em ambientes cloud e serverless {#cloud-and-serverless-schedulers}
</div>
