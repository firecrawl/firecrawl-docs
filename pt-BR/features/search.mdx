...
<div id="performing-a-search-with-firecrawl">
  ## Fazendo uma pesquisa com o Firecrawl {#performing-a-search-with-firecrawl}
</div>
...
<div id="search-result-types">
  ## Tipos de resultados de busca {#search-result-types}
</div>
...
## Categorias de busca {#search-categories}
...
### Pesquisa por categoria de pesquisa {#research-category-search}
...
### Busca na categoria Developer {#developer-category-search}
...
### Pesquisa com categorias mistas {#mixed-category-search}
...
<div id="include-domains">
  ### Incluir domínios {#include-domains}
</div>
...
<div id="exclude-domains">
  ### Domínios a excluir {#exclude-domains}
</div>
...
### Formato de resposta de categoria {#category-response-format}
...
<div id="hd-image-search-with-size-filtering">
  ### Pesquisa de imagens em alta definição com filtro por tamanho {#hd-image-search-with-size-filtering}
</div>
...
<div id="search-with-content-scraping">
  ## Busca com Coleta de Conteúdo {#search-with-content-scraping}
</div>
...
<div id="response-with-scraped-content">
  ### Resposta com conteúdo extraído {#response-with-scraped-content}
</div>
...
<div id="search-then-scrape-two-step-pattern">
  ## Buscar e depois fazer scraping (padrão de duas etapas) {#search-then-scrape-two-step-pattern}
</div>
...
### Busca por período {#time-based-search}
...
### Tempo limite personalizado {#custom-timeout}
...
<div id="end-to-end-zdr">
  ### ZDR de ponta a ponta {#end-to-end-zdr}
</div>
...
### Combinando ZDR de busca com ZDR de scraping {#combining-search-zdr-with-scrape-zdr}
...
## Implicações de custos {#cost-implications}
...
<div id="advanced-scraping-options">
  ## Opções avançadas de scraping {#advanced-scraping-options}
</div>
...
## Desempenho medido {#measured-performance}
...
## Feedback sobre busca {#search-feedback}
