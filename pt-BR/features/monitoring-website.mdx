...
Esta página aborda o alvo `crawl`. Agendamento, objetivos e avaliação, rastreamento de mudanças, notificações e preços são compartilhados entre todos os tipos de monitor. Veja a [visão geral do monitoramento](/pt-BR/features/monitoring).
