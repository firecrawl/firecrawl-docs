...
## Status do job e conclusão {#job-status-and-completion}
...
<div id="extracting-without-a-schema">
  ## Extraindo sem um esquema {#extracting-without-a-schema}
</div>
...
<div id="improving-results-with-web-search">
  ## Melhorando os resultados com busca na web {#improving-results-with-web-search}
</div>
...
<div id="extracting-without-urls">
  ## Extração sem URLs {#extracting-without-urls}
</div>
