---
title: 'Parse'
description: 'Faça upload de um documento local ou não público e converta-o em dados limpos, prontos para LLM'
og:title: "Parse | Firecrawl"
og:description: "Converta PDFs, DOCX, XLSX, HTML locais e muito mais em Markdown ou JSON estruturado"
