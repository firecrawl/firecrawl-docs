...
## Markdown por página (PDF) {#per-page-markdown-pdf}
...
## Blocos de layout (PDF) {#layout-blocks-pdf}
...
### Fundamentação: de uma resposta à página {#grounding-from-an-answer-back-to-the-page}
...
## Resultado JSON estruturado {#structured-json-output}
...
### Modos de análise {#parsing-modes}
...
## Referência da requisição {#request-reference}
