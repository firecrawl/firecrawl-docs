...
## Crie um monitor em escala da web {#create-a-web-scale-monitor}
...
## Como escrever boas metas e queries {#writing-good-goals-and-queries}
...
## Status e deduplicação {#statuses-and-dedup}
