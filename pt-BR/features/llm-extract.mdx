...
<div id="scrape-and-extract-structured-data-with-firecrawl">
  ## Raspe e extraia dados estruturados com o Firecrawl {#scrape-and-extract-structured-data-with-firecrawl}
</div>
...
<div id="json-mode-via-scrape">
  ### Modo JSON via /scrape {#json-mode-via-scrape}
</div>
...
<div id="structured-data-without-schema">
  ### Dados estruturados sem esquema {#structured-data-without-schema}
</div>
...
<div id="real-world-example-extracting-company-information">
  ### Exemplo real: extraindo informações de empresas {#real-world-example-extracting-company-information}
</div>
...
### Detecção de injeção de prompt {#prompt-injection-detection}
...
## Dicas para extração consistente {#tips-for-consistent-extraction}
