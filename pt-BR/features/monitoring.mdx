...
<CardGroup cols={3}>
  <Card title="Monitoramento de página" icon="file-lines" href="/pt-BR/features/monitoring-page">
  ...
  <Card title="Monitoramento de site" icon="spider" href="/pt-BR/features/monitoring-website">
...
<Note>
  O rastreamento de mudanças se aplica a alvos `scrape` e `crawl`. Monitores em escala web completos (`search`) emitem alertas sobre novos resultados em vez de comparar páginas conhecidas — veja [Statuses and dedup](/pt-BR/features/monitoring-web-scale#statuses-and-dedup).
</Note>
