...
## Visão geral da integração com o Dify {#dify-integration-overview}
...
## Ferramentas do Firecrawl no Dify {#firecrawl-tools-in-dify}
...
## Ações do Firecrawl {#firecrawl-actions}
...
## Dify vs. outras plataformas {#dify-vs-other-platforms}
...
## Sincronize sites na base de conhecimento do Dify {#sync-websites-into-the-dify-knowledge-base}
...
### Configurando o Firecrawl {#configuring-firecrawl}
...
### Scraping da página de destino {#scrape-the-target-webpage}
...
### Revisar resultados da importação {#review-import-results}
