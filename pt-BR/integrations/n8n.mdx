...
## Introdução ao Firecrawl e ao n8n {#introduction-to-firecrawl-and-n8n}
...
## Por que usar o Firecrawl com o n8n? {#why-use-firecrawl-with-n8n}
...
## Etapa 1: Crie sua conta no Firecrawl {#step-1-create-your-firecrawl-account}
...
### Cadastre-se no Firecrawl {#sign-up-for-firecrawl}
...
### Obtenha sua chave de API {#get-your-api-key}
...
## Etapa 2: Configure o n8n {#step-2-set-up-n8n}
...
### Escolha sua versão do n8n {#choose-your-n8n-version}
...
### Opção A: n8n Cloud (Recomendado para iniciantes) {#option-a-n8n-cloud-recommended-for-beginners}
...
### Opção B: Auto-hospedado com Docker {#option-b-self-hosted-with-docker}
...
### Entendendo a interface do n8n {#understanding-the-n8n-interface}
...
### O Canvas do Fluxo de Trabalho {#the-workflow-canvas}
...
## Etapa 3: Instale e configure o nó do Firecrawl {#step-3-install-and-configure-the-firecrawl-node}
...
### Adicione o nó do Firecrawl ao seu fluxo de trabalho {#add-the-firecrawl-node-to-your-workflow}
...
### Conecte sua chave de API do Firecrawl {#connect-your-firecrawl-api-key}
...
### Teste a conexão {#test-your-connection}
...
## Etapa 4: Crie seu bot do Telegram {#step-4-create-your-telegram-bot}
...
### Crie um bot com o BotFather {#create-a-bot-with-botfather}
...
### Encontre seu ID de chat {#get-your-chat-id}
...
## Etapa 5: Crie fluxos de trabalho práticos com o Telegram {#step-5-build-practical-workflows-with-telegram}
...
### Exemplo 1: Resumo diário das atualizações do produto Firecrawl {#example-1-daily-firecrawl-product-updates-summary}
...
### Exemplo 2: Busca de notícias sobre IA no Telegram {#example-2-ai-news-search-to-telegram}
...
### Exemplo 3: Resumo de Notícias com IA {#example-3-ai-powered-news-summary}
...
## Entendendo as operações do Firecrawl {#understanding-firecrawl-operations}
...
### Fazer scraping de uma URL e obter seu conteúdo {#scrape-a-url-and-get-its-content}
...
### Scrape + Interact com perfis persistentes {#scrape-interact-with-persistent-profiles}
...
### Pesquisar e, opcionalmente, fazer scraping dos resultados de busca {#search-and-optionally-scrape-search-results}
...
### Mapeie um site e obtenha URLs {#map-a-website-and-get-urls}
...
## Modelos e exemplos de fluxos de trabalho {#workflow-templates-and-examples}
...
### Modelos em destaque {#featured-templates}
...
### Como importar modelos {#how-to-import-templates}
...
### Testes e depuração {#testing-and-debugging}
...
### Explore recursos avançados {#explore-advanced-features}
...
### Participe da comunidade {#join-the-community}
...
### Caminho de aprendizado recomendado {#recommended-learning-path}
