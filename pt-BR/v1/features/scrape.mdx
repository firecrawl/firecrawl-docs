...
<div id="scraping-a-url-with-firecrawl">
  ## Fazendo scraping de uma URL com o Firecrawl {#scraping-a-url-with-firecrawl}
</div>
...
<div id="scrape-formats">
  ## Formatos de Scrape {#scrape-formats}
</div>
...
<div id="extracting-without-schema-new">
  ### Extração sem schema (Novo) {#extracting-without-schema-new}
</div>
...
<div id="json-options-object">
  ### Objeto de opções JSON {#json-options-object}
</div>
...
<div id="interacting-with-the-page-with-actions">
  ## Interagindo com a página usando ações {#interacting-with-the-page-with-actions}
</div>
...
<div id="batch-scraping-multiple-urls">
  ## Coleta em lote de várias URLs {#batch-scraping-multiple-urls}
</div>
...
<div id="using-fire-1-with-scrape">
  ## Usando o FIRE-1 com Scrape {#using-fire-1-with-scrape}
</div>
...
<div id="example-usage-with-scrape-endpoint">
  ### Exemplo de uso com o endpoint /scrape {#example-usage-with-scrape-endpoint}
</div>
