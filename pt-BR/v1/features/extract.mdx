...
<div id="asynchronous-extraction-status-checking">
  ## Extração assíncrona e verificação de status {#asynchronous-extraction-status-checking}
</div>
...
<div id="possible-states">
  ### Possíveis estados {#possible-states}
</div>
...
<div id="extracting-without-a-schema">
  ## Extração sem esquema {#extracting-without-a-schema}
</div>
...
<div id="improving-results-with-web-search">
  ## Melhorando os resultados com pesquisa na web {#improving-results-with-web-search}
</div>
...
<div id="example-response-with-web-search">
  ### Exemplo de resposta com pesquisa na web {#example-response-with-web-search}
</div>
...
<div id="extracting-without-urls">
  ## Extraindo sem URLs {#extracting-without-urls}
</div>
...
<div id="known-limitations-beta">
  ## Limitações Conhecidas (Beta) {#known-limitations-beta}
</div>
...
<div id="billing-and-usage-tracking">
  ## Cobrança e acompanhamento de uso {#billing-and-usage-tracking}
</div>
