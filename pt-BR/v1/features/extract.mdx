...
- **Múltiplas páginas / Domínio inteiro**  
  Exemplo: `https://firecrawl.dev/*`

Quando você usa `/*`, o Firecrawl vai automaticamente rastrear e analisar todas as URLs que conseguir encontrar nesse domínio e depois extrair os dados solicitados. Este recurso é experimental; envie um e-mail para [help@firecrawl.com](mailto:help@firecrawl.com) se tiver problemas.
