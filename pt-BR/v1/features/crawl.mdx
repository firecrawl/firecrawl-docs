...
Acelere seus rastreamentos em significantly quando não precisar dos dados mais recentes. Adicione `maxAge` às suas `scrapeOptions` para usar dados em cache da página quando disponíveis.
...
* Se houver, retorna instantaneamente do cache (significantly mais rápido)
