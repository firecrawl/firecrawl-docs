...
<div id='crawling'>## Rastreamento</div>

<div id='crawl-endpoint'>### endpoint /crawl</div>
...
<Warning>
  Por padrão, o rastreamento ignorará sublinks de uma página se eles não forem
  descendentes diretos da URL fornecida. Assim, website.com/other-parent/blog-1
  não será retornado se você rastrear website.com/blogs/. Se você precisar de
...
<div id='installation'>### Instalação</div>
...
<div id='check-crawl-job'>### Verificar Job de Crawler</div>

Usado para verificar o status de um job de crawler e obter seu resultado.

<Note>
  Este endpoint só funciona para crawls que estão em andamento ou que foram
...
<div id='response-handling'>#### Tratamento de respostas</div>
...
<Info>
  Os parâmetros skip e next só são relevantes ao acessar a API diretamente. Se
  você estiver usando o SDK, nós cuidamos disso e retornaremos todos os
...
<div id='sdk-response'>### Resposta do SDK</div>
...
<div id='faster-crawling'>## Rastreamento mais rápido</div>
...
<div id='crawl-webhook'>## Webhook de Rastreamento</div>
