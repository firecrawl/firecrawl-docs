...
<div id="batch-scraping-multiple-urls">
  ## Raspagem em lote de múltiplas URLs {#batch-scraping-multiple-urls}
</div>
...
<div id="batch-scrape-with-extraction">
  ## Raspagem em lote com extração {#batch-scrape-with-extraction}
</div>
...
<div id="synchronous-2">
  #### Sincronamente {#synchronous-2}
</div>

<BatchScrapeExtractOutput />

<div id="asynchronous-2">
  #### Assíncrono {#asynchronous-2}
</div>

<BatchScrapeExtractAsyncOutput />

<div id="batch-scrape-with-webhooks">
  ## Raspagem em lote com webhooks {#batch-scrape-with-webhooks}
</div>
