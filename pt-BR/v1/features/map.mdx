...
Este endpoint prioriza a velocidade, então pode não capturar todos os links do site. Estamos trabalhando em melhorias. Comentários e sugestões são muito bem-vindos.