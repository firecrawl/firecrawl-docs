---
title: "Modo avançado"
description: "Use proxies furtivos para raspagem confiável em sites complexos, mantendo a privacidade"
og:title: "Modo avançado | Firecrawl"
og:description: "Use proxies furtivos para raspagem confiável em sites complexos, mantendo a privacidade"
---
...
- **stealth**: Proxies avançados para scraping em sites complexos, mantendo a privacidade. Mais lento, mas mais confiável em certos sites.
...
Ao fazer scraping de sites complexos, você pode usar o modo stealth para aumentar sua taxa de sucesso enquanto mantém a privacidade.
