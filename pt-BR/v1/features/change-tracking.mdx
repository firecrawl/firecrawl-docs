...
<div id="git-diff-results-example">
  ### Exemplo de resultados de diff do Git: {#git-diff-results-example}
</div>
...
<div id="json-comparison-results-example">
  ### Exemplo de resultados de comparação de JSON: {#json-comparison-results-example}
</div>
...
<div id="typescript-interface">
  ### Interface em TypeScript {#typescript-interface}
</div>
...
<div id="advanced-options-2">
  ### Opções avançadas {#advanced-options-2}
</div>
...
<div id="python-data-model">
  ### Modelo de dados em Python {#python-data-model}
</div>
...
<div id="change-tracking-modes">
  ## Modos de rastreio de mudanças {#change-tracking-modes}
</div>
...
<div id="basic-scrape-example">
  ### Exemplo básico de scraping {#basic-scrape-example}
</div>
...
<div id="tracking-product-price-changes">
  ### Acompanhar Alterações de Preço de Produtos {#tracking-product-price-changes}
</div>
...
<div id="monitoring-content-changes-with-git-diff">
  ### Monitorando mudanças de conteúdo com git diff {#monitoring-content-changes-with-git-diff}
</div>
