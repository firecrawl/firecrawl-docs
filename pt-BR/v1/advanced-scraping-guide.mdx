...
<div id="basic-scraping-with-firecrawl-scrape">
  ## Scraping básico com o Firecrawl (/scrape) {#basic-scraping-with-firecrawl-scrape}
</div>
...
<div id="scrape-options">
  ## Opções de Scrape {#scrape-options}
</div>
...
<div id="setting-the-content-formats-on-response-with-formats">
  ### Definindo os formatos de conteúdo na resposta com `formats` {#setting-the-content-formats-on-response-with-formats}
</div>
...
<div id="getting-the-full-page-content-as-markdown-with-onlymaincontent">
  ### Obtendo o conteúdo completo da página em markdown com `onlyMainContent` {#getting-the-full-page-content-as-markdown-with-onlymaincontent}
</div>
...
<div id="setting-the-tags-to-include-with-includetags">
  ### Definindo as tags a serem incluídas com `includeTags` {#setting-the-tags-to-include-with-includetags}
</div>
...
<div id="setting-the-tags-to-exclude-with-excludetags">
  ### Definindo as tags a serem excluídas com `excludeTags` {#setting-the-tags-to-exclude-with-excludetags}
</div>
...
<div id="waiting-for-the-page-to-load-with-waitfor">
  ### Aguardando o carregamento da página com `waitFor` {#waiting-for-the-page-to-load-with-waitfor}
</div>
...
<div id="setting-the-maximum-timeout">
  ### Definindo o `timeout` máximo {#setting-the-maximum-timeout}
</div>
...
<div id="parsing-pdf-files-with-parsepdf">
  ### Processando arquivos PDF com `parsePDF` {#parsing-pdf-files-with-parsepdf}
</div>
...
<div id="extractor-options">
  ## Opções do Extrator {#extractor-options}
</div>
...
<div id="using-the-llm-extraction">
  ### Usando a extração com LLM {#using-the-llm-extraction}
</div>
...
<div id="example-usage-2">
  ### Exemplo de uso {#example-usage-2}
</div>
...
<div id="paginationnext-url">
  #### Paginação/URL seguinte {#paginationnext-url}
</div>
...
<div id="example-usage-3">
  ### Exemplo de uso {#example-usage-3}
</div>
...
<div id="mapping-website-links-with-map">
  ## Mapeando links de sites com `/map` {#mapping-website-links-with-map}
</div>
