...
* **Personalização**: excluir tags, rastrear atrás de autenticação com cabeçalhos personalizados, profundidade máxima de rastreamento, etc.
...
Firecrawl é open source e está disponível sob a [licença AGPL-3.0](https://github.com/mendableai/firecrawl/blob/main/LICENSE).
...
Adoramos contribuições! Leia nosso [guia de contribuição](https://github.com/mendableai/firecrawl/blob/main/CONTRIBUTING.md) antes de abrir um pull request.