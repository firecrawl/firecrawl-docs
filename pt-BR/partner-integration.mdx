...
* **Termos de Serviço**: Antes de chamar o endpoint `create-user`, sua plataforma deve solicitar ao usuário que aceite os [Termos de Serviço](https://www.firecrawl.dev/terms-of-service) do Firecrawl.
