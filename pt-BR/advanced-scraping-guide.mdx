...
| `model`                 | `string`  | `"spark-2"`     | Modelo de IA a ser usado: `"spark-2"` (padrão, mais barato e mais rápido), `"spark-1-mini"` (60% mais barato que o Pro) ou `"spark-1-pro"` (maior precisão).                              |
