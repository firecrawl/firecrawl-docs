...
## scraping básica {#basic-scraping}
...
<div id="scraping-pdfs">
  ## Extração de PDFs {#scraping-pdfs}
</div>
...
<div id="mobile-scraping">
  ### Scraping móvel {#mobile-scraping}
</div>
...
<div id="content-filtering">
  ### Filtragem de conteúdo {#content-filtering}
</div>
...
<div id="timing-and-cache">
  ### Tempo e cache {#timing-and-cache}
</div>
...
<div id="action-execution-notes">
  #### Observações sobre a execução de ações {#action-execution-notes}
</div>
...
<div id="advanced-action-examples">
  #### Exemplos de Ações Avançadas {#advanced-action-examples}
</div>
...
<div id="full-scrape-example">
  ### Exemplo completo de scraping {#full-scrape-example}
</div>
...
## Extração em JSON via formatos {#json-extraction-via-formats}
...
<div id="agent-endpoint">
  ## Endpoint do agente {#agent-endpoint}
</div>
...
### Opções do agente {#agent-options}
...
<div id="check-agent-status">
  ### Verificar status do agente {#check-agent-status}
</div>
...
## Rastreamento de várias páginas {#crawling-multiple-pages}
...
### Verificar o job de rastreamento {#check-crawl-job}
...
### Prévia do prompt e dos parâmetros de rastreamento {#crawl-prompt-and-params-preview}
...
<div id="crawl-scope">
  #### Escopo do rastreamento {#crawl-scope}
</div>
...
<div id="sitemap-and-deduplication">
  #### Sitemap e deduplicação {#sitemap-and-deduplication}
</div>
...
<div id="scrape-options-for-crawl">
  #### Opções de scrape para crawl {#scrape-options-for-crawl}
</div>
...
<div id="crawl-example">
  ### Exemplo de rastreamento {#crawl-example}
</div>
...
## Mapeamento de links de websites {#mapping-website-links}
...
<div id="whitelisting-firecrawl">
  ## Adicionando o Firecrawl à lista de permissões {#whitelisting-firecrawl}
</div>

### Permitindo que o Firecrawl faça scraping do seu site {#allowing-firecrawl-to-scrape-your-website}
...
<div id="allowing-your-application-to-call-the-firecrawl-api">
  ### Permitindo que sua aplicação faça chamadas à API do Firecrawl {#allowing-your-application-to-call-the-firecrawl-api}
</div>
