...
| `model`                 | `string`  | `"spark-1-pro"` | Modelo de IA a ser usado: `"spark-1-pro"` (padrão, maior precisão), `"spark-1-mini"` (60% mais barato que o Pro) ou `"spark-2"` (mais barato e mais rápido).                              |
