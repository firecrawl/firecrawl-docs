...
<Card title="servidor MCP" icon="plug" href="/pt-BR/mcp-server">
  ...
  [guia de início rápido do Windsurf](/pt-BR/quickstarts/windsurf).
</Card>
...
<Steps>
  ...
  <Step title="Servidor de docs MCP">
    Para uma abordagem estruturada com ferramentas MCP, conecte o servidor MCP do Firecrawl no Codex, Cursor, Claude Code, Claude Desktop ou outro cliente compatível. Consulte [Primeiros passos com MCP](/pt-BR/mcp-server) para a configuração hospedada. Usuários do Windsurf devem seguir o [guia de início rápido do Windsurf](/pt-BR/quickstarts/windsurf).
  </Step>
