...
| `firecrawl-research-index`   | Buscar papers, ler trechos e seguir citações no código da aplicação         |
| `firecrawl-developer-index`  | Buscar issues, pull requests, READMEs e documentação no código da aplicação |
