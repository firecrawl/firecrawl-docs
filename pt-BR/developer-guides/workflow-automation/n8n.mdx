...
<Tip>
  **Usuários do n8n Cloud:** Em vez de inserir manualmente uma chave de API, você pode usar o botão OAuth **&quot;Connect to Firecrawl&quot;** com um clique ao adicionar o nó do Firecrawl. Isso cria automaticamente uma nova equipe do Firecrawl vinculada à sua conta do n8n e concede **100.000 créditos gratuitos**. Para visualizar esses créditos no [painel do Firecrawl](https://www.firecrawl.dev/app/usage), certifique-se de mudar para a equipe vinculada ao n8n usando o seletor de equipe no canto superior esquerdo.
</Tip>
