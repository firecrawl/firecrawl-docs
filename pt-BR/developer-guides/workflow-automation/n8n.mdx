...
* **Agent (Sync)** inicia o job e aguarda o resultado em uma única etapa — mais simples para a maioria dos casos de uso.
...
* [Firecrawl Discord](https://discord.gg/gSmWdAkdwd) - Tire dúvidas sobre o Firecrawl e discuta web scraping
