...
## 1. Endpoint `/agent` {#1-agent-endpoint}
...
### Características principais {#key-characteristics}
...
### Melhor caso de uso: Pesquisa e descoberta autônomas {#best-use-case-autonomous-research-discovery}
...
## 2. Endpoint `/extract` {#2-extract-endpoint}
...
### Características principais {#key-characteristics-2}
...
### A limitação de URLs {#the-url-limitation}
...
### Caso de uso ideal: extração direcionada em múltiplas páginas {#best-use-case-targeted-multi-page-extraction}
...
## 3. Endpoint `/scrape` com modo JSON {#3-scrape-endpoint-with-json-mode}
...
### Características principais {#key-characteristics-3}
...
### Melhor caso de uso: Extração de alta precisão em página única {#best-use-case-single-page-precision-extraction}
...
### Recomendações por Cenário {#recommendations-by-scenario}
...
### Exemplo: &quot;Encontre os fundadores da Firecrawl&quot; {#example-find-the-founders-of-firecrawl}
...
## Migração: `/extract` → `/agent` {#migration-extract-agent}
