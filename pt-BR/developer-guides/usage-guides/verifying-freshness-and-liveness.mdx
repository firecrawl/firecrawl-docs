...
## O equilíbrio entre atualidade e desempenho (`maxAge`) {#the-freshness-tradeoff-maxage}
...
### Onde `maxAge` se aplica {#where-maxage-applies}
...
## Atualidade não é disponibilidade {#freshness-is-not-liveness}
...
## Checklist de Ações Sensíveis à Atualidade {#freshness-sensitive-action-checklist}
...
## Exemplo Prático: Coleta de Evidências da Página Atual {#worked-example-collect-current-page-evidence}
