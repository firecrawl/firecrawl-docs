...
### Entendendo o código {#understanding-the-code}
    </div>
...
<div id="extraction-process">
  ### Processo de Extração {#extraction-process}
</div>
...
<div id="pdf-generation-process">
  ### Processo de Geração de PDF {#pdf-generation-process}
</div>
...
<div id="automatic-color-extraction">
  ### Extração Automática de Cores {#automatic-color-extraction}
</div>
...
<div id="typography-documentation">
  ### Documentação de Tipografia {#typography-documentation}
</div>
...
<div id="add-component-documentation">
  ### Adicionar documentação de componentes {#add-component-documentation}
</div>
...
<div id="export-multiple-formats">
  ### Exportar em vários formatos {#export-multiple-formats}
</div>
...
<div id="custom-pdf-themes">
  ### Temas de PDF personalizados {#custom-pdf-themes}
</div>
