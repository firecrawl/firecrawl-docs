...
<div id="what-youll-build">
  ## O que você vai construir {#what-youll-build}
</div>
...
### Instalar pacotes do AI SDK {#install-ai-sdk-packages}
...
### Instalar o AI Elements {#install-ai-elements}
...
### Instalar o provedor OpenAI {#install-openai-provider}
...
### Entendendo o Frontend {#understanding-the-frontend}
...
### Instalar o SDK do Firecrawl {#install-firecrawl-sdk}
...
### Crie o arquivo de ferramentas {#create-the-tools-file}
...
### Entendendo as Ferramentas {#understanding-the-tools}
...
<div id="tool-calling-process">
  ### Processo de Chamada de Ferramentas {#tool-calling-process}
</div>
...
<div id="web-search-toggle">
  ### Alternância de busca na web {#web-search-toggle}
</div>
...
<div id="customization-ideas">
  ## Ideias de customização {#customization-ideas}
</div>

<div id="add-more-tools">
  ### Adicionar mais ferramentas {#add-more-tools}
</div>
...
<div id="change-the-ai-model">
  ### Alterar o modelo de IA {#change-the-ai-model}
</div>
...
<div id="customize-the-ui">
  ### Personalize a interface {#customize-the-ui}
</div>
