...
No CLI do Factory droid, adicione o Firecrawl com o comando `/mcp add`:

```bash
/mcp add firecrawl "npx -y firecrawl-mcp" -e FIRECRAWL_API_KEY=sua-chave-de-api-aqui
```

Substitua `your-api-key-here` pela sua chave de API real do Firecrawl.
