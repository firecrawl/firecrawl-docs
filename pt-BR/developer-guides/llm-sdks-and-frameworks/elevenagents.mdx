...
## Opção 1: Firecrawl servidor MCP {#option-1-firecrawl-mcp-server}
...
### Adicione o servidor MCP {#add-the-mcp-server}
...
### Anexe a um agente {#attach-it-to-an-agent}
...
### Atualize o prompt do sistema {#update-the-system-prompt}
...
## Opção 2: Ferramenta de Webhook do Servidor {#option-2-server-webhook-tool}
...
### Ferramenta de scraping {#scrape-tool}
...
### Atualize o prompt do sistema {#update-the-system-prompt-2}
