...
Esta URL inicia o conjunto de ferramentas sem chave do Firecrawl. Para uma configuração conectada à conta ou sem supervisão, siga os [modos de conexão MCP hospedados](/pt-BR/developer-guides/mcp-setup-guides/oauth); mantenha as chaves de API em um cabeçalho Authorization ou em um armazenamento seguro de segredos, nunca em uma URL.
