...
Dê aos seus agentes de voz e chat do [ElevenAgents](https://elevenlabs.io/agents) acesso à web em tempo real para fazer scraping, busca e rastreamento com o Firecrawl. Este guia aborda dois caminhos de integração:
...
Esta URL inicia o conjunto de ferramentas sem chave do Firecrawl. Para uma configuração conectada à conta, consulte o [Human MCP](/pt-BR/mcp-server/human-mcp) ou, para uma configuração não assistida, consulte o [Agent MCP](/pt-BR/mcp-server/agent-mcp); mantenha as chaves de API em um cabeçalho Authorization ou em um armazenamento seguro de segredos, nunca em uma URL.
...
* [Servidor MCP do Firecrawl](https://docs.firecrawl.dev/mcp-server/agent-mcp)