...
## Scraping + Resumo {#scrape-summarize}
...
## Extração de Dados Estruturados {#structured-data-extraction}
...
## Buscar + Analisar {#search-analyze}
...
## API Responses com MCP {#responses-api-with-mcp}
