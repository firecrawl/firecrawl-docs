---
title: "Raspagem com Autenticação"
description: "Aprenda a extrair conteúdo protegido por autenticação usando cookies"
---

<Info>
Este guia mostra como extrair conteúdo autenticado usando cookies de sessão a partir das DevTools do seu navegador. Ideal para ferramentas internas, painéis administrativos e sistemas autorizados nos quais você tem credenciais de acesso.
</Info>
...
A abordagem recomendada para scraping autenticado é a **autenticação baseada em cookie**, em que você:

1. Faz login manualmente no seu aplicativo
2. Extrai o cookie de sessão do DevTools
...
- **Sites públicos**: Normalmente de 1 a 24 horas
- **Sites bancários/sensíveis**: De 15 a 30 minutos

Ferramentas internas costumam ter um tempo de vida do cookie mais longo, tornando esse método ideal para tarefas recorrentes de scraping.
</Note>
