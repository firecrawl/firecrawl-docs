...
Ao fazer scraping na Amazon, você geralmente vai querer:

- Extrair informações do produto (título, preço, disponibilidade)
- Obter avaliações e notas dos clientes
- Monitorar alterações de preço
- Pesquisar produtos programaticamente
- Acompanhar anúncios/listagens de concorrentes
...
Descubra todas as URLs disponíveis em páginas de produto ou categoria da Amazon. Observação: o Map retorna apenas URLs, sem conteúdo.
...
Rastreie várias páginas de uma categoria da Amazon ou de resultados de busca.
...
Extraia várias URLs de produtos da Amazon simultaneamente.
