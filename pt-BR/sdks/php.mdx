...
### Integração com Laravel {#laravel-integration}
...
### Usando a facade do Laravel {#using-the-laravel-facade}
...
### Fazer o rastreamento de um site {#crawling-a-website}
...
## Ferramentas do Laravel AI SDK {#laravel-ai-sdk-tools}
...
### Comportamento da Ferramenta {#tool-behavior}
...
### Resultados do rastreamento {#crawl-results}
