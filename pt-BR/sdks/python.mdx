...
* Inicie um job e, em seguida, recupere uma página por vez com `auto_paginate=False` e `get_crawl_status_page`.
...
* Inicie um job e recupere uma página por vez com `auto_paginate=False` e `get_batch_scrape_status_page`.
