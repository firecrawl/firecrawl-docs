...
O SDK oficial do .NET é mantido no monorepo do Firecrawl em [apps/.net-sdk](https://github.com/firecrawl/firecrawl/tree/main/apps/.net-sdk).

Para instalar o SDK .NET do Firecrawl, adicione o pacote NuGet:

<Tabs>
  <Tab title="CLI do .NET">`bash dotnet add package firecrawl-sdk `</Tab>
  <Tab title="Gerenciador de Pacotes">`powershell Install-Package firecrawl-sdk `</Tab>
