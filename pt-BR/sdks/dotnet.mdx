...
### Fazer scraping de uma URL {#scraping-a-url}
...
#### Extração em lote com chave de idempotência {#batch-scrape-with-idempotency-key}
...
### Configuração de variáveis de ambiente {#environment-variable-configuration}
