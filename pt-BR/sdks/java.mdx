...
O SDK oficial para Java é mantido no monorepo do Firecrawl em [apps/java-sdk](https://github.com/firecrawl/firecrawl/tree/main/apps/java-sdk).
...
O SDK lança exceções em tempo de execução no namespace `com.firecrawl.errors`.
