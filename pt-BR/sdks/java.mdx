...
#### Extração de JSON {#json-extraction}
...
### Rastreamento de um site {#crawling-a-website}
...
### Mapear um site {#mapping-a-website}
...
### Buscando na Web {#searching-the-web}
...
### Scraping em batch {#batch-scraping}
...
## Suporte assíncrono {#async-support}
