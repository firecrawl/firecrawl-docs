...
<div id="parsing-uploaded-files">
  ### Análise de arquivos enviados {#parsing-uploaded-files}
</div>
...
<div id="crawling-a-website">
  ### Rastreando um site {#crawling-a-website}
</div>
...
<div id="sitemap-only-crawl">
  ### Rastreamento Somente do Sitemap {#sitemap-only-crawl}
</div>
...
### Executando um agente {#running-an-agent}
...
<div id="manual-crawl-with-pagination-control-single-page">
  ##### Rastreamento manual com controle de paginação (página única) {#manual-crawl-with-pagination-control-single-page}
</div>
...
<div id="manual-crawl-with-limits-auto-pagination-early-stop">
  ##### Rastreamento manual com limites (paginação automática + parada antecipada) {#manual-crawl-with-limits-auto-pagination-early-stop}
</div>
...
<div id="simple-batch-scrape-auto-pagination-default">
  ##### Raspagem em lote simples (paginação automática, padrão) {#simple-batch-scrape-auto-pagination-default}
</div>
...
<div id="manual-batch-scrape-with-pagination-control-single-page">
  ##### Coleta manual em lote com controle de paginação (página única) {#manual-batch-scrape-with-pagination-control-single-page}
</div>
...
### Listar &amp; Encerrar Sessões {#list-close-sessions}
