...
Faça busca, scraping e interaja com a web diretamente do terminal. A Firecrawl CLI pode ser usada de forma independente ou como uma Skill que agentes de programação com IA, como Claude Code, Antigravity e OpenCode, podem descobrir e usar automaticamente.
