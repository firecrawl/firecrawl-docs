...
* `--all` instala as Firecrawl skills em todos os agentes de codificação de IA detectados
...
A CLI e as skills do Firecrawl são de código aberto e estão disponíveis no GitHub: [firecrawl/cli](https://github.com/firecrawl/cli)
