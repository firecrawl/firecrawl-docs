...
Faça scraping, rastreamento, busca e extração de dados da web diretamente do terminal. A Firecrawl CLI pode ser usada de forma independente ou como uma Skill que agentes de programação com IA, como Claude Code, Antigravity e OpenCode, podem descobrir e usar automaticamente.
...
Se você estiver usando um agente de IA, como o Claude Code, poderá instalar a Firecrawl Skill abaixo, e o agente a configurará para você.
