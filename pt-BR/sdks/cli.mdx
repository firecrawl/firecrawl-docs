...
### Visualizar configuração {#view-configuration}
...
### Conecte a CLI ao Firecrawl auto-hospedado {#connect-the-cli-to-self-hosted-firecrawl}
...
#### Opções de busca {#search-options}
...
#### Opções para mapear {#map-options}
...
#### Verificar status do crawl {#check-crawl-status}

<CrawlStatus />

#### Opções de Crawl {#crawl-options}
...
## Manipulação da saída {#output-handling}
...
### Comportamento dos formatos {#format-behavior}
...
### Rastreamento completo do site {#full-site-crawl}
...
### Descoberta de sites {#site-discovery}
...
### Fluxo de Pesquisa {#research-workflow}
...
### Combine com outras ferramentas {#combine-with-other-tools}
