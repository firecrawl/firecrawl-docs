...
<div id="getting-your-claude-and-firecrawl-api-keys">
  ## Obtendo suas chaves de API do Claude e do Firecrawl {#getting-your-claude-and-firecrawl-api-keys}
</div>
...
<div id="load-website-with-firecrawl">
  ## Carregar site com Firecrawl {#load-website-with-firecrawl}
</div>
...
<div id="combination-and-generation">
  ## Combinação e Geração {#combination-and-generation}
</div>
