...
### Exemplo de requisição (Código) {#example-request-code}
...
### Exemplo de resposta (Código) {#example-response-code}
...
### Exemplo de requisição (Prompt) {#example-request-prompt}
...
### Exemplo de resposta (Prompt) {#example-response-prompt}
