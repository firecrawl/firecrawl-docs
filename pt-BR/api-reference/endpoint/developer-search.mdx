...
## Como `repos` e `sources` restringem uma busca {#how-repos-and-sources-scope-a-search}
...
## Como os filtros de repositório restringem uma busca {#how-the-repository-filters-scope-a-search}
...
## Quais valores `sources` aceita {#which-values-sources-accepts}
