...
description: "Execute código Playwright em uma sessão ativa de navegador na nuvem."
openapi: '/pt-BR/api-reference/v2-openapi.json POST /browser/{sessionId}/execute'
---
...
|-----------|------|-------------|--------|-----------|
| `code` | string | Sim | - | Código Playwright a ser executado (1-100.000 caracteres) |
