...
<div id="supported-query-operators">
  ## Operadores de pesquisa compatíveis {#supported-query-operators}
</div>
...
<div id="country-parameter">
  ## Parâmetro country {#country-parameter}
</div>
...
## Parâmetro Categories {#categories-parameter}
...
### Exemplo de inclusão de domínios {#include-domains-example}
...
### Exemplo de exclusão de domínios {#exclude-domains-example}
...
### Categoria da Resposta {#category-response}
...
## Busca por período de tempo {#time-based-search}
