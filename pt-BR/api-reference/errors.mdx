...
| 402  | `Payment Required: Insufficient credits`            | Os créditos do plano acabaram ou a cobrança não está configurada.                                                                                              | Ative a recarga automática ou faça upgrade do seu plano.                                                                                                                                                       | Não              |
