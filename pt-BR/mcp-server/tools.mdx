...
Essas ferramentas não fazem parte da interface hospedada sem chave. Para issues do GitHub, pull requests mesclados e READMEs, use [`firecrawl_developer_search`](#12b-developer-search-tool-firecrawl_developer_search).
...
Pesquise diretamente no [Índice para Desenvolvedores](/pt-BR/features/developer): issues do GitHub, pull requests mesclados, READMEs de repositórios e sites de documentação selecionados. É somente leitura e retorna resultados ranqueados com as passagens correspondentes.
