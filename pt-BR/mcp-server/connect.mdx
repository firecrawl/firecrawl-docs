...
| Modo          | Endpoint        | Ideal para                                                     | Credenciais                                 |
| ------------- | --------------- | -------------------------------------------------------------- | ------------------------------------------- |
| Conta         | `/v2/mcp-oauth` | Clientes interativos que podem concluir o OAuth pelo navegador | Tokens OAuth gerenciados pelo cliente       |
| Não assistido | `/v2/mcp`       | CI, servidores e scripts                                       | `Authorization: Bearer <FIRECRAWL_API_KEY>` |
| Sem chave     | `/v2/mcp`       | Um período de teste limitado                                   | Nenhuma                                     |
