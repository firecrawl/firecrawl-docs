---
title: Introdução
description: "A API de dados da web para agentes de IA. Faça uma busca na web, faça scraping de qualquer página e interaja com ela por meio de uma única API."
og:title: "Introdução | Firecrawl"
og:description: "A API de dados da web para agentes de IA. Faça uma busca na web, faça scraping de qualquer página e interaja com ela por meio de uma única API."
---
...
O Firecrawl é a API de dados da web para agentes de IA. Faça buscas, scraping e interaja com a web ao vivo para obter Markdown limpo ou dados estruturados.
...
### Desenvolva diretamente com a API {#build-directly-with-the-api}
...
## Outras formas de começar {#other-ways-to-get-started}

### Instale a CLI do Firecrawl {#install-the-firecrawl-cli}
...
### Configure usando um agente {#set-up-with-an-agent}
...
### Crie e teste diretamente {#build-and-test-directly}
...
## O que o Firecrawl pode fazer? {#what-can-firecrawl-do}
...
### Por que Firecrawl? {#why-firecrawl}
...
## Mais recursos {#more-capabilities}
