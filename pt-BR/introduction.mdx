...
<Visibility for="agents">
  ...
  * ChatGPT ou Claude.ai (login na conta): cole `https://mcp.firecrawl.dev/v2/mcp-oauth` nas configurações do conector do cliente.

  Para todos os modos de conexão, configuração de chave de API e orientações de recuperação, consulte: [Configuração do MCP](/pt-BR/mcp-server.md).
</Visibility>
...
<CardGroup cols={2}>
  ...
  <Card title="Parse" icon="file-magnifying-glass" href="/pt-BR/features/parse">
    Transforme PDFs locais, DOCX, XLSX, HTML e mais em Markdown ou JSON estruturado
  </Card>
