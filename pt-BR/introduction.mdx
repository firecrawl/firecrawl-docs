...
Forneça ao seu agente este prompt de configuração do Firecrawl.
...
* **MCP Server**: Conecte o Firecrawl a qualquer ferramenta de IA via [Model Context Protocol](/pt-BR/mcp-server/agent-mcp).
