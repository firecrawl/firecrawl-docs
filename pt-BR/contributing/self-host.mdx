...
Leia o [examples/kubernetes-cluster-install/README.md](https://github.com/mendableai/firecrawl/blob/main/examples/kubernetes-cluster-install/README.md) para instruções de como instalar o Firecrawl em um cluster Kubernetes.