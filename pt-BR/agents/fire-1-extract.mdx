...
<div id="using-fire-1-with-the-extract-endpoint">
  ### Usando o FIRE-1 com o endpoint de extração
</div>

Da mesma forma, você pode usar o agente FIRE-1 com o endpoint `/v1/extract` para tarefas de extração complexas que exigem navegação entre várias páginas ou interação com elementos.
...
Aqui, o agente garante que todos os comentários sejam carregados na página ao interagir com o botão &quot;Load More Comments&quot; antes que o processo de extração comece, com base no schema e no prompt fornecidos.
**Observação:** O agente FIRE-1 oferece recursos poderosos, mas pode consumir mais créditos dependendo da complexidade das instruções de navegação e do número de páginas com as quais o agente interage.
...
<div id="example-usage-with-scrape-endpoint">
  ## Exemplo de uso com o endpoint de scrape
</div>

Veja um exemplo rápido usando FIRE-1 com o endpoint de scrape para paginar listas de produtos:
...
Neste cenário, o FIRE-1 navega inteligentemente pela paginação e coleta todos os produtos.
...
- Ao usar o FIRE-1, você pode consumir mais créditos dependendo da complexidade da tarefa e da profundidade da interação.
- Certifique-se de que seus prompts orientem claramente o FIRE-1 para otimizar resultados e eficiência.
