...
Ou conecte-se sem uma API key para começar no tier Free remoto sem chave (com limite de requisições por IP; consulte [Limites de taxa](/pt-BR/rate-limits#keyless-no-api-key) para a lista atual de ferramentas):
