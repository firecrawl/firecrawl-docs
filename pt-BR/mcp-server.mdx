...
**Melhor para:** Executar código (Python/JS) que interage com uma página de navegador em tempo real, automação de navegador em várias etapas, sessões persistentes que permanecem ativas entre múltiplas chamadas de ferramenta.
