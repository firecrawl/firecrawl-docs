...
<div id="introducing-map-alpha">
  ## Apresentando o endpoint /map (Alpha) {#introducing-map-alpha}
</div>
...
<div id="new-crawl-webhook">
  ## Novo webhook de crawl {#new-crawl-webhook}
</div>
...
<div id="webhook-response">
  ### Resposta do webhook {#webhook-response}
</div>
...
<div id="migrating-from-v0">
  ## Migrando do V0 {#migrating-from-v0}
</div>
...
<div id="details-on-the-new-request-body">
  ### Detalhes sobre o novo corpo da requisição {#details-on-the-new-request-body}
</div>
...
<div id="details-on-the-new-request-body-2">
  ### Detalhes do novo corpo da requisição {#details-on-the-new-request-body-2}
</div>
