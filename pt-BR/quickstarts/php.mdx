...
### Etapa 1 — Faça scraping para iniciar uma sessão {#step-1-scrape-to-start-a-session}
...
### Etapa 2 — Enviar as interações {#step-2-send-interactions}
...
## Classe auxiliar reutilizável {#reusable-helper-class}
