...
## O que a integração faz {#what-the-integration-does}
...
## Instalar pela Vercel {#install-from-vercel}
...
## Interaja com páginas dinâmicas {#interact-with-dynamic-pages}
...
## Use o Firecrawl com o Vercel AI SDK {#use-firecrawl-with-the-vercel-ai-sdk}
