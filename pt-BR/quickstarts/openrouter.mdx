...
* Muitos dos principais apps do OpenRouter (Cline, Roo Code, Kilo, Cursor, Continue) são, eles próprios, frameworks de agentes que podem usar o Firecrawl MCP — consulte [MCP Server](/pt-BR/mcp-server) para conectar o Firecrawl diretamente a eles.
* Para jobs maiores, use [extração em lote](/pt-BR/features/batch-scrape) para ficar dentro dos limites de contexto do LLM.