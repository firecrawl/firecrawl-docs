...
* Muitos dos principais apps do OpenRouter (Cline, Roo Code, Kilo, Cursor, Continue) funcionam, eles próprios, como integrações com agentes que podem usar o Firecrawl MCP — veja [Agent MCP](/pt-BR/mcp-server/agent-mcp) para integrar o Firecrawl diretamente a eles.
