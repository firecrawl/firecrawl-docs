...
### Etapa 1 — Faça o scraping para iniciar uma sessão {#step-1-scrape-to-start-a-session}
...
### Etapa 2 — Enviar interações {#step-2-send-interactions}
...
### Etapa 3 — Encerre a sessão {#step-3-stop-the-session}
...
## Helper reutilizável {#reusable-helper}
