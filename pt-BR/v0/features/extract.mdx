...
// Define o schema para extrair conteúdo
const schema = z.object({
  top: z
    ...
    .length(5)
    .describe("Top 5 histórias do Hacker News"),
});
...
async fn main() {
    ...
    let app = FirecrawlApp::new(api_key, api_url).expect("Falha ao inicializar FirecrawlApp");
