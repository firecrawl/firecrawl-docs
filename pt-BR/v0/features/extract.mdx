...
<div id="scrape-and-extract-structured-data-with-firecrawl">
  ## Raspagem e extração de dados estruturados com o Firecrawl {#scrape-and-extract-structured-data-with-firecrawl}
</div>
...
<div id="scrape-with-extract-endpoint">
  ### endpoint /scrape (com extract) {#scrape-with-extract-endpoint}
</div>
...
### Com o SDK Python {#using-python-sdk}
...
### Com o SDK para JavaScript {#with-javascript-sdk}
...
### Com o SDK para Rust {#with-rust-sdk}
