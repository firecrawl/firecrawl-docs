...
<div id="canceling-a-crawl-job">
  ### Cancelando um trabalho de rastreamento {#canceling-a-crawl-job}
</div>
...
<div id="extracting-structured-data-from-a-url">
  ### Extraindo dados estruturados de uma URL {#extracting-structured-data-from-a-url}
</div>
...
<div id="search-for-a-query">
  ### Buscar por uma consulta {#search-for-a-query}
</div>
