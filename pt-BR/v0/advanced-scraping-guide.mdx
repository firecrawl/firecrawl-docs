...
<div id="getting-cleaner-content-with-onlymaincontent">
  ### Obtendo conteúdo mais limpo com `onlyMainContent` {#getting-cleaner-content-with-onlymaincontent}
</div>
...
<div id="getting-the-html-with-includehtml">
  ### Obtendo o HTML com `includeHtml` {#getting-the-html-with-includehtml}
</div>
...
<div id="getting-the-raw-html-with-includerawhtml">
  ### Obtendo o HTML bruto com `includeRawHtml` {#getting-the-raw-html-with-includerawhtml}
</div>
...
<div id="getting-a-screenshot-of-the-page-with-screenshot">
  ### Obtendo uma captura de tela da página com `screenshot` {#getting-a-screenshot-of-the-page-with-screenshot}
</div>
...
<div id="adjusting-timeout">
  ## Ajustando o tempo limite {#adjusting-timeout}
</div>
...
<div id="check-crawl-job">
  ### Verificar job de rastreamento {#check-crawl-job}
</div>
...
<div id="example-usage-4">
  ### Exemplo de uso {#example-usage-4}
</div>
...
<div id="page-options-crawler-options">
  ## Opções da Página + Opções do Crawler {#page-options-crawler-options}
</div>
...
<div id="example-usage-5">
  ### Exemplo de uso {#example-usage-5}
</div>
...
<div id="extractor-options-crawler-options">
  ## Opções do Extrator + Opções do crawler {#extractor-options-crawler-options}
</div>
