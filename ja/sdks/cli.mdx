...
### CLI をセルフホスト版 Firecrawl に接続する {#connect-the-cli-to-self-hosted-firecrawl}
...
#### クロールのステータスを確認する {#check-crawl-status}

<CrawlStatus />

#### クロールオプション {#crawl-options}
...
### 他のツールとの連携 {#combine-with-other-tools}
