...
### Laravel 連携 {#laravel-integration}
...
### Laravel ファサードの使用 {#using-the-laravel-facade}
...
## Laravel AI SDK ツール {#laravel-ai-sdk-tools}
