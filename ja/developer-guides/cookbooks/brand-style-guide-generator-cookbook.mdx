...
<div id="pdf-generation-process">
  ### PDF 生成プロセス {#pdf-generation-process}
</div>
...
<div id="automatic-color-extraction">
  ### 自動カラー抽出 {#automatic-color-extraction}
</div>
...
<div id="typography-documentation">
  ### タイポグラフィドキュメント {#typography-documentation}
</div>
...
<div id="add-component-documentation">
  ### コンポーネント用ドキュメントを追加する {#add-component-documentation}
</div>
...
<div id="export-multiple-formats">
  ### 複数フォーマットでエクスポート {#export-multiple-formats}
</div>
...
<div id="custom-pdf-themes">
  ### カスタム PDF テーマ {#custom-pdf-themes}
</div>
