...
### AI SDK パッケージのインストール {#install-ai-sdk-packages}
...
### AI Elements をインストールする {#install-ai-elements}
...
### OpenAI プロバイダーのインストール {#install-openai-provider}
...
### フロントエンドを理解する {#understanding-the-frontend}
...
### Firecrawl SDK のインストール {#install-firecrawl-sdk}
...
### Tools ファイルを作成する {#create-the-tools-file}
...
### ツールの概要 {#understanding-the-tools}
...
<div id="tool-calling-process">
  ### ツール呼び出しプロセス {#tool-calling-process}
</div>
...
<div id="customization-ideas">
  ## カスタマイズのアイデア {#customization-ideas}
</div>

<div id="add-more-tools">
  ### ツールを追加する {#add-more-tools}
</div>
...
<div id="change-the-ai-model">
  ### AIモデルを変更する {#change-the-ai-model}
</div>
