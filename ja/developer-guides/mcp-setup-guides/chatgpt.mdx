...
ChatGPT がブラウザで Firecrawl を開いたら、サインインし、使用するチームを選択して、アクセスを承認します。サーバー URL に Firecrawl APIキーを入力しないでください。エンドポイントの仕様とその他の対応モードについては、[Connect an MCP Client to Your Account](/ja/developer-guides/mcp-setup-guides/oauth) を参照してください。
