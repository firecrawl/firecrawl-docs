...
ChatGPT がブラウザで Firecrawl を開いたら、サインインし、使用するチームを選択して、アクセスを承認します。サーバー URL に Firecrawl APIキーを入力しないでください。エンドポイントの仕様とその他の対応モードについては、[Human MCP](/ja/mcp-server/human-mcp) を参照してください。
