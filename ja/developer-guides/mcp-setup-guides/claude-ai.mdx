...
Claude がブラウザで Firecrawl を開きます。サインインし、使用するチームを選択して、アクセスを承認してください。生の APIキーがコネクタの URL に含まれることはありません。エンドポイントの仕様やその他の対応モードについては、[Human MCP](/ja/mcp-server/human-mcp) を参照してください。
