...
## Replit Connector の概要 {#replit-connector-overview}
...
## Replit で利用できる Firecrawl の機能 {#firecrawl-capabilities-in-replit}
...
## 課金と認証情報 {#billing-and-credentials}
...
### Integrations に Firecrawl が表示されない {#firecrawl-is-missing-from-integrations}
...
### Agent から API キーを求められる場合 {#agent-asks-for-an-api-key}
...
### Agent が認証情報を取得できないと報告する {#agent-reports-withheld-credentials}
...
### クレジット請求オプションが利用できない {#the-credit-claim-option-is-unavailable}
