...
キーを持たないエージェントの場合は、適切な方法を選ぶには [AI credential routing を使って構築する](/ja/ai-onboarding#get-credentials) を参照してください。WorkOS ID-JAG を発行できる ID 対応エージェントは、正式な [`auth.md`](https://www.firecrawl.dev/auth.md) 仕様に従ってください。
