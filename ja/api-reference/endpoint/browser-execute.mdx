---
title: "ブラウザーコードの実行"
description: "アクティブなクラウドブラウザーセッション内で Playwright コードを実行します。"
openapi: '/ja/api-reference/v2-openapi.json POST /browser/{sessionId}/execute'
---
...
| パラメータ | 型 | 必須 | デフォルト | 説明 |
|-----------|------|----------|---------|-------------|
| `code` | string | はい | - | 実行する Playwright コード（1〜100,000 文字） |
