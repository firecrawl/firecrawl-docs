...
## `repos` と `sources` による検索範囲の制限 {#how-repos-and-sources-scope-a-search}
...
## リポジトリフィルターによる検索範囲の制限 {#how-the-repository-filters-scope-a-search}
...
## `sources` に指定できる値 {#which-values-sources-accepts}
