...
* [`firecrawl/firecrawl-workflows`](https://github.com/firecrawl/firecrawl-workflows) — 反復可能な成果物向けのワークフロー スキル
...
| `firecrawl-research-index`   | アプリコードで論文を検索し、本文箇所を読み、引用をたどる             |
| `firecrawl-developer-index`  | アプリコードで issue、プルリクエスト、README、ドキュメントを検索する |
