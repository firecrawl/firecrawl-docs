...
- **セルフホスト:** セルフホストする場合は[こちら](/contributing/self-host)のガイドをご参照ください。
...
- [**Map**](/features/map): ウェブサイトを入力し、サイト内のすべてのURLを高速で取得
- [**Search**](/features/search): ウェブを検索し、結果からコンテンツ全文を取得
- [**Extract**](/features/extract): 単一ページ、複数ページ、またはサイト全体からAIで構造化データを抽出
...
詳細は [Search Endpoint API Reference](/api-reference/endpoint/search) を参照してください。
