...
import CrawlAsyncOutput from "/snippets/ja/v2/start-crawl/base/output.mdx";
...
import GetCrawlJobCLI from "/snippets/ja/v2/crawl-status/short/cli.mdx";
...
import ScrapeJsonOutput from "/snippets/ja/v2/scrape/json/base/output.mdx";
import ScrapeJsonNoSchemaCURL from "/snippets/ja/v2/scrape/json/no-schema/curl.mdx";
import ScrapeJsonNoSchemaPython from "/snippets/ja/v2/scrape/json/no-schema/python.mdx";
import ScrapeJsonNoSchemaNode from "/snippets/ja/v2/scrape/json/no-schema/js.mdx";
import ScrapeJsonNoSchemaOutput from "/snippets/ja/v2/scrape/json/no-schema/output.mdx";
...
ホスト版で使える使いやすいAPIを提供しています。プレイグラウンドとドキュメントは[こちら](https://firecrawl.dev/playground)。必要に応じてバックエンドをセルフホストすることも可能です。
...
- **LLMフレームワーク**: [LangChain (Python)](https://python.langchain.com/docs/integrations/document_loaders/firecrawl/), [LangChain (JS)](https://js.langchain.com/docs/integrations/document_loaders/web_loaders/firecrawl), [LlamaIndex](https://docs.llamaindex.ai/en/latest/examples/data_connectors/WebPageDemo/#using-firecrawl-reader), [Crew.ai](https://docs.crewai.com/), [Composio](https://composio.dev/tools/firecrawl/all), [PraisonAI](https://docs.praison.ai/firecrawl/), [Superinterface](https://superinterface.ai/docs/assistants/functions/firecrawl), [Vectorize](https://docs.vectorize.io/integrations/source-connectors/firecrawl)
- **ローコードフレームワーク**: [Dify](https://dify.ai/blog/dify-ai-blog-integrated-with-firecrawl), [Langflow](https://docs.langflow.org/), [Flowise AI](https://docs.flowiseai.com/integrations/langchain/document-loaders/firecrawl), [Cargo](https://docs.getcargo.io/integration/firecrawl), [Pipedream](https://pipedream.com/apps/firecrawl/)
- **コミュニティSDK**: [Go](https://docs.firecrawl.dev/sdks/go), [Rust](https://docs.firecrawl.dev/sdks/rust) (v1)
- **その他**: [Zapier](https://zapier.com/apps/firecrawl/integrations), [Pabbly Connect](https://www.pabbly.com/connect/integrations/firecrawl/)
- **セルフホスト:** セルフホストする場合は[こちら](/ja/contributing/self-host)のガイドをご参照ください。

欲しいSDKや統合が見当たりませんか？[issue](https://github.com/firecrawl/firecrawl/issues)を作成してお知らせください。
...
- **カスタマイズ性**: タグの除外、カスタムヘッダーのサポート、最大クロール深度の指定など
- **メディア解析**: PDF、DOCX、画像
