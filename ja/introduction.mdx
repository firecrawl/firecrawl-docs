---
title: はじめに
description: "AIエージェントのためのウェブデータAPI。ウェブを検索し、あらゆるページをスクレイピングして操作できます、すべてを1つのAPIで。"
og:title: "はじめに | Firecrawl"
og:description: "AIエージェントのためのウェブデータAPI。ウェブを検索し、あらゆるページをスクレイピングして操作できます、すべてを1つのAPIで。"
---
...
Firecrawlは、AIエージェントのためのウェブデータAPIです。リアルタイムのウェブを検索・スクレイピングし、操作して、クリーンなMarkdownや構造化データを取得できます。
...
### API を直接使って構築する {#build-directly-with-the-api}
...
## その他の始め方 {#other-ways-to-get-started}

### Firecrawl CLIをインストールする {#install-the-firecrawl-cli}
...
### エージェントを使ってセットアップ {#set-up-with-an-agent}
...
### 直接 Build してテスト {#build-and-test-directly}
...
## Firecrawl でできること {#what-can-firecrawl-do}
...
### なぜ Firecrawl なのか？ {#why-firecrawl}
