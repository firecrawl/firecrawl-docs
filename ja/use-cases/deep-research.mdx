...
<div id="why-researchers-choose-firecrawl">
  ## 研究者が Firecrawl を選ぶ理由 {#why-researchers-choose-firecrawl}
</div>

<div id="accelerate-research-from-weeks-to-hours">
  ### リサーチを数週間から数時間へ {#accelerate-research-from-weeks-to-hours}
</div>
