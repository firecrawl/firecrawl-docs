...
<div id="git-diff-results-example">
  ### Git diff 結果の例: {#git-diff-results-example}
</div>
...
<div id="json-comparison-results-example">
  ### JSON 比較結果の例： {#json-comparison-results-example}
</div>
...
<div id="typescript-interface">
  ### TypeScript インターフェース {#typescript-interface}
</div>
...
<div id="python-data-model">
  ### Python データモデル {#python-data-model}
</div>
...
<div id="basic-scrape-example">
  ### スクレイピングの基本例 {#basic-scrape-example}
</div>
...
<div id="tracking-product-price-changes">
  ### 商品価格の変動を追跡する {#tracking-product-price-changes}
</div>
...
<div id="monitoring-content-changes-with-git-diff">
  ### git diff を使ったコンテンツ変更の監視 {#monitoring-content-changes-with-git-diff}
</div>
