...
<div id="scrape-with-json-endpoint">
  ### /scrape（json使用）エンドポイント {#scrape-with-json-endpoint}
</div>
...
<div id="extracting-without-schema-new">
  ### スキーマなしでの抽出（新機能） {#extracting-without-schema-new}
</div>
...
<div id="json-options-object">
  ### JSON オプションオブジェクト {#json-options-object}
</div>
...
<div id="interacting-with-the-page-with-actions">
  ## アクションでページを操作する {#interacting-with-the-page-with-actions}
</div>
...
<div id="batch-scraping-multiple-urls">
  ## 複数URLのバッチスクレイピング {#batch-scraping-multiple-urls}
</div>
...
<div id="using-fire-1-with-scrape">
  ## Scrape での FIRE-1 の使用 {#using-fire-1-with-scrape}
</div>
...
<div id="example-usage-with-scrape-endpoint">
  ### /scrape エンドポイントでの使用例 {#example-usage-with-scrape-endpoint}
</div>
