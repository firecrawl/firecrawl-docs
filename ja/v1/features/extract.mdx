...
<div id="response-sdks">
  ### レスポンス（SDK） {#response-sdks}
</div>

<ExtractOutput />

<div id="asynchronous-extraction-status-checking">
  ## 非同期抽出とステータス確認 {#asynchronous-extraction-status-checking}
</div>
...
<div id="pending-example">
  #### 保留中のサンプル {#pending-example}
</div>

<ExtractStatusPending />

<div id="completed-example">
  #### 完了例 {#completed-example}
</div>

<ExtractStatusDone />

<div id="extracting-without-a-schema">
  ## スキーマなしでの抽出 {#extracting-without-a-schema}
</div>
...
<div id="improving-results-with-web-search">
  ## ウェブ検索で結果を向上させる {#improving-results-with-web-search}
</div>
...
<div id="example-response-with-web-search">
  ### ウェブ検索を用いたレスポンス例 {#example-response-with-web-search}
</div>
...
<div id="extracting-without-urls">
  ## URLなしでの抽出 {#extracting-without-urls}
</div>
...
<div id="known-limitations-beta">
  ## 既知の制限事項（ベータ） {#known-limitations-beta}
</div>
...
<div id="billing-and-usage-tracking">
  ## 請求と利用状況の追跡 {#billing-and-usage-tracking}
</div>
