...
### ステップ1 — スクレイピングでセッションを開始する {#step-1-scrape-to-start-a-session}
...
### ステップ 2 — 操作を送信 {#step-2-send-interactions}
...
### ステップ3 — セッションを停止する {#step-3-stop-the-session}
...
## 再利用可能なヘルパークラス {#reusable-helper-class}
