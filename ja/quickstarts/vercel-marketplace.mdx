...
## この連携でできること {#what-the-integration-does}
...
## Vercel からインストール {#install-from-vercel}
...
## 動的なページを操作する {#interact-with-dynamic-pages}
...
## Vercel AI SDK で Firecrawl を使う {#use-firecrawl-with-the-vercel-ai-sdk}
