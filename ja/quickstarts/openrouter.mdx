...
* OpenRouter の主要アプリ (Cline、Roo Code、Kilo、Cursor、Continue) の多くは、それ自体が Firecrawl MCP を利用できるエージェントハーネスです。Firecrawl をそれらに直接接続する方法は、[Agent MCP](/ja/mcp-server/agent-mcp) を参照してください。
