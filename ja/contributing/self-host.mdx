...
質問がある場合や参加のサポートが必要な場合は、Discord コミュニティに[こちら](https://discord.gg/gSmWdAkdwd)から参加するか、GitHub で[こちら](https://github.com/firecrawl/firecrawl/issues/new/choose)から Issue を作成してください。
...
| 機能 | Cloud | 自己ホスト |
| --- | --- | --- |
| すべての API エンドポイントがサポート対象 | はい | 常にではない（自己ホストでは `/agent` はサポートされません） |
