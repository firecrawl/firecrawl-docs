...
クロール、バッチスクレイプ、抽出、またはエージェントジョブが開始、進行、完了した瞬間に通知を受け取れます。ステータスをポーリングする代わりに、HTTPS エンドポイントを指定すると、Firecrawl がそこにイベントをリアルタイムで配信します。
...
完全なpayloadの詳細と例については、[Event Types](/ja/webhooks/events)を参照してください。
