...
このエンドポイントは速度を優先しているため、サイト上のリンクをすべて取得できない場合があります。主にウェブサイトのサイトマップを利用し、キャッシュ済みのクロールデータや検索エンジンの結果で補完しています。より網羅的かつ最新の URL リストが必要な場合は、代わりに [/crawl](/ja/features/crawl) エンドポイントの利用をご検討ください。