...
### ファイルダウンロードの処理 {#handling-file-downloads}
...
## agent-browser (Bash モード) {#agent-browser-bash-mode}
...
### インタラクティブ Live View {#interactive-live-view}
...
## Browser を使うべきタイミング {#when-to-use-browser}
