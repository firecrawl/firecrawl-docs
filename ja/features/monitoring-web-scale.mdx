...
## Webスケールのモニターを作成する {#create-a-web-scale-monitor}
...
## 良いゴールとクエリの書き方 {#writing-good-goals-and-queries}
