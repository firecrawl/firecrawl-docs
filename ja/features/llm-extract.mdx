...
<div id="scrape-and-extract-structured-data-with-firecrawl">
  ## Firecrawlで構造化データをスクレイプして抽出する {#scrape-and-extract-structured-data-with-firecrawl}
</div>
...
<div id="json-mode-via-scrape">
  ### /scrape による JSONモード {#json-mode-via-scrape}
</div>
...
<div id="structured-data-without-schema">
  ### スキーマ不要の構造化データ {#structured-data-without-schema}
</div>
...
<div id="real-world-example-extracting-company-information">
  ### 実例：企業情報の抽出 {#real-world-example-extracting-company-information}
</div>
...
### プロンプトインジェクションの検出 {#prompt-injection-detection}
...
## 一貫した抽出のためのヒント {#tips-for-consistent-extraction}
