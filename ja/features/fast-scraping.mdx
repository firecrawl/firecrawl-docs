...
<div id="common-maxage-values">
  ## よく使われる maxAge の値 {#common-maxage-values}
</div>
...
### キャッシュが使用されない場合 {#when-caching-is-bypassed}
...
### キャッシュヒットの一致条件 {#cache-hit-matching}
