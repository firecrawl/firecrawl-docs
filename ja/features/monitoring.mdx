...
### Markdown モード (デフォルト) {#markdown-mode-default}
...
### Mixedモード (JSON + git-diff) {#mixed-mode-json-git-diff}
...
#### 受信者の確認手順 {#recipient-confirmation-process}
...
## スキップされたチェックと一時停止中のモニター {#skipped-checks-and-paused-monitors}
...
### 読み取れる失敗カウンターはありません {#there-is-no-failure-counter-to-read}
