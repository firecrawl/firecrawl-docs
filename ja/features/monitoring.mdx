...
import MonitorFeedbackCTA from "/snippets/ja/monitor-feedback-cta.mdx";
...
1. [monitoring dashboard](https://www.firecrawl.dev/app/monitoring)を開きます。これは、モニターの作成前でも、既存のモニターがある場合でも行えます。
