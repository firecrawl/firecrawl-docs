...
## サポートされているドキュメントフォーマット {#supported-document-formats}
...
## ドキュメントパースの使い方 {#how-to-use-document-parsing}
...
### `/v2/parse` でドキュメントをアップロードする {#upload-documents-with-v2parse}
...
<div id="example-scraping-an-excel-file">
  ### 例: Excel ファイルのスクレイピング {#example-scraping-an-excel-file}
</div>

<ScrapeXLSX />

<div id="example-scraping-a-word-document">
  ### 例：Word ドキュメントのスクレイピング {#example-scraping-a-word-document}
</div>
