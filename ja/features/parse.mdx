...
## ページごとのMarkdown (PDF) {#per-page-markdown-pdf}
...
## レイアウトブロック (PDF) {#layout-blocks-pdf}
...
### 根拠付け: 回答からページへ {#grounding-from-an-answer-back-to-the-page}
...
## 構造化JSON出力 {#structured-json-output}
