...
<div id="performing-a-search-with-firecrawl">
  ## Firecrawl で検索を行う {#performing-a-search-with-firecrawl}
</div>

<div id="search-endpoint">
  ### /search エンドポイント {#search-endpoint}
</div>
...
### 研究カテゴリ検索 {#research-category-search}
...
### Developerカテゴリ検索 {#developer-category-search}
...
### 複合カテゴリ検索 {#mixed-category-search}
...
### カテゴリのレスポンス形式 {#category-response-format}
...
<div id="hd-image-search-with-size-filtering">
  ### サイズフィルタ付きHD画像検索 {#hd-image-search-with-size-filtering}
</div>
...
<div id="search-with-content-scraping">
  ## コンテンツのスクレイピング付き検索 {#search-with-content-scraping}
</div>
...
<div id="response-with-scraped-content">
  ### スクレイプ済みコンテンツを含むレスポンス {#response-with-scraped-content}
</div>
...
<div id="search-then-scrape-two-step-pattern">
  ## Searchしてからスクレイピング (2ステップパターン) {#search-then-scrape-two-step-pattern}
</div>
...
<div id="location-customization">
  ### 場所のカスタマイズ {#location-customization}
</div>
...
<div id="zero-data-retention-zdr">
  ## ゼロデータ保持 (ZDR) {#zero-data-retention-zdr}
</div>
...
### 検索 ZDR と Scrape ZDR の組み合わせ {#combining-search-zdr-with-scrape-zdr}
...
<div id="advanced-scraping-options">
  ## 高度なスクレイピングオプション {#advanced-scraping-options}
</div>
...
## 計測されたパフォーマンス {#measured-performance}
