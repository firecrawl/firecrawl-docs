...
Firecrawlの検索APIを使うと、ウェブ検索を実行し、必要に応じて検索結果を1回の操作でスクレイピングできます。

* 特定の出力形式 (markdown、HTML、links、screenshots) を選択
* カスタマイズ可能なパラメータ (ロケーションなど) を指定してウェブを検索
* 必要に応じて、検索結果からさまざまな形式でコンテンツを取得
