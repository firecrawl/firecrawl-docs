...
## 適切な操作モデルを選択 {#choose-the-right-interaction-model}
...
## プロンプトで操作する {#interact-via-prompting}
...
### プロンプトは小さく、焦点を絞る {#keep-prompts-small-and-focused}
...
### インタラクティブ ライブビュー {#interactive-live-view}
...
## Scrape + Interact での永続プロファイル {#persistent-profiles-with-scrape-interact}
...
### リクエスト本文 (POST) {#request-body-post}
