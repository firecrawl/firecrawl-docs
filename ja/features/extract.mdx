...
<div id="improving-results-with-web-search">
  ## Web検索で結果を向上させる {#improving-results-with-web-search}
</div>
...
<div id="example-response-with-web-search">
  ### ウェブ検索を使った応答例 {#example-response-with-web-search}
</div>
...
<div id="extracting-without-urls">
  ## URL なしでの抽出 {#extracting-without-urls}
</div>
...
## 課金と利用状況の追跡 {#billing-and-usage-tracking}
