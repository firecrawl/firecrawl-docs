...
Firecrawl offers flexible subscription plans to suit different use cases. **Note: Firecrawl does not offer a pay-as-you-go model.** Instead, we provide tiered subscription plans with monthly credit allowances. If you're testing Firecrawl before committing to a plan, you can start with a lower-tier subscription and upgrade as needed. All plans include the ability to use auto-recharge to purchase additional credits when you approach your monthly limit—the larger your plan, the more cost-effective these auto-recharge packs become. For high-volume or enterprise use cases, contact our sales team for custom arrangements. Visit the [pricing page](https://firecrawl.dev/pricing) to view all available plans and features.
