---
title: Introduction
description: "The web data API for AI agents. Search the web, scrape any page, and interact with it through one API."
og:title: "Introduction | Firecrawl"
og:description: "The web data API for AI agents. Search the web, scrape any page, and interact with it through one API."
---
