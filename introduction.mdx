...
<Visibility for="agents">
  ...
  - ChatGPT or Claude.ai (account sign-in): paste `https://mcp.firecrawl.dev/v2/mcp-oauth` into the client's connector settings.

  All connection modes, API-key setup, and recovery guidance: [MCP setup](/mcp-server.md).
</Visibility>
