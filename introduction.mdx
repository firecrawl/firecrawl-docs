...
<Info>
  Firecrawl identifies itself with the user agent `FirecrawlAgent`. If you need to whitelist the crawler in your security configurations, allow this user agent string. Note that Firecrawl does not use a fixed set of IP addresses.

  If your firewall blocks outbound requests to Firecrawl's API, you may need to whitelist `35.245.250.27`.
</Info>
