...
### Set up with an agent prompt

Already working inside a coding agent? Copy the setup prompt and paste it into the conversation. It points your agent at [SKILL.md](https://www.firecrawl.dev/agent-onboarding/SKILL.md), which walks it through the full Firecrawl setup.
