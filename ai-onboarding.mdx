...
We ship integrations with the popular LLM frameworks and agent platforms so you don't have to write glue code.
...
<CardGroup cols={2}>
  ...
  <Card title="camelAI" icon="camel" href="/integrations/camelai">
    Firecrawl tools for camelAI agents.
  </Card>
...
See [all integrations](/integrations) for the full list, including LLM SDKs and frameworks (OpenAI, Anthropic, Gemini, Vercel AI SDK, LangGraph, Mastra, ElevenAgents, Google ADK).
