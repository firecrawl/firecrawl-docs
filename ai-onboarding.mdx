...
Firecrawl supports two credential paths: WorkOS ID-JAG registration for identity-aware agents, and human-in-the-loop CLI/browser onboarding when a person needs to sign in or create a dashboard API key.
