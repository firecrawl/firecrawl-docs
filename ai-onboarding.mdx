...
<Card title="MCP Server" icon="plug" href="/mcp-server">
  ...
  [Windsurf quickstart](/quickstarts/windsurf).
</Card>
...
<Steps>
  ...
  <Step title="MCP docs server">
    For a structured approach using MCP tools, connect the Firecrawl MCP server in Codex, Cursor, Claude Code, Claude Desktop, or another compatible client. See [Getting started with MCP](/mcp-server) for hosted setup. Windsurf users should follow the [Windsurf quickstart](/quickstarts/windsurf).
  </Step>
