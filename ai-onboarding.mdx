...
<CardGroup cols={3}>
  ...
  <Card title="Claude Code" icon="terminal" href="/developer-guides/mcp-setup-guides/claude-code">
    Anthropic's CLI — set up Firecrawl MCP in Claude Code.
  </Card>
  <Card title="Cursor" icon="arrow-pointer" href="/developer-guides/mcp-setup-guides/cursor">
    IDE agent — one-click install Firecrawl MCP in Cursor.
  </Card>
  <Card title="OpenCode" icon="code-branch" href="/developer-guides/mcp-setup-guides/opencode">
    Wire Firecrawl MCP into OpenCode.
  </Card>
  <Card title="Codex CLI" icon="code" href="/developer-guides/mcp-setup-guides/codex-cli">
    Wire Firecrawl MCP into OpenAI Codex CLI.
  </Card>
  <Card title="OpenRouter" icon="route" href="/developer-guides/llm-sdks-and-frameworks/openrouter">
    Pair any OpenRouter model with Firecrawl web tools.
  </Card>
  <Card title="Amp" icon="bolt" href="/developer-guides/mcp-setup-guides/amp">
    Wire Firecrawl MCP into Sourcegraph Amp.
  </Card>
  <Card title="Windsurf" icon="wind" href="/developer-guides/mcp-setup-guides/windsurf">
    Agentic IDE — set up Firecrawl MCP in Windsurf.
  </Card>
  <Card title="Antigravity" icon="rocket" href="/developer-guides/mcp-setup-guides/antigravity">
    Add Firecrawl MCP to Google's agentic IDE.
  </Card>
  <Card title="Gemini CLI" icon="gem" href="/developer-guides/mcp-setup-guides/gemini-cli">
    Wire Firecrawl MCP into Google Gemini CLI.
  </Card>
  <Card title="Nous Research" icon="brain" href="/developer-guides/llm-sdks-and-frameworks/nous-research">
    Use Firecrawl as a tool with Hermes models.
  </Card>
  <Card title="AutoGen" icon="robot" href="/developer-guides/llm-sdks-and-frameworks/autogen">
