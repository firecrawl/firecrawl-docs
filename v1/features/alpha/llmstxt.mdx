...
<Warning>
  This API is being deprecated in favor of our main endpoints. Here is an
  example repo that generates LLMs.txt files:
  [https://github.com/mendableai/create-llmstxt-py](https://github.com/mendableai/create-llmstxt-py).
  This API endpoint will still remain active but we will no longer be
  maintaining it after June 30, 2025.
</Warning>
