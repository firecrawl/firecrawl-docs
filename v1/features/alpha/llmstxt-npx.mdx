...
description: "Generate LLMs.txt files from any website in CLI using our NPX package"
og:title: "LLMs.txt NPX Generator | Firecrawl"
og:description: "Transform websites into clean, LLM-ready text files using NPX in the CLI"
icon: "file-text"
