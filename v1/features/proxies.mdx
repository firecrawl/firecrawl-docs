...
<Warning>
  The list of supported proxy locations was last updated on May 15, 2025.
...
<Info>
  If you request a country where a proxy is not available, Firecrawl will use
  the closest available region (EU or US) and set the browser location to your
  requested country.
</Info>
