...
Reduce crawl latency when you do not need every page to be fetched again. Add `maxAge` to your `scrapeOptions` to use cached page data when available.
...
- If yes, returns the matching cached result without re-scraping that page
