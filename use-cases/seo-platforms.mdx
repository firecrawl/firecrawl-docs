...
- **AI Readability Audit**: Score how clearly each page communicates with AI assistants and flag pages that need restructuring.
- **Content Analysis**: Extract headings, schema, and body content to grade structure, depth, and semantic coverage.
- **Technical SEO**: Surface broken links, redirect chains, canonical issues, and missing meta tags across an entire site.
- **Search Tracking**: Pull SERP results on a schedule to monitor keyword positions and movement over time.
