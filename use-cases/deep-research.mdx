...
### Cover more sources in less time
Discover, read, and synthesize information from hundreds of pages in a single run. You focus on analysis instead of manually searching and copying content from each source.

### Follow citation chains automatically
Build agents that walk reference links and surface related sources, reducing the risk of missing critical information that keyword search alone leaves behind.
