...
Choose the output that fits your pipeline: Markdown, HTML, JSON, or full-page screenshots.

### Images and visuals
Pull images and screenshots from source pages to ground decks, emails, and social posts in real visuals.

### News and trending content
Surface fresh news stories alongside scraped pages so your generated content stays current.
