...
You choose the setup when you create the integration. Adding or removing Gateway later requires contacting Firecrawl. See the [Partner API page](https://www.firecrawl.dev/partner-program) for an overview.
...
Create your integration in the [Firecrawl dashboard](https://www.firecrawl.dev/app/partner-api): sign in, choose Partner API or Gateway, accept the agreement, and copy your partner key. Then call the endpoints above from your server. Questions, or a larger integration in mind? Write to [partnerships@firecrawl.dev](mailto:partnerships@firecrawl.dev).
