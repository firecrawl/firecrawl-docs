...
All SDK methods support standard `try/except` error handling:
...
- **429 (Rate Limit)**: Implement exponential backoff retries
- **401/403 (Auth)**: Check your API key
- **402 (Payment Required)**: Upgrade your plan or add credits
- **5xx (Server Error)**: Retry with exponential backoff

### Advanced Retry Strategies

For production applications, implement sophisticated retry logic:

**See [Error Handling and Retries](/developer-guides/advanced-guides/error-handling-and-retries)** for complete examples including:
