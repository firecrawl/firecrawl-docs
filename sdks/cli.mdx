...
The fastest setup is a single command that installs the CLI, registers Firecrawl skills with any detected AI coding agent (such as Claude Code, Antigravity, and OpenCode), and opens a browser to authenticate.
