...
| `--bash` | Execute a local bash command with `CDP_URL` injected as an env variable. Use this with [agent-browser](https://github.com/vercel-labs/agent-browser) or any CDP-compatible tool. |
