...
The fastest way to get started is to install Firecrawl as a skill into your AI coding agent. The agent then calls the CLI automatically whenever it needs to scrape, search, or crawl the web.
...
<Note>
After installing the skill, restart your agent so it can discover it.
</Note>

If you prefer to use the CLI directly from your terminal, install it globally with npm:
