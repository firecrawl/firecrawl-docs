---
title: 'Skills + CLI'
description: 'Firecrawl CLI is a command-line interface for AI agents to get web data from the web directly from their terminals.'
icon: 'terminal'
og:title: "CLI | Firecrawl"
og:description: "Firecrawl CLI is a command-line interface for AI agents to get web data from the web directly from their terminals."
---
