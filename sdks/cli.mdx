...
Launch and manage cloud browser sessions for automation.
...
|------------|-------------|
| `launch` | Launch a new cloud browser session |
| `execute <code>` | Execute Playwright code in a session |
...
| `--ttl-inactivity <seconds>` | Inactivity timeout (range: 10–3600) |
