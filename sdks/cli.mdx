---
title: 'Skills + CLI'
description: 'Firecrawl Skills is an easy way to get AI agents to use Firecrawl through the CLI. AI agents can get web data through a better and more context efficient interface'
icon: 'terminal'
og:title: "CLI | Firecrawl"
og:description: "Firecrawl Skills is an easy way to get AI agents to use Firecrawl through the CLI. AI agents can get web data through a better and more context efficient interface"
---
...
If you are using in any AI agent like Claude Code, you can install the Firecrawl skill with and the agent will be able download and set it up for you.
