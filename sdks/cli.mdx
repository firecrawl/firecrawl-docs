...
Or with [SkillKit](https://github.com/rohitg00/skillkit):

```bash
npx skillkit install firecrawl/cli
```

SkillKit can also translate skills across 32+ AI agents and publish your own skills for recommendations:
