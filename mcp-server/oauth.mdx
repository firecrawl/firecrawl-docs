...
<CardGroup cols={2}>
  ...
  <Card title="Add to Claude" icon="sparkles" href="https://claude.ai/new#settings/customize-connectors/66568f32-0968-4801-94e9-d7eec28a3b2d" cta="Open in Claude" arrow>
    Install the native Firecrawl connector in Claude.ai.
  </Card>
</CardGroup>

Short walkthroughs: [ChatGPT](/developer-guides/mcp-setup-guides/chatgpt) and [Claude.ai](/developer-guides/mcp-setup-guides/claude-ai).
