...
<CardGroup cols={2}>
  ...
  <Card title="Add to Claude" icon="sparkles" href="https://claude.ai/directory/connectors/firecrawl" cta="Open in Claude" arrow>
...
<Card title="Use an API key" icon="key" href="/mcp-server/keyless#add-an-api-key" cta="Go to For Agents" arrow>
  Prefer a key in your client config instead of browser sign-in? Setup lives on For Agents (`/v2/mcp`).
</Card>
