...
Use keyless access for a quick trial. Use an API key when the connection must run reliably without a person present. If you want to sign in through a browser instead, use [OAuth](/mcp-server/oauth).
