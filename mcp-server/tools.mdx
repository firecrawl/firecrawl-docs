...
These tools are not part of the hosted keyless surface. For GitHub issues, pull requests, and READMEs, use [`firecrawl_developer_search`](#12b-developer-search-tool-firecrawl_developer_search).
