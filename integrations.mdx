...
<CardGroup cols={2}>
  <Card title="Vercel Marketplace" icon="bolt" href="quickstarts/vercel-marketplace">
    Add Firecrawl to Vercel projects with automatic API key setup
  </Card>
  <Card title="Replit" icon="cube" href="developer-guides/workflow-automation/replit">
    Official Replit Connector for search, scrape, and interact in Agent apps
  </Card>
  <Card
    title="Langchain"
    icon={
