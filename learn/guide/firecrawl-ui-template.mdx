...
description: "A guide to setting up a UI for web ingestion using Firecrawl with React."
og:title: "Web Connector UI Template | Firecrawl"
og:description: "Learn how to set up a UI for web ingestion using Firecrawl with React."
---
...
This template simplifies the creation of a web connector UI for Firecrawl using React.
It includes a pre-built component that interfaces with the Firecrawl API, enabling you to quickly set up a web crawling and scraping interface for users to extract data for their AI applications.
...
- npm
- Make sure you have installed [shadcn](https://github.com/shadcn-ui/ui)
- Make sure you have installed [tailwindcss](https://tailwindcss.com/docs/installation)

## Getting Started

1. Install dependencies:

- Install the [shadcn components](https://github.com/shadcn-ui/ui) you will need:
...
2. Create a `lib/utils.ts` file and add the following code:
...
3. Copy and paste our main ingestion component. **Make sure to replace the `FIRECRAWL_API_KEY` with your key.**

<Accordion title="Ingestion Component (ingestion.tsx)">
```jsx
...
(currentPage - 1) _ urlsPerPage,
currentPage _ urlsPerPage
);
