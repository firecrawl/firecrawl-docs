...
description: "Complete reference for all Firecrawl operations in n8n"
---
...
|----------|----------|----------|
| **Market Research** | → [View Workflow](https://n8n.io/workflows/4588?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | Research teams tracking news & trends |
| **Compliance** | → [View Workflow](https://n8n.io/workflows/5591?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | Daily monitoring with alerts |
| **Price Tracking** | → [View Workflow](https://n8n.io/workflows/3101?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | E-commerce competitor analysis |
| **Sales Leads** | → [View Workflow](https://n8n.io/workflows/5786?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | B2B prospecting & outreach |
| **Lead Outreach** | → [View Workflow](https://n8n.io/workflows/8520?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | Personalized email automation |
| **Product Updates** | → [View Workflow](https://n8n.io/workflows/5510?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | React/JS app monitoring |
| **AI Research** | → [View Workflow](https://n8n.io/workflows/6343?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | GPT-powered web research |
| **Local Businesses** | → [View Workflow](https://n8n.io/workflows/4573?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | Google Maps lead generation |
| **Developer Tools** | → [View Workflow](https://n8n.io/workflows/7394?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | GitHub trending tracking |
| **SEO Content** | → [View Workflow](https://n8n.io/workflows/8289?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | Research-backed content briefs |
| **SEO Analysis** | → [View Workflow](https://n8n.io/workflows/7379?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | Website structure analysis |
| **Content Strategy** | → [View Workflow](https://n8n.io/workflows/7372?utm_source=firecrawl&utm_medium=documentation&utm_campaign=n8n-nodes-reference) | Google Trends automation |
