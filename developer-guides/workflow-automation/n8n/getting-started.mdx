...
![Firecrawl and n8n integration](/images/guides/n8n/n8n+firecrawl.png)
...
![Firecrawl api key section](/images/guides/n8n/firecrawl-api-key.gif)
...
![n8n Cloud homepage showing the signup options](/images/guides/n8n/n8n-cloud.png)
...
![Terminal showing the docker commands being executed with n8n starting up](/images/guides/n8n/self-hosted.gif)
...
![n8n self-hosted welcome screen at localhost:5678](/images/guides/n8n/local-n8n-register.gif)
...
![n8n dashboard showing the workflow list view with "Create new workflow" button](/images/guides/n8n/n8n-interface.png)
...
![Empty n8n workflow canvas with the "+" button visible in the center](/images/guides/n8n/n8n-workflow.png)
...
![Clicking the + button, typing "Firecrawl" in the search, and the Firecrawl node appearing](/images/guides/n8n/add-firecrawl-node.gif)
...
![Firecrawl node now added to the canvas, showing as a box with the Firecrawl logo](/images/guides/n8n/adding-n8n-node.gif)
...
![Firecrawl node configuration panel showing the credentials dropdown with "Create New Credential" option](/images/guides/n8n/n8n-firecrawl-credentials.gif)
...
![Selecting Scrape operation, entering example.com URL, and clicking Test step button](/images/guides/n8n/firecrawl-test.gif)
...
![Creating a bot with BotFather, showing the full conversation flow](/images/guides/n8n/telegram-bot-creation.png)
...
![Browser showing Telegram API getUpdates response with chat ID highlighted](/images/guides/n8n/find-telegram-key.gif)
...
![Schedule Trigger configured for daily 9 AM execution](/images/guides/n8n/creating-cron-node.gif)
...
![Adding and configuring Firecrawl node with the blog URL and Summary format selected](/images/guides/n8n/firecrawl-node-adding.gif)
...
![Telegram credential configuration with bot token field](/images/guides/n8n/telegram-credential-configuration.gif)
...
![Configuring Telegram node and mapping the summary field to the message text](/images/guides/n8n/testing-telegram-message.gif)
...
![Complete workflow showing Schedule Trigger → Firecrawl → Telegram with all nodes connected](/images/guides/n8n/finished-first-example.png)
...
![Firecrawl Search node configuration with "ai news" query](/images/guides/n8n/ai-news-query.gif)
...
![Adding Code node and pasting the formatting script](/images/guides/n8n/add-code-node.gif)

4. Update **Telegram** node (using your saved credential):
   - **Text**: Drag the `message` field from Code node

![Complete workflow execution with AI news sent to Telegram](/images/guides/n8n/executing-telegram.gif)
...
![OpenAI dashboard showing API key creation](/images/guides/n8n/openai-console.gif)
...
![Adding AI Agent node, dragging input from Code node, and connecting OpenAI as LLM](/images/guides/n8n/add-ai-agent.gif)
...
![Adding OpenAI credentials to the AI Agent node](/images/guides/n8n/adding-openai-credentials.gif)
...
![Adding the system prompt to the AI Agent node](/images/guides/n8n/insert-system-prompt.gif)
...
![Complete workflow execution with AI-generated summary sent to Telegram](/images/guides/n8n/final-output.gif)
