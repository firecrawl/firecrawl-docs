...
description: "Official tutorials and Zapier integration templates for Firecrawl + Zapier automation"
---
...
**Templates:**
- → [Hourly URL crawling](https://zapier.com/apps/firecrawl/integrations/schedule/1734988)
- → [Daily structured data extraction](https://zapier.com/apps/firecrawl/integrations/schedule/255604981)
...
<CardGroup cols={2}>
  <Card title="Daily Data Extraction" icon="calendar-day" href="https://zapier.com/apps/firecrawl/integrations/schedule/255604981">
    Extract structured data every day automatically
  </Card>

  <Card title="Hourly Crawling" icon="clock" href="https://zapier.com/apps/firecrawl/integrations/schedule/1734988">
    Continuous website monitoring for price tracking
  </Card>

  <Card title="Google Sheets Trigger" icon="table" href="https://zapier.com/apps/firecrawl/integrations/google-sheets/255622819">
    Dynamic data enrichment from spreadsheets
  </Card>

  <Card title="Form Submissions" icon="file-invoice" href="https://zapier.com/apps/firecrawl/integrations/gravity-forms/1802185">
    Scrape websites when forms are submitted
  </Card>
</CardGroup>
...
<Tabs>
  <Tab title="Competitor Monitoring">
```
Schedule (Daily)
  → Firecrawl (Scrape competitor site)
  → Google Sheets (Log data)
  → Slack (Alert if changes)
```
  </Tab>
...
Google Forms (New submission)
  ...
  → Airtable (Create enriched record)
  → HubSpot (Add to CRM)
```
  </Tab>
...
```
Schedule (Hourly)
  → Firecrawl (Scrape product pages)
  → Filter by Zapier (Check threshold)
  → Telegram (Send alert)
```
  </Tab>

  <Tab title="SEO Monitoring">
```
Schedule (Weekly)
  → Firecrawl (Crawl website)
  → AI by Zapier (Analyze issues)
  → Airtable (Track changes)
  → Slack (Weekly report)
```
  </Tab>
</Tabs>
