...
Hermes models support OpenAI-compatible tool calls, so Firecrawl plugs in as a function the model can invoke. You can reach Hermes via the Nous Portal API, via [OpenRouter](/developer-guides/llm-sdks-and-frameworks/openrouter), or through Nous's Forge agent platform.
...
See the [OpenRouter guide](/developer-guides/llm-sdks-and-frameworks/openrouter) for the full pattern.
