...
Claude opens Firecrawl in your browser. Sign in, choose the team to use, and approve access. Your raw API key is never placed in the connector URL. See [Human MCP](/mcp-server/human-mcp) for the endpoint contract and other supported modes.
