...
When ChatGPT opens Firecrawl in your browser, sign in, choose the team to use, and approve access. Do not put a Firecrawl API key in the server URL. See [Connect an MCP Client to Your Account](/developer-guides/mcp-setup-guides/oauth) for the endpoint contract and other supported modes.
