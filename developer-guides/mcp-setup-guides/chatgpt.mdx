...
When ChatGPT opens Firecrawl in your browser, sign in, choose the team to use, and approve access. Do not put a Firecrawl API key in the server URL. See [For Humans](/mcp-server/oauth) for the sign-in setup and the API-key alternative.
