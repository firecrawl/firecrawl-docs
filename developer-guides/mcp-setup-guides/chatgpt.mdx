...
When ChatGPT opens Firecrawl in your browser, sign in, choose the team to use, and approve access. Do not put a Firecrawl API key in the server URL. See [Human MCP](/mcp-server/human-mcp) for the endpoint contract and other supported modes.
