...
这些工具不属于托管免密钥服务的一部分。对于 GitHub issue、已合并的 pull request 和 README，请使用 [`firecrawl_developer_search`](#12b-developer-search-tool-firecrawl_developer_search)。

<div id="12b-developer-search-tool-firecrawl_developer_search">
  ### 12b. 开发者搜索工具 (`firecrawl_developer_search`)
</div>

可单独搜索[开发者索引](/zh/features/developer)，涵盖 GitHub issue、已合并的 pull request、仓库 README 和精选文档站点。该工具为只读，并返回按相关性排序的结果及其匹配段落。
