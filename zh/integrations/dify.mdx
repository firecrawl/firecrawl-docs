...
## Dify 集成概览 {#dify-integration-overview}
...
## Dify 中的 Firecrawl 工具 {#firecrawl-tools-in-dify}
...
## Firecrawl actions {#firecrawl-actions}
...
## Dify 与其他平台对比 {#dify-vs-other-platforms}
...
## 将网站同步到 Dify 知识库 {#sync-websites-into-the-dify-knowledge-base}

Firecrawl 还可以将网页抓取为 Markdown，并通过 [Dify Cloud](https://cloud.dify.ai/) 将其导入 Dify 知识库。

### 配置 Firecrawl {#configuring-firecrawl}
...
### 抓取目标网页 {#scrape-the-target-webpage}
