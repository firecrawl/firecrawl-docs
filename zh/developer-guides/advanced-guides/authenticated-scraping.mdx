---
title: "身份验证抓取"
description: "了解如何使用 Cookie 抓取需登录访问的内容"
---

<Info>
本指南演示如何使用浏览器 DevTools 中的会话 Cookie 抓取需要身份验证的内容。非常适合用于内部工具、管理后台，以及你拥有登录凭据的受控系统。
</Info>
...
进行需要身份验证的抓取，推荐使用**基于 Cookie 的身份验证**，步骤如下：

1. 在你的应用中手动登录
2. 从 DevTools 中提取会话 Cookie
3. 使用该 Cookie 搭配 Firecrawl 访问受保护页面
...
内部工具的 Cookie 一般有效期更长，因此此方法非常适合需要定期重复的抓取任务。
</Note>
