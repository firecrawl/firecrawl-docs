...
<div id="pdf-generation-process">
  ### PDF 生成流程 {#pdf-generation-process}
</div>
...
<div id="branding-profile-structure">
  ### 品牌配置结构 {#branding-profile-structure}
</div>
...
<div id="automatic-color-extraction">
  ### 自动颜色提取 {#automatic-color-extraction}
</div>
...
<div id="typography-documentation">
  ### 排版规范文档 {#typography-documentation}
</div>
...
<div id="customization-ideas">
  ## 自定义方案示例 {#customization-ideas}
</div>

<div id="add-component-documentation">
  ### 添加组件文档 {#add-component-documentation}
</div>
...
<div id="export-multiple-formats">
  ### 导出多种 formats {#export-multiple-formats}
</div>
