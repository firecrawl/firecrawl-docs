...
<Steps>
  ...
  <Step title="安装依赖项">
### 安装 AI SDK 包 {#install-ai-sdk-packages}
...
### 安装 AI Elements {#install-ai-elements}
...
### 安装 OpenAI Provider {#install-openai-provider}
...
### 了解前端 {#understanding-the-frontend}
...
### 安装 Firecrawl SDK {#install-firecrawl-sdk}
...
### 了解这些工具 {#understanding-the-tools}
...
<div id="web-search-toggle">
  ### Web Search 开关 {#web-search-toggle}
</div>
