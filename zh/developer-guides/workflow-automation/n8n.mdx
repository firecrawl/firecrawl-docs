...
<Tip>
  **n8n Cloud 用户：** 添加 Firecrawl 节点时，无需手动输入 API 密钥，你可以使用一键式 **“Connect to Firecrawl”** OAuth 按钮。这会自动创建一个与你的 n8n 账户关联的全新 Firecrawl 团队，并授予 **100,000 免费额度**。要在 [Firecrawl Dashboard](https://www.firecrawl.dev/app/usage) 中查看这些额度，请确保你已通过左上角的团队选择器切换到与你的 n8n 关联的团队。
</Tip>
