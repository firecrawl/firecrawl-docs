...
<div id="action-execution-notes">
  #### actions 执行说明 {#action-execution-notes}
</div>
...
<div id="advanced-action-examples">
  #### 高级操作示例 {#advanced-action-examples}
</div>
...
## 通过 formats 提取 JSON {#json-extraction-via-formats}
...
<div id="check-agent-status">
  ### 检查 agent 状态 {#check-agent-status}
</div>
...
### 爬取 prompt 和参数预览 {#crawl-prompt-and-params-preview}
...
<div id="sitemap-and-deduplication">
  #### Sitemap 和去重 {#sitemap-and-deduplication}
</div>
...
<div id="scrape-options-for-crawl">
  #### 爬取任务的抓取选项 {#scrape-options-for-crawl}
</div>
...
<div id="whitelisting-firecrawl">
  ## Firecrawl 白名单设置 {#whitelisting-firecrawl}
</div>

### 允许 Firecrawl 抓取你的网站 {#allowing-firecrawl-to-scrape-your-website}
...
<div id="allowing-your-application-to-call-the-firecrawl-api">
  ### 允许你的应用调用 Firecrawl API {#allowing-your-application-to-call-the-firecrawl-api}
</div>
