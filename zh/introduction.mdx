...
我们提供易用的托管版 API。你可以在[这里](https://firecrawl.dev/playground)找到 Playground 和文档。你也可以选择自托管后端。
...
* [x] **社区 SDK**：[Go](https://docs.firecrawl.dev/sdks/go)、[Rust](https://docs.firecrawl.dev/sdks/rust)（v1）
...
**自托管：** 自托管请参考[此处](/zh/contributing/self-host)的指南。
