...
- **自托管：** 请参考[此处](/contributing/self-host)的指南。
...
- [**Map**](/features/map): 输入一个网站，极速获取该网站的所有 URL
- [**Search**](/features/search): 搜索全网，并获取结果的完整内容
- [**Extract**](/features/extract): 使用 AI 从单页、多页或整站提取结构化数据。
...
详见[Search Endpoint API Reference](/api-reference/endpoint/search)。
