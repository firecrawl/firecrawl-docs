...
import GetCrawlJobCLI from "/snippets/zh/v2/crawl-status/short/cli.mdx";
...
* **SDK**： [Python](https://docs.firecrawl.dev/sdks/python)、[Node](https://docs.firecrawl.dev/sdks/node)、[CLI](https://docs.firecrawl.dev/sdks/cli)
