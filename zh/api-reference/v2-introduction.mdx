...
如果你是没有密钥的代理，请参见 [使用 AI 凭证路由构建](/zh/ai-onboarding#get-credentials) 以选择正确的方式。具备身份感知能力并且能够签发 WorkOS ID-JAG 的代理，应遵循规范的 [`auth.md`](https://www.firecrawl.dev/auth.md) 标准。
