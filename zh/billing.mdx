...
<AccordionGroup>
  ...
  <Accordion title="我如何知道还剩多少额度？">
    在 [firecrawl.dev/app](https://www.firecrawl.dev/app) 的仪表盘中查看，或者以编程方式调用 [Credit Usage API endpoint](/zh/api-reference/endpoint/credit-usage)。
  </Accordion>
  ...
  <Accordion title="在哪里使用优惠码？">
    这取决于优惠券类型。**额度优惠券**可在仪表盘的 Billing 部分中使用。**订阅优惠券** (即套餐价格折扣) 只能在订阅或更改套餐时于 Stripe 结账页面使用。
  </Accordion>
