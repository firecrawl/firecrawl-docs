...
<Note>
  对于超出 Growth 方案的大规模用量，Firecrawl 提供 **Scale (扩展)&#x20;**&#x20;和 **Enterprise** 方案，包含 100 万+ 额度、150+ 并发浏览器、专属支持、SLA、批量折扣、零数据留存以及 SSO。详情请访问 [Enterprise 页面](https://www.firecrawl.dev/enterprise)。
</Note>
