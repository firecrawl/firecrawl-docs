...
| **Search**  | 2 credits / 10 results     | 搜索全网，并可选地抓取搜索结果。对每个被抓取的结果将按页面收取额外的抓取额度。企业版 ZDR 搜索的消耗为 10 credits / 10 results (参见 [ZDR Search](/zh/features/search#zero-data-retention-zdr)) 。 |
