...
Firecrawl 采用开源模式，遵循 [AGPL-3.0 许可证](https://github.com/mendableai/firecrawl/blob/main/LICENSE)。
...
我们欢迎一切贡献！在提交 pull request 之前，请先阅读我们的[贡献指南](https://github.com/mendableai/firecrawl/blob/main/CONTRIBUTING.md)。