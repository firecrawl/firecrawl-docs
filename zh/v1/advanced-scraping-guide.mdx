...
<div id="basic-scraping-with-firecrawl-scrape">
  ## 使用 Firecrawl 进行基础抓取 (/scrape) {#basic-scraping-with-firecrawl-scrape}
</div>
...
<div id="setting-the-content-formats-on-response-with-formats">
  ### 使用 `formats` 设置响应中的内容格式 {#setting-the-content-formats-on-response-with-formats}
</div>
...
<div id="getting-the-full-page-content-as-markdown-with-onlymaincontent">
  ### 使用 `onlyMainContent` 以 markdown 获取整页内容 {#getting-the-full-page-content-as-markdown-with-onlymaincontent}
</div>
...
<div id="setting-the-tags-to-include-with-includetags">
  ### 使用 `includeTags` 设置要包含的标签 {#setting-the-tags-to-include-with-includetags}
</div>
...
<div id="setting-the-tags-to-exclude-with-excludetags">
  ### 使用 `excludeTags` 设置要排除的标签 {#setting-the-tags-to-exclude-with-excludetags}
</div>
...
<div id="waiting-for-the-page-to-load-with-waitfor">
  ### 使用 `waitFor` 等待页面加载 {#waiting-for-the-page-to-load-with-waitfor}
</div>
...
<div id="setting-the-maximum-timeout">
  ### 设置最大 `timeout` {#setting-the-maximum-timeout}
</div>
...
<div id="parsing-pdf-files-with-parsepdf">
  ### 使用 `parsePDF` 解析 PDF 文件 {#parsing-pdf-files-with-parsepdf}
</div>
...
<div id="using-the-llm-extraction">
  ### 使用 LLM 提取功能 {#using-the-llm-extraction}
</div>
...
<div id="crawling-multiple-pages">
  ## 爬取多个页面 {#crawling-multiple-pages}
</div>
...
<div id="mapping-website-links-with-map">
  ## 使用 `/map` 映射网站链接 {#mapping-website-links-with-map}
</div>
