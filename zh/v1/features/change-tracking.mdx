...
<div id="git-diff-results-example">
  ### Git Diff 比对结果示例： {#git-diff-results-example}
</div>
...
<div id="json-comparison-results-example">
  ### JSON 比较结果示例： {#json-comparison-results-example}
</div>
...
<div id="tracking-product-price-changes">
  ### 监控产品价格变动 {#tracking-product-price-changes}
</div>
...
<div id="monitoring-content-changes-with-git-diff">
  ### 使用 git diff 监控内容变更 {#monitoring-content-changes-with-git-diff}
</div>
