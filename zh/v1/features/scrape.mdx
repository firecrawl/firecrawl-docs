...
<div id="extracting-without-schema-new">
  ### 无需 schema 的提取 (新) {#extracting-without-schema-new}
</div>
...
<div id="using-fire-1-with-scrape">
  ## 在 Scrape 中使用 FIRE-1 {#using-fire-1-with-scrape}
</div>
...
<div id="example-usage-with-scrape-endpoint">
  ### 使用 /scrape 端点的示例 {#example-usage-with-scrape-endpoint}
</div>
