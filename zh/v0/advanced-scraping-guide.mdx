...
<div id="getting-cleaner-content-with-onlymaincontent">
  ### 使用 `onlyMainContent` 获取更纯净的内容 {#getting-cleaner-content-with-onlymaincontent}
</div>
...
<div id="getting-the-html-with-includehtml">
  ### 使用 `includeHtml` 获取 HTML {#getting-the-html-with-includehtml}
</div>
...
<div id="getting-the-raw-html-with-includerawhtml">
  ### 使用 `includeRawHtml` 获取原始 HTML {#getting-the-raw-html-with-includerawhtml}
</div>
...
<div id="getting-a-screenshot-of-the-page-with-screenshot">
  ### 使用 `screenshot` 获取页面截图 {#getting-a-screenshot-of-the-page-with-screenshot}
</div>
...
<div id="extractor-options-crawler-options">
  ## 提取器选项 + 爬取选项 {#extractor-options-crawler-options}
</div>
