...
* 许多热门的 OpenRouter 应用 (Cline、Roo Code、Kilo、Cursor、Continue) 本身就是可使用 Firecrawl MCP 的代理框架——请参见 [MCP Server](/zh/mcp-server)，了解如何将 Firecrawl 直接接入这些应用。
* 对于大型任务，请使用 [batch scrape](/zh/features/batch-scrape)，以控制在 LLM 上下文预算范围内。