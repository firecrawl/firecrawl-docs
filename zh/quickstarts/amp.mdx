...
此配置使用免密钥 Firecrawl 工具集。如需连接账户的设置，请参见[Human MCP](/zh/mcp-server/human-mcp)；如需无人值守设置，请参见[Agent MCP](/zh/mcp-server/agent-mcp)；API 密钥应存放在 Authorization 请求头或安全密钥存储中，切勿置于 URL 中。
