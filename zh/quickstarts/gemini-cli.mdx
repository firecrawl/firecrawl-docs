...
此配置使用免密钥 Firecrawl 工具集。对于账户关联的设置，请参见[Human MCP](/zh/mcp-server/human-mcp)，对于无人值守的设置，请参见[Agent MCP](/zh/mcp-server/agent-mcp)；API 密钥应保存在 Authorization 请求头或安全密钥存储中，切勿放入 URL。
