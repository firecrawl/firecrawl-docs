...
## 集成的作用 {#what-the-integration-does}
...
## 从 Vercel 安装 {#install-from-vercel}
...
## 与动态页面交互 {#interact-with-dynamic-pages}
...
## 将 Firecrawl 与 Vercel AI SDK 结合使用 {#use-firecrawl-with-the-vercel-ai-sdk}
