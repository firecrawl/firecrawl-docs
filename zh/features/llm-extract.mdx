...
<div id="scrape-and-extract-structured-data-with-firecrawl">
  ## 使用 Firecrawl 抓取并提取结构化数据 {#scrape-and-extract-structured-data-with-firecrawl}
</div>
...
<div id="json-mode-via-scrape">
  ### 通过 /scrape 的 JSON 模式 {#json-mode-via-scrape}
</div>
...
<div id="structured-data-without-schema">
  ### 无需 schema 的结构化数据 {#structured-data-without-schema}
</div>
...
<div id="real-world-example-extracting-company-information">
  ### 真实案例：提取公司信息 {#real-world-example-extracting-company-information}
</div>
...
### prompt 注入检测 {#prompt-injection-detection}
...
## 保持提取一致性的技巧 {#tips-for-consistent-extraction}
