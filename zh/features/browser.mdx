...
<Info>
  浏览器沙箱现已更名为 [Interact](/zh/features/interact)，提供相同的功能，并且还可通过提示词进行控制。
</Info>

Firecrawl Browser Sandbox 为你的代理提供一个安全的浏览器环境，让代理能够与 Web 交互。可以填写表单、点击按钮、进行身份验证等。
...
要为 AI 编码代理 (Claude Code、Codex、Open Code、Cursor 等) 添加浏览器支持，请安装 Firecrawl skill：
