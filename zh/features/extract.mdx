...
<div id="response-sdks">
  ### 响应 (SDK) {#response-sdks} 
</div>

<ExtractOutput />

## Job status and completion {#job-status-and-completion}
...
<div id="pending-example">
  #### 处理中示例 {#pending-example}
</div>

<ExtractStatusPending />

<div id="completed-example">
  #### 完成示例 {#completed-example}
</div>

<ExtractStatusDone />

<div id="extracting-without-a-schema">
  ## 无需 Schema 的提取 {#extracting-without-a-schema}
</div>
...
<div id="improving-results-with-web-search">
  ## 通过网页搜索提升结果 {#improving-results-with-web-search}
</div>
...
<div id="example-response-with-web-search">
  ### 含网页搜索的示例响应 {#example-response-with-web-search}
</div>
...
<div id="extracting-without-urls">
  ## 无需提供 URL 的提取 {#extracting-without-urls}
</div>
...
<div id="known-limitations-beta">
  ## 已知限制 (Beta) {#known-limitations-beta} 
</div>
...
## 计费与使用方式跟踪 {#billing-and-usage-tracking}
