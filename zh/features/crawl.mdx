...
<div id="real-time-results-with-websocket">
  ## 使用 WebSocket 获取实时结果 {#real-time-results-with-websocket}
</div>
...
### 失败和被封禁的页面 {#failed-and-blocked-pages}
...
### 爬虫的可达范围 {#what-the-crawler-is-scoped-to-reach}
...
### 当多次运行结果不一致时 {#when-results-vary-between-runs}
...
### 判断爬取何时完成 {#knowing-when-a-crawl-is-done}
