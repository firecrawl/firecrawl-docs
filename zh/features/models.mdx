---
title: "模型"
description: "为你的智能体抽取任务选择合适的模型。"
og:title: "智能体模型 | Firecrawl"
og:description: "在 Spark 1 Mini 和 Spark 1 Pro 之间，为你的智能体抽取任务选择合适的模型。"
icon: "microchip"
sidebarTitle: "模型"
---
...
有关完整的参数说明，请参阅 [Agent API Reference](/zh/api-reference/endpoint/agent)。

对于该使用哪个模型有疑问？请发送邮件至 [help@firecrawl.com](mailto:help@firecrawl.com)。