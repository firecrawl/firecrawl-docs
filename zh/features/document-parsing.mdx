...
## 如何使用文档解析 {#how-to-use-document-parsing}
...
### 使用 `/v2/parse` 上传文档 {#upload-documents-with-v2parse}
...
<div id="example-scraping-an-excel-file">
  ### 示例：爬取 Excel 文件 {#example-scraping-an-excel-file}
</div>

<ScrapeXLSX />

<div id="example-scraping-a-word-document">
  ### 示例：抓取 Word 文档 {#example-scraping-a-word-document}
</div>
