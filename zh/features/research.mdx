---
title: "研究索引"
description: "搜索论文、阅读论文段落、查找相关工作，并搜索相关的 GitHub 仓库"
og:title: "研究索引 | Firecrawl"
og:description: "使用 Firecrawl 的研究索引进行论文检索、语义扩展、论文阅读和 GitHub 搜索。"
icon: "book-open"
---

Firecrawl Research 是一个专为科学与工程研究代理构建的专用索引。它提供一套面向研究的工具集，用于搜索论文、查看论文元数据、阅读相关的全文段落、通过结构化扩展发现相关论文，以及搜索与研究相关的 GitHub 仓库。
