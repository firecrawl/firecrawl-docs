...
## 选择合适的交互模型 {#choose-the-right-interaction-model}
...
## 通过 prompt 交互 {#interact-via-prompting}
...
### 保持 prompt 简短且聚焦 {#keep-prompts-small-and-focused}
...
### Node.js (Playwright) {#nodejs-playwright}
...
### Bash (agent-browser) {#bash-agent-browser}
...
## 使用 抓取 + 交互 的持久化配置文件 {#persistent-profiles-with-scrape-interact}
