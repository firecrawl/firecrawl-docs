...
<div id="scraping-a-url-with-firecrawl">
  ## 使用 Firecrawl 抓取 URL {#scraping-a-url-with-firecrawl}
</div>

<div id="scrape-endpoint">
  ### /scrape 端点 {#scrape-endpoint}
</div>
...
### 响应元数据和状态码 {#response-metadata-and-status-codes}
...
<div id="scrape-with-json-endpoint">
  ### /scrape (使用 JSON) 端点 {#scrape-with-json-endpoint}
</div>
...
<div id="extracting-without-schema">
  ### 无需 schema 的提取 {#extracting-without-schema}
</div>
...
<div id="extract-brand-identity">
  ## 提取品牌识别度 {#extract-brand-identity}
</div>

<div id="scrape-with-branding-endpoint">
  ### /scrape (品牌信息) 端点 {#scrape-with-branding-endpoint}
</div>
...
<div id="branding-profile-structure">
  ### 品牌档案结构 {#branding-profile-structure}
</div>
...
<div id="combining-with-other-formats">
  ### 与其他 formats 结合使用 {#combining-with-other-formats}
</div>
...
### /scrape (带有 product 参数) 端点 {#scrape-with-product-endpoint}
...
### 产品对象结构 {#product-object-structure}
...
### 产品提取的工作方式 {#how-product-extraction-works}
...
### 与其他 formats 组合使用 {#combining-with-other-formats-2}
...
<div id="highlights-format">
  ## Highlights 格式 {#highlights-format}
</div>
...
<div id="interacting-with-the-page-with-actions">
  ## 使用 actions 与页面交互 {#interacting-with-the-page-with-actions}
</div>
...
### 新鲜度与条目状态 {#freshness-and-item-status}
...
<div id="batch-scraping-multiple-urls">
  ## 批量抓取多个 URL {#batch-scraping-multiple-urls}
</div>
