...
<div id="performing-a-search-with-firecrawl">
  ## 使用 Firecrawl 进行搜索 {#performing-a-search-with-firecrawl}
</div>

<div id="search-endpoint">
  ### /search 端点 {#search-endpoint}
</div>
...
### 研究类别搜索 {#research-category-search}
...
### 开发者类别搜索 {#developer-category-search}
...
### 类别响应格式 {#category-response-format}
...
<div id="hd-image-search-with-size-filtering">
  ### 按尺寸筛选的高清图片搜索 {#hd-image-search-with-size-filtering}
</div>
...
<div id="search-with-content-scraping">
  ## 搜索并抓取内容 {#search-with-content-scraping}
</div>
...
<div id="response-with-scraped-content">
  ### 包含爬取内容的响应 {#response-with-scraped-content}
</div>
...
<div id="search-then-scrape-two-step-pattern">
  ## 先搜索，再抓取 (两步模式) {#search-then-scrape-two-step-pattern}
</div>
...
### 结合使用 Search ZDR 和 Scrape ZDR {#combining-search-zdr-with-scrape-zdr}
...
<div id="advanced-scraping-options">
  ## 高级抓取选项 {#advanced-scraping-options}
</div>
