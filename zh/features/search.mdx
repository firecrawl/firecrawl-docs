...
* `pdf`：搜索 PDF 文档
* `developer`：搜索 [开发者索引](/zh/features/developer) — GitHub issue、已合并的 pull request、仓库 README 和精选文档网站
...
开发者结果会在独立的`developer`组中与`web`一同返回，每项均带有`category: "developer"`。如需获取包含匹配段落的排序结果，或使用仓库和文档来源筛选条件，请使用[开发者搜索端点](/zh/features/developer#developer-search-endpoint)。
