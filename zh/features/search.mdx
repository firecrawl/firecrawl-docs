...
* `github`：在 GitHub 仓库、代码、issue 和文档中搜索
...
开发者结果返回在标准的`web`组中，每项均带有`category: "developer"`；`developer` 类别不能与其他类别组合使用。如需获取包含匹配段落的排序结果，或使用仓库和文档来源筛选条件，请使用[开发者搜索端点](/zh/features/developer#search-the-developer-index)。
