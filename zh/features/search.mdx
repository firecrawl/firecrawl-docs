...
Firecrawl 的搜索 API 允许你执行网络搜索，并可选在一次操作中抓取搜索结果。

* 选择特定的输出格式 (markdown、HTML、links、screenshots) 
* 使用可自定义参数 (如位置) 进行网络搜索
* 可选以多种格式从搜索结果中获取内容

详情请参阅 [Search Endpoint API Reference](https://docs.firecrawl.dev/api-reference/endpoint/search)。
