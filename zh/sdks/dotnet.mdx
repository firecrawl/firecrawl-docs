...
官方 .NET SDK 由 Firecrawl monorepo 中的 [apps/.net-sdk](https://github.com/firecrawl/firecrawl/tree/main/apps/.net-sdk) 维护。

要安装 Firecrawl .NET SDK，请添加以下 NuGet 包：

<Tabs>
  <Tab title=".NET CLI">`bash dotnet add package firecrawl-sdk `</Tab>
  <Tab title="包管理器">`powershell Install-Package firecrawl-sdk `</Tab>
