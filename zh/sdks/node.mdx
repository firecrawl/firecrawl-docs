...
<div id="parsing-uploaded-files">
  ### 解析上传的文件 {#parsing-uploaded-files}
</div>
...
<div id="sitemap-only-crawl">
  ### 仅爬取 Sitemap {#sitemap-only-crawl}
</div>
...
### 使用 WebSockets 爬取网站 {#crawling-a-website-with-websockets}
...
<div id="simple-crawl-auto-pagination-default">
  ##### 简单爬取 (自动分页，默认) {#simple-crawl-auto-pagination-default} 
</div>

* 请参阅[网站爬取](#crawling-a-website)中的默认流程。

<div id="manual-crawl-with-pagination-control-single-page">
  ##### 手动抓取与分页控制 (单页) {#manual-crawl-with-pagination-control-single-page} 
</div>
...
<div id="manual-crawl-with-limits-auto-pagination-early-stop">
  ##### 设有限制的手动抓取 (自动分页 + 提前停止) {#manual-crawl-with-limits-auto-pagination-early-stop} 
</div>
...
<div id="simple-batch-scrape-auto-pagination-default">
  ##### 简单批量抓取 (自动分页，默认) {#simple-batch-scrape-auto-pagination-default} 
</div>

* 默认流程请参见[批量抓取](/zh/features/batch-scrape)。

<div id="manual-batch-scrape-with-pagination-control-single-page">
  ##### 手动批量抓取并控制分页 (单页) {#manual-batch-scrape-with-pagination-control-single-page} 
</div>
...
<div id="manual-batch-scrape-with-limits-auto-pagination-early-stop">
  ##### 手动批量抓取并设定限制 (自动分页 + 提前停止) {#manual-batch-scrape-with-limits-auto-pagination-early-stop} 
</div>
...
### 绑定到抓取任务的交互式会话 {#scrape-bound-interactive-session}
