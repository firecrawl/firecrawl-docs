...
### Laravel 集成 {#laravel-integration}
...
### 使用 Laravel 门面 {#using-the-laravel-facade}
...
## Laravel AI SDK 工具 {#laravel-ai-sdk-tools}
...
### 与抓取任务绑定的交互式会话 {#scrape-bound-interactive-session}
