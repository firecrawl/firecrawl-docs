---
title: "技能 + CLI"
description: "Firecrawl 技能让 AI 代理（例如 Claude Code、Antigravity 和 OpenCode）可以更简单地通过 CLI 使用 Firecrawl。"
og:title: "CLI | Firecrawl"
og:description: "Firecrawl 技能让 AI 代理可以更简单地通过 CLI 使用 Firecrawl。AI 代理可以通过一个更优且上下文效率更高的接口获取 Web 数据。"
---
...
直接在终端中搜索、抓取并与网页交互。Firecrawl CLI 既可独立运行，也可作为一项技能，供 Claude Code、Antigravity 和 OpenCode 等 AI 编码代理自动发现并使用。
