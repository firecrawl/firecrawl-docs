...
### 将 CLI 连接到自托管的 Firecrawl {#connect-the-cli-to-self-hosted-firecrawl}
...
#### 查看抓取状态 {#check-crawl-status}

<CrawlStatus />

#### Crawl 选项 {#crawl-options}
