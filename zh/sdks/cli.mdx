---
title: '技能 + CLI'
description: 'Firecrawl Skills 让 AI 代理可以更简单地通过 CLI 使用 Firecrawl。AI 代理可以通过一个更优且上下文效率更高的接口获取 Web 数据。'
icon: 'terminal'
...
如果你在任何 AI agent（例如 Claude Code）中使用它，可以安装 Firecrawl skill，agent 会为你下载并完成设置。
