...
<div id="getting-your-claude-and-firecrawl-api-keys">
  ## 获取 Claude 和 Firecrawl 的 API 密钥 {#getting-your-claude-and-firecrawl-api-keys}
</div>
...
<div id="load-website-with-firecrawl">
  ## 使用 Firecrawl 加载网站 {#load-website-with-firecrawl}
</div>
...
<div id="combination-and-generation">
  ## 组合与生成 {#combination-and-generation}
</div>
