...
要通过 [Smithery](https://smithery.ai/server/@firecrawl/mcp-server-firecrawl) 自动为 Claude Desktop 安装 Firecrawl：
...
```json
{
  "content": [
    {
      "type": "text",
      "text": "批量操作已加入队列,ID:batch_1。使用 firecrawl_check_batch_status 查看进度。"
    }
  ],
  "isError": false
}
