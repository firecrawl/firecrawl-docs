...
Tell Firecrawl where to deliver events by including a `webhook` object in your request. You can attach it to any supported operation, and the same object shape works across all of them.
