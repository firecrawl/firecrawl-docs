...
# Comprobar si el código de estado indica que debemos reintentar con enhanced
if [[ "$STATUS_CODE" == "401" || "$STATUS_CODE" == "403" || "$STATUS_CODE" == "500" ]]; then
    echo "Se obtuvo el código de estado $STATUS_CODE; reintentando con el proxy enhanced"
