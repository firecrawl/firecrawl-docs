...
<Warning>
The starting URL is also checked against `includePaths`. If it does not match any of the patterns, the crawl will return 0 pages because link discovery never begins.
</Warning>
