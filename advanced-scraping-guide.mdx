...
|-----------|------|---------|-------------|
| `formats` | `array` | `["markdown"]` | Output formats to return. Strings: `"markdown"`, `"links"`, `"html"`, `"rawHtml"`, `"summary"`, `"images"`. Objects: JSON (`type: "json"`), Screenshot (`type: "screenshot"`), Change tracking (`type: "changeTracking"`, requires `"markdown"`). |
