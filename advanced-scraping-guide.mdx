...
If you need to whitelist Firecrawl in your security configurations:
...
- **IP Addresses**: Firecrawl does not use a fixed set of IP addresses for scraping.
- **API Access**: If your firewall blocks outbound requests to Firecrawl's API, you may need to whitelist `35.245.250.27`.
