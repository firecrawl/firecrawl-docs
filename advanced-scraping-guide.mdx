...
| `menu` | Extracts a structured restaurant menu (sections, items, prices, availability) from menu pages via deterministic multi-source structured-data extraction. |
