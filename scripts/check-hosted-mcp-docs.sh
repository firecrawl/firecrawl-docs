...
require "$human_page" "/developer-guides/mcp-setup-guides/chatgpt"
require "$human_page" "/developer-guides/mcp-setup-guides/claude-ai"
...
require "$human_page" "## ChatGPT and Claude.ai"
