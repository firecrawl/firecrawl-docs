...
## Estructura del payload {#payload-structure}
...
## Eventos de rastreo {#crawl-events}
...
## Eventos de scraping por lotes {#batch-scrape-events}
...
## Eventos del Monitor {#monitor-events}
...
## Eventos de extracción {#extract-events}
...
## Eventos del agente {#agent-events}
