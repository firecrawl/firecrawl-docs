...
**Skills de CLI** — para trabajo web en tiempo real durante una sesión del agente:
...
| `firecrawl-research-index`   | Buscar artículos, leer pasajes y seguir citas en el código de la aplicación        |
| `firecrawl-developer-index`  | Buscar issues, pull requests, README y documentación en el código de la aplicación |
