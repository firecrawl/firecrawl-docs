...
<Card title="MCP Server" icon="plug" href="/es/mcp-server">
  ...
  [inicio rápido de Windsurf](/es/quickstarts/windsurf).
</Card>
...
<Steps>
  ...
  <Step title="Servidor de documentación MCP">
    Para un enfoque estructurado con herramientas MCP, conecta el Firecrawl MCP Server en Codex, Cursor, Claude Code, Claude Desktop u otro cliente compatible. Consulta [Primeros pasos con MCP](/es/mcp-server) para la configuración alojada. Los usuarios de Windsurf deben seguir el [inicio rápido de Windsurf](/es/quickstarts/windsurf).
  </Step>
