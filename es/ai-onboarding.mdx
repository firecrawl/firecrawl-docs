...
* **Stripe Projects:** en un proyecto que ya usa la CLI de Stripe, `stripe projects add firecrawl/api --name firecrawl` aprovisiona la cuenta y escribe `FIRECRAWL_API_KEY` en `.env`. Consulta [Stripe Projects](/es/integrations/stripe-projects).
...
## CLI y skills de agente {#cli-and-agent-skills}
...
### Lo que incluye la instalación {#what-the-install-gives-you}
...
### Cómo los agentes encadenan herramientas {#how-agents-chain-tools-together}
