...
La configuración se selecciona al crear la integración. Para agregar o quitar Gateway más adelante es necesario contactar a Firecrawl. Consulta la [página de la Partner API](https://www.firecrawl.dev/partner-program) para obtener una visión general.
...
Crea tu integración en el [Dashboard de Firecrawl](https://www.firecrawl.dev/app/partner-api): inicia sesión, selecciona Partner API o Gateway, acepta el acuerdo y copia tu clave de socio. Después, llama a los endpoints anteriores desde tu servidor. ¿Tienes dudas o tienes en mente una integración de mayor alcance? Escríbenos a [partnerships@firecrawl.dev](mailto:partnerships@firecrawl.dev).