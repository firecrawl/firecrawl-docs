...
* **Términos del servicio**: Antes de llamar al endpoint `create-user`, tu plataforma debe solicitar al usuario que acepte los [Términos del servicio](https://www.firecrawl.dev/terms-of-service) de Firecrawl.
