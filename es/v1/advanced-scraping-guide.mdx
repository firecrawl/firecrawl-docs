...
<div id="basic-scraping-with-firecrawl-scrape">
  ## Scraping básico con Firecrawl (/scrape) {#basic-scraping-with-firecrawl-scrape}
</div>
...
<div id="setting-the-content-formats-on-response-with-formats">
  ### Configurar los formatos de contenido en la respuesta con `formats` {#setting-the-content-formats-on-response-with-formats}
</div>
...
<div id="getting-the-full-page-content-as-markdown-with-onlymaincontent">
  ### Obtener todo el contenido de la página como markdown con `onlyMainContent` {#getting-the-full-page-content-as-markdown-with-onlymaincontent}
</div>
...
<div id="setting-the-tags-to-include-with-includetags">
  ### Configurar las etiquetas que se incluirán con `includeTags` {#setting-the-tags-to-include-with-includetags}
</div>
...
<div id="setting-the-tags-to-exclude-with-excludetags">
  ### Configurar las etiquetas a excluir con `excludeTags` {#setting-the-tags-to-exclude-with-excludetags}
</div>
...
<div id="waiting-for-the-page-to-load-with-waitfor">
  ### Esperar a que la página se cargue con `waitFor` {#waiting-for-the-page-to-load-with-waitfor}
</div>
...
<div id="setting-the-maximum-timeout">
  ### Configurar el `timeout` máximo {#setting-the-maximum-timeout}
</div>
...
<div id="parsing-pdf-files-with-parsepdf">
  ### Análisis de archivos PDF con `parsePDF` {#parsing-pdf-files-with-parsepdf}
</div>
...
<div id="extractor-options">
  ## Opciones de extracción {#extractor-options}
</div>
...
<div id="using-the-llm-extraction">
  ### Uso de la extracción con LLM {#using-the-llm-extraction}
</div>
...
<div id="example-usage-2">
  ### Ejemplo de uso {#example-usage-2}
</div>
...
<div id="crawling-multiple-pages">
  ## Rastreo de múltiples páginas {#crawling-multiple-pages}
</div>
...
<div id="check-crawl-job">
  ### Comprobar trabajo de rastreo {#check-crawl-job}
</div>
...
<div id="paginationnext-url">
  #### Paginación/URL siguiente {#paginationnext-url}
</div>
...
<div id="crawler-options">
  ### Opciones del crawler {#crawler-options}
</div>
...
<div id="example-usage-3">
  ### Ejemplo de uso {#example-usage-3}
</div>
...
<div id="mapping-website-links-with-map">
  ## Mapeo de enlaces de un sitio web con `/map` {#mapping-website-links-with-map}
</div>
