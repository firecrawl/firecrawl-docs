...
<div id="welcome-to-firecrawl">
  ## Bienvenido a Firecrawl {#welcome-to-firecrawl}
</div>
...
<div id="powerful-capabilities">
  ### Capacidades potentes {#powerful-capabilities}
</div>
...
<div id="installing-firecrawl">
  ## Instalación de Firecrawl {#installing-firecrawl}
</div>
...
<div id="interacting-with-the-page-with-actions">
  ## Interactuar con la página mediante acciones {#interacting-with-the-page-with-actions}
</div>
...
<div id="open-source-vs-cloud">
  ## Código abierto vs nube {#open-source-vs-cloud}
</div>
