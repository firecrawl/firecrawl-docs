---
title: 'Búsqueda'
openapi: '/es/api-reference/v1-openapi.json V1-OPENAPI POST /search'
---
...
Incluye `scrapeOptions` con `formats: ["markdown"]` para obtener el contenido completo en markdown de cada resultado de búsqueda; de lo contrario, de forma predeterminada recibirás los resultados del SERP (url, title, description).
