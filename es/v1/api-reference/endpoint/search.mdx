...
Incluye `scrapeOptions` con `formats: ["markdown"]` para obtener el contenido completo en markdown de cada resultado de búsqueda; de lo contrario, de forma predeterminada recibirás los resultados del search (url, title, description).
