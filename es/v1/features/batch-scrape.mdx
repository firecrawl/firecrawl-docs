...
Para consultar la documentación completa de webhooks —incluidos los tipos de eventos, la estructura del payload y ejemplos de implementación— visita la [documentación de webhooks](/es/features/webhooks).
...
<Note>
  Para ver la configuración detallada de los webhooks, las prácticas recomendadas de seguridad y la resolución de problemas, visita la [documentación de Webhooks](/es/features/webhooks).
</Note>
