...
<div id="batch-scraping-multiple-urls">
  ## Extracción por lotes de múltiples URL {#batch-scraping-multiple-urls}
</div>
...
<div id="batch-scrape-with-extraction">
  ## Rastreo por lotes con extracción {#batch-scrape-with-extraction}
</div>
