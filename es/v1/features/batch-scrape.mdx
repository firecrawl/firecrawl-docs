...
<div id='how-it-works'>### Cómo funciona</div>
...
El SDK ofrece 2 métodos: sincrónico y asincrónico. El método sincrónico devuelve los resultados del trabajo de scraping por lotes, mientras que el método asincrónico devuelve un ID de trabajo que puedes usar para consultar el estado del scraping por lotes.
...
<div id='synchronous'>#### Sincrónico</div>

<BatchScrapeOutput />

<div id='asynchronous'>#### Asíncrono</div>
...
<div id='batch-scrape-with-extraction'>## Rastreo por lotes con extracción</div>
...
<div id='batch-scrape-with-webhooks'>## Raspado por lotes con webhooks</div>
...
- `batch_scrape.started` - Cuando empieza el scraping por lotes
...
<Note>
  ...
  recomendadas de seguridad y la resolución de problemas, visita la
  [documentación de Webhooks](/es/webhooks/overview).
</Note>
