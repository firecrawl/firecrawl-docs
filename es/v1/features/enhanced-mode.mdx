---
title: "Modo sigilo"
description: "Usa proxies en modo sigilo para un scraping confiable en sitios complejos, manteniendo la privacidad"
og:title: "Modo sigilo | Firecrawl"
og:description: "Usa proxies en modo sigilo para un scraping confiable en sitios complejos, manteniendo la privacidad"
---
...
- **Enhanced**: Proxies de modo sigiloso para extraer datos de sitios complejos manteniendo la privacidad. Es más lento, pero más fiable en ciertos sitios.
...
Al extraer datos de sitios web complejos, puedes usar el modo sigiloso para mejorar la tasa de éxito y mantener la privacidad.
