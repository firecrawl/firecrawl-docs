...
<div id="scraping-a-url-with-firecrawl">
  ## Raspando una URL con Firecrawl {#scraping-a-url-with-firecrawl}
</div>
...
<div id="extracting-without-schema-new">
  ### Extracción sin esquema (Nuevo) {#extracting-without-schema-new}
</div>
...
<div id="json-options-object">
  ### Objeto de opciones JSON {#json-options-object}
</div>
...
<div id="batch-scraping-multiple-urls">
  ## Raspado por lotes de varias URL {#batch-scraping-multiple-urls}
</div>
...
<div id="using-fire-1-with-scrape">
  ## Usar FIRE-1 con Scrape {#using-fire-1-with-scrape}
</div>
...
<div id="example-usage-with-scrape-endpoint">
  ### Ejemplo de uso con el punto de conexión /scrape {#example-usage-with-scrape-endpoint}
</div>
