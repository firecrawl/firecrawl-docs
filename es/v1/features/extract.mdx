...
El punto de conexión `/extract` simplifica la recopilación de datos estructurados desde cualquier cantidad de URL o dominios completos. Proporciona una lista de URL, opcionalmente con comodines (p. ej., `example.com/*`), y un prompt o un esquema que describa la información que deseas. Firecrawl se encarga de los detalles de rastreo, análisis y consolidación de conjuntos de datos, grandes o pequeños.

<Info>Extract se factura de manera diferente a otros puntos de conexión. Consulta los [precios de Extract](https://www.firecrawl.dev/extract#pricing) para más detalles.</Info>
...
Puedes consultar los precios de /extract en la [página de precios de Extract](https://www.firecrawl.dev/extract#pricing) y hacer seguimiento del uso desde la [página de Extract en el panel](https://www.firecrawl.dev/app/extract).
