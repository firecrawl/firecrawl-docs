...
<div id="asynchronous-extraction-status-checking">
  ## Extracción asíncrona y comprobación de estado {#asynchronous-extraction-status-checking}
</div>
...
<div id="pending-example">
  #### Ejemplo pendiente {#pending-example}
</div>
...
<div id="extracting-without-a-schema">
  ## Extracción sin esquema {#extracting-without-a-schema}
</div>
...
<div id="improving-results-with-web-search">
  ## Mejora de resultados con búsqueda web {#improving-results-with-web-search}
</div>
...
<div id="example-response-with-web-search">
  ### Ejemplo de respuesta con búsqueda web {#example-response-with-web-search}
</div>
...
<div id="extracting-without-urls">
  ## Extracción sin URLs {#extracting-without-urls}
</div>
...
<div id="known-limitations-beta">
  ## Limitaciones conocidas (Beta) {#known-limitations-beta}
</div>
...
<div id="billing-and-usage-tracking">
  ## Facturación y seguimiento del uso {#billing-and-usage-tracking}
</div>
