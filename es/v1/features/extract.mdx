...
Cuando utilizas `/*`, Firecrawl rastreará y analizará automáticamente todas las URL que detecte en ese dominio y luego extraerá los datos solicitados. Esta funcionalidad es experimental; envía un correo a [help@firecrawl.com](mailto:help@firecrawl.com) si tienes algún problema.
