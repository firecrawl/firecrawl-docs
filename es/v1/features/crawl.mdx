...
Acelera tus rastreos hasta un significantly cuando no necesitas los datos más recientes. Agrega `maxAge` a tus `scrapeOptions` para usar datos en caché de la página cuando haya disponibilidad.
...
* Si los hay, se devuelve al instante desde la caché (hasta significantly más rápido)
