...
<div id="javascript-sdk">
  ## SDK de JavaScript {#javascript-sdk}
</div>
...
<div id="git-diff-results-example">
  ### Ejemplo de resultados de Git diff: {#git-diff-results-example}
</div>
...
<div id="json-comparison-results-example">
  ### Ejemplo de resultados de comparación de JSON: {#json-comparison-results-example}
</div>
...
<div id="typescript-interface">
  ### Interfaz de TypeScript {#typescript-interface}
</div>
...
<div id="python-sdk">
  ## SDK de Python {#python-sdk}
</div>

<div id="basic-usage-2">
  ### Uso básico {#basic-usage-2}
</div>
...
<div id="advanced-options-2">
  ### Opciones avanzadas {#advanced-options-2}
</div>
...
<div id="python-data-model">
  ### Modelo de datos en Python {#python-data-model}
</div>
...
<div id="change-tracking-modes">
  ## Modos de seguimiento de cambios {#change-tracking-modes}
</div>
...
<div id="basic-scrape-example">
  ### Ejemplo básico de scraping {#basic-scrape-example}
</div>
...
<div id="tracking-product-price-changes">
  ### Seguimiento de cambios en precios de productos {#tracking-product-price-changes}
</div>
...
<div id="monitoring-content-changes-with-git-diff">
  ### Monitorear cambios de contenido con git-diff {#monitoring-content-changes-with-git-diff}
</div>
