...
<div id="parsing-uploaded-files">
  ### Análisis de archivos subidos {#parsing-uploaded-files}
</div>
...
<div id="crawling-a-website">
  ### Rastreo de un sitio web {#crawling-a-website}
</div>
...
<div id="mapping-a-website">
  ### Mapear un sitio web {#mapping-a-website}
</div>
...
### Ejecutar un agente {#running-an-agent}
...
<div id="manual-crawl-with-pagination-control-single-page">
  ##### Rastreo manual con control de paginación (una sola página) {#manual-crawl-with-pagination-control-single-page}
</div>
...
<div id="manual-crawl-with-limits-auto-pagination-early-stop">
  ##### Rastreo manual con límites (paginación automática + parada anticipada) {#manual-crawl-with-limits-auto-pagination-early-stop}
</div>
...
<div id="batch-scrape">
  #### Scrape por lotes {#batch-scrape}
</div>

Usa el método waiter `batchScrape`, o inicia un job y pagina manualmente.

<div id="simple-batch-scrape-auto-pagination-default">
  ##### Raspado por lotes simple (paginación automática, predeterminado) {#simple-batch-scrape-auto-pagination-default}
</div>
...
<div id="manual-batch-scrape-with-pagination-control-single-page">
  ##### Raspado manual por lotes con control de paginación (una sola página) {#manual-batch-scrape-with-pagination-control-single-page}
</div>
...
<div id="manual-batch-scrape-with-limits-auto-pagination-early-stop">
  ##### Extracción manual por lotes con límites (paginación automática + detención anticipada) {#manual-batch-scrape-with-limits-auto-pagination-early-stop}
</div>
...
<div id="connect-via-cdp">
  ### Conectar mediante CDP {#connect-via-cdp}
</div>
...
### Listar &amp; cerrar sesiones {#list-close-sessions}
...
### Sesión interactiva vinculada al scraping {#scrape-bound-interactive-session}
