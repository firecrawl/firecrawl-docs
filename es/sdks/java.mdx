...
### Scraping de una URL {#scraping-a-url}
...
#### Extracción de JSON {#json-extraction}
...
### Rastrear un sitio web {#crawling-a-website}
...
### Comprobar el estado del rastreo {#checking-crawl-status}
...
### Mapeo de un sitio web {#mapping-a-website}
...
### Buscar en la Web {#searching-the-web}
...
### Scraping por lotes {#batch-scraping}
...
## Soporte asíncrono {#async-support}
