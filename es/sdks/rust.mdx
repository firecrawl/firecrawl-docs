...
### Hacer scraping de una URL {#scraping-a-url}
...
### Procesamiento de archivos subidos {#parsing-uploaded-files}
...
### Comprobar errores de rastreo {#checking-crawl-errors}
...
### Búsqueda en la web {#searching-the-web}
...
### Intervalos de sondeo {#poll-intervals}
