...
Busca, haz scraping e interactúa con la web directamente desde la terminal. La CLI de Firecrawl funciona de forma independiente o como un Skill que los agentes de IA para programación, como Claude Code, Antigravity y OpenCode, pueden descubrir y usar automáticamente.
