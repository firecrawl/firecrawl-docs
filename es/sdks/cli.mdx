...
Haz scraping, rastrea, busca y extrae datos web directamente desde la terminal. La CLI de Firecrawl funciona de forma independiente o como un Skill que los agentes de IA para programación, como Claude Code, Antigravity y OpenCode, pueden descubrir y usar automáticamente.
...
Si estás usando un agente de IA como Claude Code, puedes instalar el Skill de Firecrawl a continuación y el agente lo configurará por ti.
