...
* `--all` instala los Skills de Firecrawl en todos los agentes de codificación con IA detectados
...
| `--schema <json>`        |       | JSON schema para extracción estructurada                                                                                                                                      |
| `--schema-file <path>`   |       | Ruta al archivo de JSON schema                                                                                                                                                |
...
La CLI y las skills de Firecrawl son de código abierto y están disponibles en GitHub: [firecrawl/cli](https://github.com/firecrawl/cli)
