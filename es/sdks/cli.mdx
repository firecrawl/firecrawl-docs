---
title: 'Skills + CLI'
description: 'Firecrawl Skills es una forma sencilla de hacer que los agentes de IA usen Firecrawl a través de la CLI. Los agentes de IA pueden obtener datos web mediante una interfaz mejor y más eficiente en el uso del contexto.'
icon: 'terminal'
...
Si lo estás usando en un agente de IA como Claude Code, puedes instalar la habilidad de Firecrawl y el agente podrá descargarla y configurarla por ti.
