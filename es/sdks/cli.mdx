...
### Ver la configuración {#view-configuration}
...
### Conecta la CLI a Firecrawl autogestionado {#connect-the-cli-to-self-hosted-firecrawl}
...
#### Opciones de Scrape {#scrape-options}
...
#### Consultar el estado del rastreo {#check-crawl-status}

<CrawlStatus />

#### Opciones de rastreo {#crawl-options}
...
## Manejo de la salida {#output-handling}
...
### Comportamiento de los formatos {#format-behavior}
...
### Rastreo completo del sitio web {#full-site-crawl}
...
### Descubrimiento de sitios web {#site-discovery}
...
### Flujo de trabajo de investigación {#research-workflow}
...
### Combínalo con otras herramientas {#combine-with-other-tools}
