...
### Consultar el estado de un rastreo {#checking-crawl-status}
...
### Mapea un sitio web {#map-a-website}
...
## Instancias autogestionadas {#self-hosted-instances}
...
## Todas las funciones disponibles {#all-available-functions}
