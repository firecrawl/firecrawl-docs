...
### Extracción de una URL {#scraping-a-url}
...
### Análisis de archivos cargados {#parsing-uploaded-files}
...
### Rastreo solo del sitemap {#sitemap-only-crawl}
...
<div id="start-a-crawl">
  ### Iniciar un rastreo {#start-a-crawl}
</div>
...
### Consultar el estado del rastreo {#checking-crawl-status}
...
### Cancelar un rastreo {#cancelling-a-crawl}
...
### Ejecutar un agente {#run-an-agent}
...
<div id="crawling-a-website-with-websockets">
  ### Rastreo de un sitio web con WebSockets {#crawling-a-website-with-websockets}
</div>
...
#### Utilidades para paginación manual {#manual-pagination-helpers}
...
<div id="simple-crawl-auto-pagination-default">
  ##### Rastreo simple (paginación automática, por defecto) {#simple-crawl-auto-pagination-default}
</div>

* Consulta el flujo por defecto en [Rastrear un sitio web](#crawl-a-website).

##### Rastreo manual con control de paginación {#manual-crawl-with-pagination-control}
...
##### Rastreo manual con límites (paginación automática + detención anticipada) {#manual-crawl-with-limits-auto-pagination-early-stop}
...
<div id="simple-batch-scrape-auto-pagination-default">
  ##### Raspado por lotes simple (paginación automática, por defecto) {#simple-batch-scrape-auto-pagination-default}
</div>

* Consulta el flujo por defecto en [Batch Scrape](/es/features/batch-scrape).

##### Extracción por lotes manual con control de paginación {#manual-batch-scrape-with-pagination-control}
...
##### Raspado manual por lotes con límites (paginación automática + detención anticipada) {#manual-batch-scrape-with-limits-auto-pagination-early-stop}
...
### Conectar vía CDP {#connect-via-cdp}
...
### Listar y cerrar sesiones {#list-close-sessions}
...
### Sesión interactiva vinculada al scrape {#scrape-bound-interactive-session}
