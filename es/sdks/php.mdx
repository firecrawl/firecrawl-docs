...
### Integración con Laravel {#laravel-integration}
...
### Uso del facade de Laravel {#using-the-laravel-facade}
...
#### Extracción JSON {#json-extraction}
...
## Herramientas de Laravel AI SDK {#laravel-ai-sdk-tools}
...
### Parámetros de las herramientas {#tool-parameters}
...
### Comportamiento de la herramienta {#tool-behavior}
...
### Resultados del rastreo {#crawl-results}
