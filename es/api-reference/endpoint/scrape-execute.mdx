...
### solicitud de ejemplo (Code) {#example-request-code}
...
### Respuesta de ejemplo (código) {#example-response-code}
...
### Solicitud de ejemplo (Prompt) {#example-request-prompt}
...
### respuesta de ejemplo (Prompt) {#example-response-prompt}
