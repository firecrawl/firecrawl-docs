...
| `profile.writeMode` | string | No | `"readwrite"` | `"readwrite"` guarda los cambios; `"readonly"` carga los datos existentes sin escribir. Solo se permite un proceso de escritura a la vez. |
