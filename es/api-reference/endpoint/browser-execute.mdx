---
title: "Ejecutar código en el navegador"
description: "Ejecuta código de Playwright en una sesión activa de navegador en la nube."
openapi: '/es/api-reference/v2-openapi.json POST /browser/{sessionId}/execute'
---
...
|-----------|------|-------------|----------------|-------------|
| `code` | string | Sí | - | Código de Playwright a ejecutar (1-100,000 caracteres) |
