...
| 402  | `Payment Required: Insufficient credits`                | Los créditos del plan se agotaron o la facturación no está configurada.                                                                                            | Activa la recarga automática o actualiza tu plan.                                                                                                                                                                 | No              |
