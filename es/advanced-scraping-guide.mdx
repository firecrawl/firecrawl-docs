...
| Parámetro | Tipo | Predeterminado | Descripción |
|-----------|------|---------|-------------|
| `waitFor` | `integer` (ms) | `0` | Tiempo de espera adicional antes de extraer, además del smart-wait. Úsalo con moderación. |
...
| `timeout` | `integer` (ms) | `30000` | Duración máxima de la solicitud antes de abortarla (el valor predeterminado es 30 segundos). El mínimo es 1000 (1 segundo). |
