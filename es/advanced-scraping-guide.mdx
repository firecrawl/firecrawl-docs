...
## Scraping básico {#basic-scraping}
...
<div id="scraping-pdfs">
  ## Extracción de PDF {#scraping-pdfs}
</div>
...
## Opciones de scraping {#scrape-options}
...
<div id="mobile-scraping">
  ### Scraping móvil {#mobile-scraping}
</div>
...
<div id="timing-and-cache">
  ### Temporización y caché {#timing-and-cache}
</div>
...
<div id="action-execution-notes">
  #### Notas sobre la ejecución de acciones {#action-execution-notes}
</div>
...
<div id="advanced-action-examples">
  #### Ejemplos de acciones avanzadas {#advanced-action-examples}
</div>
...
<div id="full-scrape-example">
  ### Ejemplo de scraping completo {#full-scrape-example}
</div>
...
## Extracción de JSON mediante formatos {#json-extraction-via-formats}
...
## Endpoint del agente {#agent-endpoint}
...
### Opciones del agente {#agent-options}
...
<div id="check-agent-status">
  ### Comprobar el estado del agente {#check-agent-status}
</div>
...
## Rastreo de varias páginas {#crawling-multiple-pages}
...
### Consultar el trabajo de rastreo {#check-crawl-job}
...
### Vista previa del `prompt` y los parámetros de rastreo {#crawl-prompt-and-params-preview}
...
<div id="crawler-options">
  ### Opciones del rastreador {#crawler-options}
</div>
...
<div id="path-filtering">
  #### Filtrado de rutas {#path-filtering}
</div>
...
<div id="crawl-scope">
  #### Alcance del rastreo {#crawl-scope}
</div>
...
<div id="sitemap-and-deduplication">
  #### Sitemap y deduplicación {#sitemap-and-deduplication}
</div>
...
<div id="scrape-options-for-crawl">
  #### Opciones de scrape para crawl {#scrape-options-for-crawl}
</div>
...
<div id="crawl-example">
  ### Ejemplo de rastreo {#crawl-example}
</div>
...
## Mapeo de enlaces de un sitio web {#mapping-website-links}
...
<div id="whitelisting-firecrawl">
  ## Agregar Firecrawl a la lista de permitidos {#whitelisting-firecrawl}
</div>

### Permitir que Firecrawl haga scraping de tu sitio web {#allowing-firecrawl-to-scrape-your-website}
...
<div id="allowing-your-application-to-call-the-firecrawl-api">
  ### Permitir que tu aplicación llame a la API de Firecrawl {#allowing-your-application-to-call-the-firecrawl-api}
</div>
