...
| `model`                 | `string`  | `"spark-1-pro"` | Modelo de IA a utilizar: `"spark-1-pro"` (predeterminado, mayor precisión), `"spark-1-mini"` (60% más económico que Pro) o `"spark-2"` (el más económico y rápido).                                                           |
