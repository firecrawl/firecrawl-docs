...
| `model`                 | `string`  | `"spark-2"`    | Modelo de IA a utilizar: `"spark-2"` (predeterminado, el más económico y rápido), `"spark-1-mini"` (60% más económico que Pro) o `"spark-1-pro"` (mayor precisión).                                                           |
