...
<div id="getting-your-claude-and-firecrawl-api-keys">
  ## Obtener tus claves de API de Claude y Firecrawl {#getting-your-claude-and-firecrawl-api-keys}
</div>
...
<div id="load-website-with-firecrawl">
  ## Cargar un sitio web con Firecrawl {#load-website-with-firecrawl}
</div>
...
<div id="combination-and-generation">
  ## Combinación y generación {#combination-and-generation}
</div>
