...
Cuando superas un límite de tasa o de concurrencia, la API devuelve una respuesta `429`. Consulta [Errores](/es/api-reference/errors) para ver el catálogo completo de errores y un fragmento de código para reintentar con backoff.
