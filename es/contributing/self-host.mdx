...
## Selecciona entre el autoalojamiento y Firecrawl Cloud {#choose-self-hosting-or-firecrawl-cloud}

### Autoalojar Firecrawl cuando {#self-host-firecrawl-when}
...
### Qué implica el autoalojamiento {#what-self-hosting-requires}
...
## Autoalojar Firecrawl con Docker Compose {#self-host-firecrawl-with-docker-compose}

### Empieza con estos valores predeterminados {#start-with-these-defaults}
...
### Clona la versión verificada {#clone-the-verified-release}
...
### Configura el entorno de evaluación {#configure-the-evaluation-deployment}
...
### Compila e inicia Firecrawl {#build-and-start-firecrawl}
...
### Comprueba que la API sea accesible {#check-api-reachability}
...
### Realiza una prueba rápida de funcionamiento {#run-a-functional-smoke-test}
...
## Compatibilidad de funciones autogestionadas {#self-hosted-feature-support}
...
## Antes de pasar a producción {#before-production}
...
### Estás omitiendo la autenticación {#youre-bypassing-authentication}
...
### Los contenedores de Docker no se inician {#docker-containers-fail-to-start}
...
### Problemas de conexión con Redis {#connection-issues-with-redis}
...
### El endpoint de la API no responde {#api-endpoint-does-not-respond}
...
### La solicitud de scraping supera el tiempo de espera {#scrape-request-times-out}
