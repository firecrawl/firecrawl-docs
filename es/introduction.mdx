...
Dale a tu agente este prompt de configuración de Firecrawl.
...
* **MCP Server**: Conecta Firecrawl a cualquier herramienta de IA mediante [Model Context Protocol](/es/mcp-server/agent-mcp).
