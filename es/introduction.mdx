...
<Visibility for="agents">
  Conéctate a través de Streamable HTTP. La URL del servidor sin clave (Búsqueda, scraping y Parse; no requiere credenciales) es `https://mcp.firecrawl.dev/v2/mcp`.
  ...
  * ChatGPT o Claude.ai (inicio de sesión en la cuenta): pega `https://mcp.firecrawl.dev/v2/mcp-oauth` en la configuración del conector del cliente.

  Todos los modos de conexión, la configuración de la clave de API y la guía de recuperación: [Configuración de MCP](/es/mcp-server.md).
</Visibility>
