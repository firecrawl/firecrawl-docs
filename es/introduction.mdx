...
- **Autoalojado:** Para autohospedarlo, consulta la guía [aquí](/contributing/self-host).
...
- [**Map**](/features/map): ingresa un sitio web y obtén todas las URL del sitio: extremadamente rápido
- [**Search**](/features/search): busca en la web y obtén el contenido completo de los resultados
- [**Extract**](/features/extract): obtén datos estructurados de una sola página, múltiples páginas o sitios completos con IA.
...
Para más detalles, consulta la [Referencia del endpoint /search](/api-reference/endpoint/search).
