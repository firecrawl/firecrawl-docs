...
import BrowserPython from "/snippets/es/v2/browser/quickstart/python.mdx";
import BrowserNode from "/snippets/es/v2/browser/quickstart/js.mdx";
import BrowserCURL from "/snippets/es/v2/browser/quickstart/curl.mdx";
import BrowserCLI from "/snippets/es/v2/browser/quickstart/cli.mdx";
...
El Agent de Firecrawl es una herramienta autónoma de recopilación de datos web. Solo tienes que describir qué datos necesitas, y buscará, navegará y los extraerá desde cualquier lugar de la web. Consulta la [documentación de la funcionalidad Agent](/es/features/agent) para ver todas las opciones.
