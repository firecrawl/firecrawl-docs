...
const schema = z.object({
  top: z
    ...
    .length(5)
    .describe("Las 5 historias principales en Hacker News"),
});
  ...
  jsonSchema := map[string]any{
    ...
    "properties": map[string]any{
      "top": map[string]any{
        ...
        "minItems":    5,
        "maxItems":    5,
        "description": "Top 5 historias en Hacker News",
      },
    },
    "required": []string{"top"},
  }
...
#[tokio::main]
async fn main() {
    // Inicializar la FirecrawlApp con la clave de API
    ...
    let json_schema = json!({
        ...
        "properties": {
            "top": {
                ...
                "minItems": 5,
                "maxItems": 5,
                "description": "Top 5 de historias en Hacker News"
            }
        },
        "required": ["top"]
    });
