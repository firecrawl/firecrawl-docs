...
<div id="scrape-and-extract-structured-data-with-firecrawl">
  ## Extrae y estructura datos con Firecrawl {#scrape-and-extract-structured-data-with-firecrawl}
</div>
...
<div id="scrape-with-extract-endpoint">
  ### punto de conexión /scrape (con extract) {#scrape-with-extract-endpoint}
</div>
...
### Utilizar Python SDK {#using-python-sdk}
