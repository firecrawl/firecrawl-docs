...
<div id="canceling-a-crawl-job">
  ### Cancelación de un trabajo de rastreo {#canceling-a-crawl-job}
</div>
...
<div id="extracting-structured-data-from-a-url">
  ### Extracción de datos estructurados desde una URL {#extracting-structured-data-from-a-url}
</div>
...
<div id="search-for-a-query">
  ### Buscar una consulta {#search-for-a-query}
</div>
