...
<div id="getting-cleaner-content-with-onlymaincontent">
  ### Obtener contenido más limpio con `onlyMainContent` {#getting-cleaner-content-with-onlymaincontent}
</div>
...
<div id="getting-the-html-with-includehtml">
  ### Obtener el HTML con `includeHtml` {#getting-the-html-with-includehtml}
</div>
...
<div id="getting-the-raw-html-with-includerawhtml">
  ### Obtener el HTML en bruto con `includeRawHtml` {#getting-the-raw-html-with-includerawhtml}
</div>
...
<div id="getting-a-screenshot-of-the-page-with-screenshot">
  ### Obtener una captura de pantalla de la página con `screenshot` {#getting-a-screenshot-of-the-page-with-screenshot}
</div>
...
<div id="extractor-options">
  ## Opciones del extractor {#extractor-options}
</div>
...
<div id="adjusting-timeout">
  ## Ajustar el timeout {#adjusting-timeout}
</div>
...
<div id="check-crawl-job">
  ### Consultar trabajo de rastreo {#check-crawl-job}
</div>
...
<div id="example-usage-4">
  ### Ejemplo de uso {#example-usage-4}
</div>
...
<div id="page-options-crawler-options">
  ## Opciones de página + opciones del rastreador {#page-options-crawler-options}
</div>
...
<div id="example-usage-5">
  ### Ejemplo de uso {#example-usage-5}
</div>
...
<div id="extractor-options-crawler-options">
  ## Opciones del extractor + opciones del rastreador {#extractor-options-crawler-options}
</div>
