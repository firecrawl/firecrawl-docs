...
<div id="introducing-map-alpha">
  ## Presentamos /map (Alpha) {#introducing-map-alpha}
</div>
...
<div id="new-crawl-webhook">
  ## Nuevo webhook de rastreo {#new-crawl-webhook}
</div>
...
<div id="webhook-response">
  ### Respuesta del webhook {#webhook-response}
</div>
...
<div id="migrating-from-v0">
  ## Migración desde V0 {#migrating-from-v0}
</div>
...
<div id="details-on-the-new-request-body">
  ### Detalles del nuevo cuerpo de la solicitud {#details-on-the-new-request-body}
</div>
...
<div id="crawl-endpoint">
  ## punto de conexión /crawl {#crawl-endpoint}
</div>
...
<div id="details-on-the-new-request-body-2">
  ### Detalles del nuevo cuerpo de la solicitud {#details-on-the-new-request-body-2}
</div>
