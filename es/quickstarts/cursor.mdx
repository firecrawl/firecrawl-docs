...
Esta configuración usa el conjunto de herramientas keyless de Firecrawl. Para una configuración conectada a una cuenta, consulta [Human MCP](/es/mcp-server/human-mcp), o para una configuración sin supervisión, consulta [Agent MCP](/es/mcp-server/agent-mcp); guarda las claves de API en una cabecera Authorization o en un almacén seguro de secretos, nunca en una URL.
