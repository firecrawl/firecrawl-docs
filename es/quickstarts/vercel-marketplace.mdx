...
## Qué hace la integración {#what-the-integration-does}
...
## Instalar desde Vercel {#install-from-vercel}
...
## Interactúa con páginas dinámicas {#interact-with-dynamic-pages}
...
## Usa Firecrawl con el Vercel AI SDK {#use-firecrawl-with-the-vercel-ai-sdk}
