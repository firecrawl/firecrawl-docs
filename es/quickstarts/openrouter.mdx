...
* Muchas de las principales aplicaciones de OpenRouter (Cline, Roo Code, Kilo, Cursor, Continue) son en sí mismas entornos de agentes que pueden usar el MCP de Firecrawl; consulta [Agent MCP](/es/mcp-server/agent-mcp) para integrar Firecrawl directamente en ellas.
