...
* Muchas de las principales aplicaciones de OpenRouter (Cline, Roo Code, Kilo, Cursor, Continue) son en sí mismas frameworks de agentes que pueden usar Firecrawl MCP; consulta [MCP Server](/es/mcp-server) para conectar Firecrawl directamente con ellas.
* Para trabajos grandes, usa [extracción por lotes](/es/features/batch-scrape) para mantenerte dentro de los límites de contexto del LLM.