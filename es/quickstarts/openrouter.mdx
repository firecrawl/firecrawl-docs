...
## Scraping + resumen con cualquier modelo de OpenRouter {#scrape-summarize-with-any-openrouter-model}
...
## Llamadas a herramientas: el modelo decide cuándo hacer scraping {#tool-calling-model-decides-when-to-scrape}
