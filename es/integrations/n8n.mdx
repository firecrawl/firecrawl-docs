...
## Introducción a Firecrawl y n8n {#introduction-to-firecrawl-and-n8n}
...
## ¿Por qué usar Firecrawl con n8n? {#why-use-firecrawl-with-n8n}
...
## Paso 1: Crea tu cuenta de Firecrawl {#step-1-create-your-firecrawl-account}
...
### Regístrate en Firecrawl {#sign-up-for-firecrawl}
...
### Obtén tu clave de API {#get-your-api-key}
...
## Paso 2: Configura n8n {#step-2-set-up-n8n}
...
### Selecciona tu versión de n8n {#choose-your-n8n-version}
...
### Opción A: n8n Cloud (recomendado para principiantes) {#option-a-n8n-cloud-recommended-for-beginners}
...
### Opción B: Autogestionado con Docker {#option-b-self-hosted-with-docker}
...
### Conocer la interfaz de n8n {#understanding-the-n8n-interface}
...
### El lienzo del flujo de trabajo {#the-workflow-canvas}
...
## Paso 3: Instala y configura el nodo de Firecrawl {#step-3-install-and-configure-the-firecrawl-node}
...
### Añade el nodo de Firecrawl a tu flujo de trabajo {#add-the-firecrawl-node-to-your-workflow}
...
### Conecta tu clave de API de Firecrawl {#connect-your-firecrawl-api-key}
...
### Prueba la conexión {#test-your-connection}
...
## Paso 4: Crea tu bot de Telegram {#step-4-create-your-telegram-bot}
...
### Crea un bot con BotFather {#create-a-bot-with-botfather}
...
### Obtén tu ID de chat {#get-your-chat-id}
...
## Paso 5: Crea flujos de trabajo prácticos con Telegram {#step-5-build-practical-workflows-with-telegram}
...
### Ejemplo 1: Resumen diario de actualizaciones de producto de Firecrawl {#example-1-daily-firecrawl-product-updates-summary}
...
### Ejemplo 2: Búsqueda de noticias de IA en Telegram {#example-2-ai-news-search-to-telegram}
...
### Ejemplo 3: Resumen de noticias con IA {#example-3-ai-powered-news-summary}
...
## Operaciones de Firecrawl {#understanding-firecrawl-operations}
...
### Haz scraping de una URL y obtén su contenido {#scrape-a-url-and-get-its-content}
...
### scraping + Interact con perfiles persistentes {#scrape-interact-with-persistent-profiles}
...
### Buscar y, opcionalmente, hacer scraping de los resultados de búsqueda {#search-and-optionally-scrape-search-results}
...
### Mapea un sitio web y obtén URL {#map-a-website-and-get-urls}
...
### Sandbox del navegador {#browser-sandbox}
...
## Plantillas y ejemplos de flujos de trabajo {#workflow-templates-and-examples}
...
### Cómo importar plantillas {#how-to-import-templates}
...
### Explora funciones avanzadas {#explore-advanced-features}
