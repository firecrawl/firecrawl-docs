...
## Descripción general de la integración con Dify {#dify-integration-overview}
...
## Herramientas de Firecrawl en Dify {#firecrawl-tools-in-dify}
...
## Dify frente a otras plataformas {#dify-vs-other-platforms}
...
## Sincroniza sitios web con la base de conocimientos de Dify {#sync-websites-into-the-dify-knowledge-base}
...
### Configurar Firecrawl {#configuring-firecrawl}
...
### Scraping de la página de destino {#scrape-the-target-webpage}
...
### Revisa los resultados de la importación {#review-import-results}
