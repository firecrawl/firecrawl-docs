...
## El equilibrio entre actualidad y rendimiento (`maxAge`) {#the-freshness-tradeoff-maxage}
...
### Dónde se aplica `maxAge` {#where-maxage-applies}
...
## La actualidad no implica vigencia {#freshness-is-not-liveness}
...
## Lista de verificación para acciones sensibles a la actualidad {#freshness-sensitive-action-checklist}
...
## Ejemplo práctico: Recopilar evidencia de la página actual {#worked-example-collect-current-page-evidence}
