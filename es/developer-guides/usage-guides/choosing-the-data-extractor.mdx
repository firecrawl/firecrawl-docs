...
* **Modelos disponibles**: `spark-2` (predeterminado, el más económico y rápido), `spark-1-mini` (60% más económico que Pro) y `spark-1-pro` (mayor precisión)
...
result = app.agent(
    ...
    schema=schema,
    model="spark-2"  # predeterminado; también están disponibles "spark-1-mini" o "spark-1-pro"
)
```
