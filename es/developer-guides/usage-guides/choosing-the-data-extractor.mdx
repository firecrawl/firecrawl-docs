...
### Caso de uso ideal: investigación y descubrimiento autónomos {#best-use-case-autonomous-research-discovery}
...
### Características clave {#key-characteristics-2}
...
### La limitación de las URL {#the-url-limitation}
...
### Mejor caso de uso: extracción específica de múltiples páginas {#best-use-case-targeted-multi-page-extraction}
...
## 3. Endpoint `/scrape` con modo JSON {#3-scrape-endpoint-with-json-mode}
...
### Características clave {#key-characteristics-3}
...
### Caso de uso ideal: extracción precisa de una sola página {#best-use-case-single-page-precision-extraction}
...
### Recomendaciones por escenario {#recommendations-by-scenario}
...
### Ejemplo: &quot;Encuentra a los fundadores de Firecrawl&quot; {#example-find-the-founders-of-firecrawl}
...
## Migración: `/extract` → `/agent` {#migration-extract-agent}
