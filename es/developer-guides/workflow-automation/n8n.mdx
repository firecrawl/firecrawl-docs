...
<Tip>
  **Usuarios de n8n Cloud:** En lugar de ingresar manualmente una clave de API, puedes usar el botón de OAuth con un clic **&quot;Connect to Firecrawl&quot;** al agregar el nodo de Firecrawl. Esto crea automáticamente un nuevo equipo de Firecrawl vinculado a tu cuenta de n8n y te otorga **100.000 créditos gratis**. Para ver estos créditos en el [panel de Firecrawl](https://www.firecrawl.dev/app/usage), asegúrate de cambiar a tu equipo vinculado a n8n usando el selector de equipo en la esquina superior izquierda.
</Tip>
