...
* **Agent (Sync)** inicia el trabajo y espera el resultado en un solo paso: es lo más sencillo para la mayoría de los casos de uso.
...
* [Firecrawl Discord](https://discord.gg/gSmWdAkdwd) - Obtén ayuda con Firecrawl y habla sobre web scraping
