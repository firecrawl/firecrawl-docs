...
<div id="what-youll-build">
  ## Qué vas a construir {#what-youll-build}
</div>
...
### Instalar paquetes del AI SDK {#install-ai-sdk-packages}
...
### Instalar AI Elements {#install-ai-elements}
...
### Instalar el proveedor de OpenAI {#install-openai-provider}
...
### Entendiendo el Frontend {#understanding-the-frontend}
...
### Instalar el SDK de Firecrawl {#install-firecrawl-sdk}
...
### Crea el archivo de herramientas {#create-the-tools-file}
...
### Entender las herramientas {#understanding-the-tools}
...
<div id="tool-calling-process">
  ### Proceso de llamada a herramientas {#tool-calling-process}
</div>
...
<div id="web-search-toggle">
  ### Interruptor de búsqueda web {#web-search-toggle}
</div>
...
<div id="customization-ideas">
  ## Ideas de personalización {#customization-ideas}
</div>

<div id="add-more-tools">
  ### Agregar más herramientas {#add-more-tools}
</div>
...
<div id="change-the-ai-model">
  ### Cambiar el modelo de IA {#change-the-ai-model}
</div>
...
<div id="customize-the-ui">
  ### Personaliza la interfaz de usuario {#customize-the-ui}
</div>
