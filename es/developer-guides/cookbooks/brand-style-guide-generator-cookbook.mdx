...
### Comprender el código {#understanding-the-code}
    </div>
...
<div id="extraction-process">
  ### Proceso de extracción {#extraction-process}
</div>
...
<div id="pdf-generation-process">
  ### Proceso de generación de PDF {#pdf-generation-process}
</div>
...
<div id="branding-profile-structure">
  ### Estructura del perfil de branding {#branding-profile-structure}
</div>
...
<div id="automatic-color-extraction">
  ### Extracción Automática de Colores {#automatic-color-extraction}
</div>
...
<div id="typography-documentation">
  ### Documentación sobre tipografía {#typography-documentation}
</div>
...
<div id="add-component-documentation">
  ### Agregar documentación de componentes {#add-component-documentation}
</div>
...
<div id="export-multiple-formats">
  ### Exportar en varios formatos {#export-multiple-formats}
</div>
...
<div id="custom-pdf-themes">
  ### Temas personalizados de PDF {#custom-pdf-themes}
</div>
