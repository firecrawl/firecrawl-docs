---
title: "Scraping autenticado"
description: "Aprende a extraer contenido detrás de un inicio de sesión usando cookies"
---
...
const result = await app.scrape("https://firecrawl-auth.vercel.app/dashboard", {
  ...
  waitFor: 3000, // Espera 3 segundos adicionales para que cargue la página
});
