...
## Scrape + Resumir {#scrape-summarize}
...
## Extracción de datos estructurados {#structured-data-extraction}
...
## Búsqueda + Análisis {#search-analyze}
...
## API Responses con MCP {#responses-api-with-mcp}
