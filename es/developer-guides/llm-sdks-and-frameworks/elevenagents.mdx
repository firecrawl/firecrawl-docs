...
Dales a tus agentes de voz y chat de [ElevenAgents](https://elevenlabs.io/agents) la capacidad de hacer scraping, buscar y rastrear la web en tiempo real con Firecrawl. Esta guía cubre dos opciones de integración:
...
Esta URL activa el conjunto de herramientas sin clave de Firecrawl. Para una configuración vinculada a una cuenta, consulta [Human MCP](/es/mcp-server/human-mcp), o para una configuración sin supervisión, consulta [Agent MCP](/es/mcp-server/agent-mcp); conserva las claves de API en una cabecera Authorization o en un almacén seguro de secretos, nunca en una URL.
...
* [Firecrawl MCP Server](https://docs.firecrawl.dev/mcp-server/agent-mcp)