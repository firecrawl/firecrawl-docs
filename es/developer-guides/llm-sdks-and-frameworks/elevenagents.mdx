...
El MCP sin clave ofrece exactamente Search, scraping y Parse, con límites compartidos. Usa [OAuth](/es/mcp-server/oauth) o una [clave de API](/es/mcp-server/keyless-api-key#add-an-api-key) para acceder a un conjunto de herramientas más amplio. Conserva las claves de API en una variable de entorno o almacén de secretos, nunca en una URL.
...
ElevenLabs se conectará al servidor sin clave y mostrará Search, scraping y Parse.
