...
Esta URL activa el conjunto de herramientas sin clave de Firecrawl. Para una configuración vinculada a una cuenta o sin supervisión, sigue los [modos de conexión MCP alojados](/es/developer-guides/mcp-setup-guides/oauth); conserva las claves de API en una cabecera Authorization o en un almacén seguro de secretos, nunca en una URL.
