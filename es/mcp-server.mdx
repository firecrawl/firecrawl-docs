...
Con una clave de API (desbloquea todas las herramientas y ofrece límites superiores):

```bash
https://mcp.firecrawl.dev/{FIRECRAWL_API_KEY}/v2/mcp
```

O conéctate sin una clave de API para empezar con el plan Free remoto sin clave (limitado por IP; consulta [Límites de tasa](/es/rate-limits#keyless-no-api-key) para ver la lista actual de herramientas):
