...
Los administradores del equipo gestionan la lista de permitido desde [Configuración avanzada](https://www.firecrawl.dev/app/settings?tab=advanced) del dashboard. Agrega o elimina entradas y guarda: los cambios surten efecto en aproximadamente un minuto.
...
Una solicitud desde una IP que no está en la lista de permitidos se rechaza con un `403`:
