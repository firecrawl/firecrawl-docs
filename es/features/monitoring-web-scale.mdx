...
## Objetivo de búsqueda {#search-target}
...
## Crear un monitor a escala web {#create-a-web-scale-monitor}
...
## Cómo redactar buenos objetivos y queries {#writing-good-goals-and-queries}
...
## Estados y deduplicación {#statuses-and-dedup}
