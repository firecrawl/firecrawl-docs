...
Para obtener documentación completa sobre webhooks, incluidos los tipos de eventos, la estructura del payload y ejemplos de implementación, consulta la [documentación de webhooks](/es/webhooks/overview).
...
<Note>
  Para ver la configuración detallada de webhooks, las prácticas recomendadas de
  seguridad y la resolución de problemas, visita la [documentación de
