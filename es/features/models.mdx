...
|-------|------|----------|----------|
| `spark-1-mini` | **60% más económico** | Estándar | Tareas con prioridad en el coste |
| `spark-1-pro` | Estándar | Más alta | Investigación compleja, extracción crítica (predeterminado) |
