...
Para sitios web complejos, Firecrawl ofrece un modo sigiloso que proporciona mayores tasas de éxito a la vez que mantiene la privacidad.

Obtén más información sobre el [Modo sigiloso](/es/features/enhanced-mode).