...
Para sitios web con protecciones anti-bot avanzadas, Firecrawl ofrece un modo proxy sigiloso que proporciona mayores tasas de éxito al hacer scraping de sitios complejos.

Obtén más información sobre el [Modo sigiloso](/es/features/stealth-mode).