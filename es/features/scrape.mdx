...
<div id="scraping-a-url-with-firecrawl">
  ## Extraer datos de una URL con Firecrawl {#scraping-a-url-with-firecrawl}
</div>

<div id="scrape-endpoint">
  ### punto de conexión /scrape {#scrape-endpoint}
</div>
...
### Metadatos de la respuesta y códigos de estado {#response-metadata-and-status-codes}
...
<div id="extract-structured-data">
  ## Extrae datos estructurados {#extract-structured-data}
</div>

### punto de conexión /scrape (con json) {#scrape-with-json-endpoint}
...
<div id="json-format-options">
  ### Opciones del formato JSON {#json-format-options}
</div>
...
<div id="extract-brand-identity">
  ## Extraer la identidad de la marca {#extract-brand-identity}
</div>

<div id="scrape-with-branding-endpoint">
  ### endpoint /scrape (con branding) {#scrape-with-branding-endpoint}
</div>
...
<div id="branding-profile-structure">
  ### Estructura del perfil de marca {#branding-profile-structure}
</div>
...
<div id="combining-with-other-formats">
  ### Combinar con otros formatos {#combining-with-other-formats}
</div>
...
## Extraer datos de productos {#extract-product-data}
...
### punto de conexión /scrape (con producto) {#scrape-with-product-endpoint}
...
### Estructura del objeto product {#product-object-structure}
...
### Cómo funciona la extracción de productos {#how-product-extraction-works}
...
### Combinación con otros formatos {#combining-with-other-formats-2}
...
<div id="audio-extraction">
  ## Extracción de audio {#audio-extraction}
</div>
...
<div id="video-extraction">
  ## Extracción de video {#video-extraction}
</div>
...
<div id="question-format">
  ## Formato de pregunta {#question-format}
</div>
...
## Ocultación de PII {#pii-redaction}
...
<div id="interacting-with-the-page-with-actions">
  ## Interacción con la página mediante acciones {#interacting-with-the-page-with-actions}
</div>
...
<div id="location-and-language">
  ## Ubicación e idioma {#location-and-language}
</div>
...
## Caché y maxAge {#caching-and-maxage}
...
### Frescura y estado del elemento {#freshness-and-item-status}
...
<div id="batch-scraping-multiple-urls">
  ## Raspado por lotes de múltiples URL {#batch-scraping-multiple-urls}
</div>
...
<div id="zero-data-retention-zdr">
  ## Retención cero de datos (ZDR) {#zero-data-retention-zdr}
</div>
