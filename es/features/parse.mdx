---
title: 'Parse'
description: 'Sube un documento local o privado y conviértelo en datos limpios, listos para LLM'
og:title: "Parse | Firecrawl"
og:description: "Convierte PDF, DOCX, XLSX, HTML locales y más en Markdown o JSON estructurado"
