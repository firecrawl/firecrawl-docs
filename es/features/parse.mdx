...
## Markdown físico por página (PDF) {#per-page-markdown-pdf}
...
## Marcadores de página (PDF) {#page-markers-pdf}
...
## Bloques de diseño (PDF) {#layout-blocks-pdf}
...
### Fundamentación: de una respuesta a la página {#grounding-from-an-answer-back-to-the-page}
...
## Salida JSON estructurada {#structured-json-output}
...
### Modos de procesamiento {#parsing-modes}
...
## Referencia de la solicitud {#request-reference}
