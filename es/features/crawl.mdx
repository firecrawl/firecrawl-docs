...
<Info>
  Cada página rastreada consume 1 crédito (más créditos adicionales para opciones como modo JSON, proxy sigiloso o análisis de PDF). El `limit` predeterminado es de 10.000 páginas. Establece un `limit` más bajo para controlar el consumo de créditos; por ejemplo, `limit: 100` para limitar el rastreo a 100 páginas.
</Info>
