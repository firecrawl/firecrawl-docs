---
title: 'Rastrear'
description: 'Rastrea recursivamente un sitio web y extrae el contenido de cada página'
og:title: 'Rastrear | Firecrawl'
og:description: 'Rastrea recursivamente un sitio web y extrae el contenido de cada página'
icon: 'spider'
---
...
Todas las opciones del [endpoint Scrape](/es/api-reference/endpoint/scrape) están disponibles en crawl mediante `scrapeOptions` (JS) / `scrape_options` (Python). Se aplican a cada página que el crawler raspa, incluidos formatos, proxy, caché, acciones, ubicación y etiquetas.
