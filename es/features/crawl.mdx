...
<div id="checking-crawl-status">
  ## Verificar el estado del rastreo {#checking-crawl-status}
</div>
...
<div id="response-handling">
  ### Manejo de respuestas {#response-handling}
</div>
...
<div id="start-and-check-later">
  ### Iniciar y luego verificar el estado {#start-and-check-later}
</div>
...
<div id="real-time-results-with-websocket">
  ## Resultados en tiempo real con WebSocket {#real-time-results-with-websocket}
</div>
...
<div id="verifying-webhook-signatures">
  ### Verificación de firmas de webhooks {#verifying-webhook-signatures}
</div>
...
## Ejecución y contabilización de resultados {#execution-and-result-accounting}
...
### Lectura de los contadores de estado {#reading-the-status-counters}
...
### Paginar los resultados {#paging-through-results}
...
### Páginas fallidas y bloqueadas {#failed-and-blocked-pages}
...
### Hasta dónde puede llegar el rastreador {#what-the-crawler-is-scoped-to-reach}
...
### Cuando los resultados varían entre ejecuciones {#when-results-vary-between-runs}
...
### Cómo saber cuándo ha terminado un crawl {#knowing-when-a-crawl-is-done}
