...
<div id="scrape-and-extract-structured-data-with-firecrawl">
  ## Rastrea y extrae datos estructurados con Firecrawl {#scrape-and-extract-structured-data-with-firecrawl}
</div>
...
<div id="json-mode-via-scrape">
  ### Modo JSON con /scrape {#json-mode-via-scrape}
</div>
...
<div id="structured-data-without-schema">
  ### Datos estructurados sin esquema {#structured-data-without-schema}
</div>
...
<div id="real-world-example-extracting-company-information">
  ### Ejemplo real: extracción de información de empresas {#real-world-example-extracting-company-information}
</div>
...
### Detección de inyección de prompts {#prompt-injection-detection}
...
## Consejos para una extracción consistente {#tips-for-consistent-extraction}
