...
## Formatos de documentos compatibles {#supported-document-formats}
...
## Cómo usar Análisis de documentos {#how-to-use-document-parsing}
...
### Subir documentos con `/v2/parse` {#upload-documents-with-v2parse}
...
<div id="example-scraping-an-excel-file">
  ### Ejemplo: Raspado de un archivo de Excel {#example-scraping-an-excel-file}
</div>

<ScrapeXLSX />

<div id="example-scraping-a-word-document">
  ### Ejemplo: extracción de un documento de Word {#example-scraping-a-word-document}
</div>
