...
<Info>
  Las solicitudes con proxy mejorado ahora tienen el mismo costo que las solicitudes básicas: **1 crédito por solicitud**. Ya no hay ningún cargo adicional cuando `auto` pasa a un reintento mejorado.
</Info>
