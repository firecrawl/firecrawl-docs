...
## Relación con `/search` {#how-this-relates-to-search}
...
## Buscar artículos {#search-papers}
...
### Ejemplo biomédico {#biomedical-example}
...
## Inspeccionar un artículo científico {#inspect-a-paper}
...
## Leer pasajes del artículo {#read-paper-passages}
...
## Encontrar artículos relacionados {#find-related-papers}
