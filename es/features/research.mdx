...
description: "Busca artículos, lee pasajes de artículos, encuentra trabajos relacionados y busca en repositorios de GitHub relacionados"
og:title: "Índice de investigación | Firecrawl"
og:description: "Utiliza el índice de investigación de Firecrawl para recuperar artículos, ampliarlos semánticamente, leerlos y buscar en GitHub."
icon: "book-open"
---

import ResearchFeedbackCTA from "/snippets/es/research-feedback-cta.mdx";
...
| Consultar metadatos o leer pasajes | [`GET /search/research/papers/{id}`](/es/api-reference/endpoint/research-paper)                  |
| Buscar artículos relacionados         | [`GET /search/research/papers/{id}/similar`](/es/api-reference/endpoint/research-related-papers) |
| Buscar en el historial de GitHub      | [`GET /search/research/github`](/es/api-reference/endpoint/research-github-search)               |
...
<CodeGroup>
  ```bash cURL
  # No se necesita una clave de API para comenzar; agrega -H "Authorization: Bearer $FIRECRAWL_API_KEY" para obtener límites de tasa más altos:
  ...
  firecrawl = Firecrawl(
    # No se necesita una clave de API para comenzar; agrega una para obtener límites de tasa más altos:
    # api_key="fc-YOUR-API-KEY",
  )
