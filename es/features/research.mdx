...
<Note>
  Para darle a tu agente acceso al Índice de investigación, te recomendamos encarecidamente utilizar nuestro [CLI](/es/sdks/cli) o [MCP](/es/mcp-server/agent-mcp), junto con nuestra [**skill de investigación dedicada**](https://github.com/firecrawl/skills/blob/main/skills/firecrawl-research-index/SKILL.md), que puedes instalar con:
