...
## Proporcionar URLs (opcional) {#providing-urls-optional}
...
## Estado y finalización de trabajos {#job-status-and-completion}
...
### Posibles estados {#possible-states}
...
#### Ejemplo en estado pendiente {#pending-example}

<AgentStatusPending />

#### Ejemplo completado {#completed-example}

<AgentStatusCompleted />

## Listado de ejecuciones de agentes {#listing-agent-runs}
...
## Seguimiento de una ejecución en curso {#following-a-run-in-progress}
...
## Trazas de ejecución y snapshots {#execution-traces-and-snapshots}
...
## Obtención de los datos de origen del agente {#getting-the-agents-source-data}
...
## Compartir ejecuciones del agente {#share-agent-runs}
...
### Especificar un modelo {#specifying-a-model}
...
## Agent vs Extract: Qué ha mejorado {#agent-vs-extract-whats-improved}
...
## Carga de archivos CSV en Agent Playground {#csv-upload-in-agent-playground}
...
## Solución de problemas con Ask {#troubleshooting-with-ask}
...
### Cómo funcionan los precios de Agent {#how-agent-pricing-works}
...
### Precios de agentes en paralelo {#parallel-agents-pricing}
...
### Gestión de costos {#managing-costs}
