...
Firecrawl Agent ofrece dos modelos. `spark-1-pro` es el modelo predeterminado y ofrece la máxima precisión para tareas complejas. `spark-1-mini` cuesta un 60% menos y es una buena opción cuando priorizas la eficiencia de costes.

| Modelo | Coste | Precisión | Ideal para |
|--------|-------|-----------|------------|
| `spark-1-mini` | **60% más barato** | Estándar | Tareas con prioridad en el coste |
| `spark-1-pro` | Estándar | Mayor | Investigación compleja, extracción crítica (predeterminado) |

<Tip>
  Agent usa Spark 1 Pro de forma predeterminada. Elige Spark 1 Mini explícitamente cuando quieras reducir el coste de tareas sencillas.
</Tip>
...
| `model`      | string | No          | Modelo a utilizar: `spark-1-pro` (predeterminado) o `spark-1-mini`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
- [Iniciar una tarea de Agent](/es/api-reference/endpoint/agent)
- [Obtener el estado de Agent](/es/api-reference/endpoint/agent-get)
- [Cancelar una tarea de Agent](/es/api-reference/endpoint/agent-delete)
