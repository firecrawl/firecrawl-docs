...
Sube tu CSV, escribe un prompt que describa qué datos quieres que el agente obtenga para cada fila, define tus campos de salida y ejecútalo. El agente procesa cada fila en paralelo y completa los resultados.
