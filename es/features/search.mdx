...
Cuando no se hace scraping de los resultados de búsqueda (no se especifican opciones de scraping), el costo es de 2 créditos por cada 10 resultados. Cuando el scraping está habilitado, no hay cargos adicionales por scrapes básicos de cada resultado más allá de los costos estándar de scraping.
...
- **Modo de proxy sigiloso (stealth)**: +4 créditos adicionales por resultado de búsqueda
- ***modo JSON***: +4 créditos adicionales por resultado de búsqueda

Para controlar los costos:

- Establece `parsers: []` si no necesitas contenido de PDF
