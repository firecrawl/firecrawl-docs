...
<div id="performing-a-search-with-firecrawl">
  ## Buscar con Firecrawl {#performing-a-search-with-firecrawl}
</div>

<div id="search-endpoint">
  ### punto de conexión /search {#search-endpoint}
</div>
...
<div id="search-result-types">
  ## Tipos de resultados de búsqueda {#search-result-types}
</div>
...
## Categorías de búsqueda {#search-categories}
...
### Búsqueda por categoría de investigación {#research-category-search}
...
### Búsqueda por categoría para desarrolladores {#developer-category-search}
...
### Búsqueda de categorías mixtas {#mixed-category-search}
...
<div id="include-domains">
  ### Dominios incluidos {#include-domains}
</div>
...
<div id="exclude-domains">
  ### Excluir dominios {#exclude-domains}
</div>
...
### Formato de respuesta de categorías {#category-response-format}
...
<div id="hd-image-search-with-size-filtering">
  ### Búsqueda de imágenes en HD con filtro de tamaño {#hd-image-search-with-size-filtering}
</div>
...
<div id="search-with-content-scraping">
  ## Búsqueda con extracción de contenido {#search-with-content-scraping}
</div>
...
<div id="response-with-scraped-content">
  ### Respuesta con contenido rastreado {#response-with-scraped-content}
</div>
...
<div id="search-then-scrape-two-step-pattern">
  ## Buscar y luego hacer scraping (patrón de dos pasos) {#search-then-scrape-two-step-pattern}
</div>
...
### Búsqueda por tiempo {#time-based-search}
...
### Tiempo de espera personalizado {#custom-timeout}
...
<div id="zero-data-retention-zdr">
  ## Retención de datos cero (ZDR) {#zero-data-retention-zdr}
</div>
...
<div id="end-to-end-zdr">
  ### ZDR de extremo a extremo {#end-to-end-zdr}
</div>
...
<div id="anonymized-zdr">
  ### ZDR anonimizado {#anonymized-zdr}
</div>
...
### Combinar búsqueda ZDR con Scrape ZDR {#combining-search-zdr-with-scrape-zdr}
...
## Implicaciones de costos {#cost-implications}
...
<div id="advanced-scraping-options">
  ## Opciones avanzadas de scraping {#advanced-scraping-options}
</div>
...
## Comentarios sobre la búsqueda {#search-feedback}
