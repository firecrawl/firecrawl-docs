...
* `developer`: Busca en el [Índice de desarrolladores](/es/features/developer) — issues de GitHub, pull requests fusionadas, archivos README de repositorios y sitios de documentación seleccionados
...
Los resultados para desarrolladores se devuelven en su propio grupo `developer`, junto a `web`, cada uno con `category: "developer"`. Para obtener resultados ordenados con los pasajes coincidentes y usar los filtros de repositorio y fuente de documentación, utiliza el [endpoint de búsqueda para desarrolladores](/es/features/developer#developer-search-endpoint).
