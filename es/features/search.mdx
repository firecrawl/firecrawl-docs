...
La API de búsqueda de Firecrawl te permite realizar búsquedas en la web y, opcionalmente, extraer los resultados de búsqueda en una sola operación.
...
* Opcionalmente, puedes recuperar contenido de los resultados de búsqueda en varios formatos

Para más detalles, consulta la [referencia de la API del endpoint Search](https://docs.firecrawl.dev/api-reference/endpoint/search).
