...
El modo `json` ofrece una comparación estructurada de campos específicos extraídos del contenido. Esto es útil para seguir cambios en datos concretos en lugar de en todo el contenido.
