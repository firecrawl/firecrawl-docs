...
<div id="crawl-with-change-tracking">
  ## Rastreo con seguimiento de cambios {#crawl-with-change-tracking}
</div>
...
<div id="batch-scrape-with-change-tracking">
  ## Extracción por lotes con seguimiento de cambios {#batch-scrape-with-change-tracking}
</div>
...
<div id="scheduling-change-tracking">
  ## Programar el seguimiento de cambios {#scheduling-change-tracking}
</div>
...
<div id="cloud-and-serverless-schedulers">
  ### Planificadores en la nube y sin servidor {#cloud-and-serverless-schedulers}
</div>
