...
description: "Acelera tus scrapes un significantly con el parámetro maxAge"
og:title: "Scraping más rápido | Firecrawl"
og:description: "Acelera tus scrapes un significantly con el parámetro maxAge"
---
...
Obtén tus resultados **hasta un significantly más rápido** cuando no necesites los datos más recientes. Controla la frescura con `maxAge`:
...
Al rastrear con `maxAge`, cada página de tu rastreo se beneficiará de una mejora de velocidad del significantly si tenemos datos recientes en caché para esa página.
