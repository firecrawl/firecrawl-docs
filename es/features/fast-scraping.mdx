...
<div id="when-to-use-this">
  ## Cuándo usarlo {#when-to-use-this}
</div>
...
<div id="common-maxage-values">
  ## Valores comunes de maxAge {#common-maxage-values}
</div>
...
### Cuando se omite la caché {#when-caching-is-bypassed}
...
### Coincidencia para un acierto de caché {#cache-hit-matching}
...
## Rastreo más rápido {#faster-crawling}
