...
## Controles de la política {#policy-controls}
...
### Conecta tu tenant {#connecting-your-tenant}
...
### Capacidad y comportamiento {#capacity-and-behavior}
...
## Configuración de la política {#configuring-the-policy}
...
## Anulaciones por solicitud {#per-request-overrides}
...
## Cuando una URL está bloqueada {#when-a-url-is-blocked}
