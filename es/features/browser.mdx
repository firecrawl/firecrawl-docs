...
## Iniciar una sesión {#launch-a-session}
...
### Gestión de descargas de archivos {#handling-file-downloads}
...
## agent-browser (Modo Bash) {#agent-browser-bash-mode}
...
### Sesiones persistentes {#persistent-sessions}
...
### Configuración de TTL {#ttl-configuration}
...
### Vista interactiva en vivo {#interactive-live-view}
...
## Conexión mediante CDP {#connecting-via-cdp}
...
## Cuándo usar navegador {#when-to-use-browser}
