...
De forma predeterminada, cada sesión de navegador comienza desde cero. Con `profile`, puedes guardar el estado del navegador entre sesiones. Esto es útil para seguir conectado, mantener tus preferencias o reanudar flujos de trabajo de varios pasos.
