...
El precio depende de cómo controles la sesión: 7 créditos por minuto de navegador si la sesión usa un `prompt`, o 2 créditos por minuto de navegador si no lo usa (solo con `code` de Playwright). La facturación se calcula por minuto de navegador, con un mínimo de un minuto. Los usuarios Free reciben 5 horas de uso gratuito.
