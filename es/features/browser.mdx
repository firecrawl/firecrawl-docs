...
<Info>
  sandbox del navegador ahora es [Interact](/es/features/interact), que ofrece las mismas funcionalidades y además puede controlarse mediante prompts.
</Info>

El sandbox del navegador de Firecrawl ofrece a tus agentes un entorno de navegador seguro donde pueden interactuar con la web. Completa formularios, haz clic en botones, autentícate y mucho más.
...
El número de sesiones de navegador simultáneas permitidas está determinado por el límite de concurrencia del plan de tu equipo.
