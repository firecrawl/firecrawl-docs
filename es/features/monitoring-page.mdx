...
## Crea un monitor de página {#create-a-page-monitor}
...
## Objetivo de scrape {#scrape-target}
...
## Detectar cambios a nivel de campo {#detecting-field-level-changes}
...
## Configuración compartida {#shared-configuration}
