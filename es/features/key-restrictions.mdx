...
## Lo que puedes restringir {#what-you-can-restrict}
...
## Configurar una clave {#configuring-a-key}
...
## Restricciones de formatos {#format-restrictions}
...
### Acciones que devuelven contenido {#actions-that-return-content}
...
## Restricciones de endpoints {#endpoint-restrictions}
