...
<Info>Extract se factura de forma diferente a otros puntos de conexión. Consulta los [precios de Extract](https://www.firecrawl.dev/extract#pricing) para más detalles.</Info>
...
Puedes consultar los precios de /extract en la [página de precios de Extract](https://www.firecrawl.dev/extract#pricing) y supervisar el uso en la [página de Extract del panel](https://www.firecrawl.dev/app/extract).
