---
title: "Monitoreo"
description: "Programa scrapes y crawls periódicos, detecta cambios en el contenido y recibe notificaciones por webhook o correo electrónico"
og:title: "Monitoreo | Firecrawl"
og:description: "Programa scrapes y crawls periódicos, detecta cambios en el contenido y recibe notificaciones por webhook o correo electrónico"
icon: "radar"
---
...
puede procesar resultados relevantes del webhook `monitor.page`:
...
El intervalo mínimo es de 15 minutos. Las respuestas de la API siempre devuelven la expresión cron normalizada. Las programaciones en texto se distribuyen según el ID del monitor antes de convertirse a cron, para que varios monitores no se ejecuten todos en el mismo instante.
