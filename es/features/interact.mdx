...
## Selecciona el modelo de interacción adecuado {#choose-the-right-interaction-model}
...
## Interactúa mediante prompts {#interact-via-prompting}
...
### Mantén los prompts pequeños y enfocados {#keep-prompts-small-and-focused}
...
## Ejecución de código {#running-code}
...
### Vista en vivo interactiva {#interactive-live-view}
...
## Perfiles persistentes con Scraping + Interact {#persistent-profiles-with-scrape-interact}
...
### Validar la persistencia {#validate-persistence}
...
### Cuerpo de la solicitud (POST) {#request-body-post}
