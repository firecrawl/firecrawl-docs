...
- [Configure an API key](/mcp-server/keyless-api-key#add-an-api-key) for unattended use. Keep the secret outside agent chat and use an environment-variable reference.
