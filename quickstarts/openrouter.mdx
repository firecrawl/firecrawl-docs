...
- Many top OpenRouter apps (Cline, Roo Code, Kilo, Cursor, Continue) are themselves agent harnesses that can use Firecrawl MCP — see [Agent MCP](/mcp-server/agent-mcp) to wire Firecrawl into those directly.
