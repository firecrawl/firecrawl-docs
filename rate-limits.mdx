...
Firecrawl uses **subscription-based monthly plans** rather than pay-as-you-go. However, we offer flexible payment options for your needs:

- **Auto-recharge feature**: Once you subscribe to a plan, you can automatically purchase additional credits when you dip below a threshold, with better rates on larger auto-recharge packs
- **Testing options**: Start with our **Free** or **Hobby** tier to evaluate Firecrawl before scaling up to larger plans
- **Affordable scaling**: Our **Standard plan ($99/month)** is designed for moderate to large-scale use cases and provides excellent value compared to pay-as-you-go pricing

This approach lets you test thoroughly without overpaying, while auto-recharge ensures you never run out of credits during production use.
