...
<Info>
  Each page crawled consumes 1 credit. Additional credits apply for certain options: JSON mode costs 4 additional credits per page, enhanced proxy costs 4 additional credits per page, and PDF parsing costs 1 credit per PDF page. The default `limit` is 10,000 pages. Set a lower `limit` to control credit usage - for example, `limit: 100` to cap the crawl at 100 pages.
</Info>
