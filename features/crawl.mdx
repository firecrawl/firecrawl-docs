...
<Note>
  The `/crawl` endpoint defaults to a `limit` of 10,000 pages. Before starting a crawl, Firecrawl performs a credit check to ensure you have enough credits for the full limit. On the free plan with 500 credits, be sure to set `limit: 500` or lower to match your available credits.
</Note>
