...
- **Python SDK**: Use snake_case parameter names — `max_age` instead of `maxAge`, `store_in_cache` instead of `storeInCache`, etc. Using camelCase in the Python SDK will silently have no effect.
