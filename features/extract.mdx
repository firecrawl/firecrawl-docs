...
See [API Reference](https://docs.firecrawl.dev/api-reference/v2-endpoint/extract) for more details.
...
You can leverage the FIRE-1 agent with the `/v2/extract` endpoint for complex extraction tasks that require navigation across multiple pages or interaction with elements.
