...
<Frame caption="Every block the engine detects, typed and positioned — the same regions that become the markdown.">
  <img src="/images/pdf-blocks-overlay.png" alt="A parsed PDF page with colored bounding boxes overlaid on each detected layout block: section headers, text, table, figure, caption, page footer, and page number" />
</Frame>
