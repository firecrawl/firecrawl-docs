...
2. **Interact** by calling `POST /v2/scrape/{scrapeId}/interact` with a `prompt` or `code`. On the first call, the scraped session is resumed and you can start interacting with the page.
