...
URLs are primarily discovered from the website's sitemap, supplemented with SERP (search engine) results and Firecrawl's index to improve coverage. You can control sitemap behavior with the `sitemap` parameter.
