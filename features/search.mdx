...
The cost of a search is 2 credits per 10 search results, charged in blocks of 10. Requesting 1–10 results costs 2 credits, 11–20 costs 4 credits, 21–30 costs 6 credits, and so on. If scraping options are enabled, the standard scraping costs apply to each search result:
