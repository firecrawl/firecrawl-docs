...
import SearchLanguagePython from "/snippets/v2/search/language/python.mdx";
import SearchLanguageNode from "/snippets/v2/search/language/js.mdx";
import SearchLanguageCURL from "/snippets/v2/search/language/curl.mdx";
import SearchLanguageCLI from "/snippets/v2/search/language/cli.mdx";
...
Use the `lang` parameter to get search results in a specific language. The `lang` parameter uses ISO 639-1 language codes and should be used together with the `country` parameter for correct results.
