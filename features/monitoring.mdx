...
| Search monitor | `ceil(results / 10) × 2` credits per check (≈ 2 credits per 10 results) |
| Search monitor judging | 5 credits per result judged, when AI judging is enabled (covers scraping and evaluating the result) |
