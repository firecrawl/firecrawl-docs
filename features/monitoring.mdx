...
1. Open the [monitoring dashboard](https://www.firecrawl.dev/app/monitoring). You can do this either before creating a monitor or after a monitor already exists.
