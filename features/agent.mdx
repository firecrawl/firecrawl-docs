...
**All users** receive **5 free daily runs** to explore Agent's capabilities without any cost. These free runs apply to all calling methods, including the API, SDKs, and the playground.
