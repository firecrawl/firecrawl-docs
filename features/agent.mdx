...
<Info>
Schema suggestions in the Agent Playground use lightweight excerpts from up to 3 of the URLs you provide to ground field names. All provided URLs are still used for the actual agent run, and these preview fetches do not consume credits.
</Info>
