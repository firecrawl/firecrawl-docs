...
| `maxCredits` | number | No | Maximum number of credits you're willing to spend on this request. Limits spending and prevents unexpected high costs |
...
Agent costs scale based on several factors:

**Factors that increase costs:**
- **Multiple URLs/domains**: Researching across more websites uses more credits
- **Complex prompts**: Detailed, multi-step research tasks consume more credits than simple single-page extractions
- **Structured output**: Requests with JSON schemas or complex data structures may use additional credits
- **Large datasets**: Extracting large amounts of data from multiple sources increases cost

**Typical cost ranges (Research Preview):**
- **Simple extractions** (single page, basic info): 10-50 credits
- **Standard research** (5-10 pages, structured data): 50-200 credits
- **Complex analysis** (10+ pages, multi-domain research): 200+ credits

**To minimize costs:**
- Start with your 5 free daily requests to understand pricing for your specific use case
- Use the `maxCredits` parameter to set a spending limit and avoid unexpected charges
- Keep prompts concise and focused—more specific queries often use fewer credits
- Test with simpler prompts first before moving to complex multi-domain research
