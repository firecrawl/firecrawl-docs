...
**All users** receive **5 free daily runs** to explore Agent's capabilities without any cost. Free runs apply regardless of how you access Agent — via the API, SDKs, or the Playground. Free runs are always consumed first before paid credits.
