...
Pricing is straightforward: 100 credits per browser hour. Free users get 5 hours of free usage.


## Rate limits

For the initial launch, we are allow all plans up to 20 concurrent browser sessions.
