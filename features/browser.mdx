...
By default, each browser session starts with a clean slate. With `profile`, you can save cookies, localStorage, and other browser state so it carries over to future sessions. This is useful for staying logged in, preserving preferences, or resuming multi-step workflows.
