...
By default, each browser session starts with a clean slate. With `profile`, you can save browser state across sessions. This is useful for staying logged in, preserving preferences, or resuming multi-step workflows.
