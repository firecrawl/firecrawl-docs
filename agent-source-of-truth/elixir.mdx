...
Canonical Firecrawl Elixir source of truth for agents. Generated from SDK source (`:firecrawl` **v1.11.0**) and the v2 OpenAPI spec.
...
- `timeout`
  - Type: integer
  - Use when: you need a timeout in milliseconds. Min 1000, default 60000, max 300000.
