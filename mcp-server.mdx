...
<CardGroup cols={3}>
  <Card title="Try instantly" icon="bolt" href="/mcp-server/keyless-api-key#try-keyless" cta="Start keyless setup" arrow>
    No account or key. Use Search, Scrape, and Parse with a daily limit shared by users on the same public IP.
  </Card>
  <Card title="Sign in with your account" icon="right-to-bracket" href="/mcp-server/oauth" cta="Connect your account" arrow>
