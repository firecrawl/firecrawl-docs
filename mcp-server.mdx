...
<CardGroup cols={3}>
  <Card title="Keyless" icon="bolt" href="/mcp-server/keyless#try-keyless" cta="Start keyless" arrow>
    No account or key. Search, Scrape, and Parse within daily limits.
  </Card>
  <Card title="Sign in" icon="right-to-bracket" href="/mcp-server/oauth" cta="Sign in" arrow>
    Browser sign-in from Codex, Claude Code, or your favorite harness.
  </Card>
  <Card title="API key" icon="key" href="/mcp-server#add-an-api-key" cta="Add a key" arrow>
    Add an API key in your config, no browser needed.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="For Humans" icon="user" href="/mcp-server/oauth">
    Sign in via browser or use an API key.
  </Card>
</CardGroup>
