...
This endpoint will have its own OAuth resource identity and will always ask an anonymous client to sign in. It also accepts Firecrawl API keys in an `Authorization` header.
