...
| Dashboard | ✘ | ✔ |
| Actions | ✘ | ✔ |
| Browserless + Browserful scraping | ✘ | ✔ |
| Enterprise features | ✘ | ✔ |
...
- **Cloud** — Get started immediately with a managed service that includes advanced anti-bot handling, proxy infrastructure, and a usage dashboard. Sign up at [firecrawl.dev](https://firecrawl.dev).