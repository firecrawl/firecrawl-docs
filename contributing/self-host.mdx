...
| --- | --- | --- |
| All API endpoints supported | Yes | Not always; some endpoints require extra services or are unavailable |
| Screenshot support | Yes | Yes, when the Playwright service is running |
| Fire-1 engine (Fire-engine) | Yes | No (not available in self-hosted instances) |
