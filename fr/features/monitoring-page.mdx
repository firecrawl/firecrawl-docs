...
## Créer un moniteur de page {#create-a-page-monitor}
...
## Détection des modifications champ par champ {#detecting-field-level-changes}
...
## Configuration partagée {#shared-configuration}
