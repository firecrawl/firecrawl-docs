...
Les administrateurs de l’équipe gèrent la liste d’autorisation depuis les [paramètres avancés](https://www.firecrawl.dev/app/settings?tab=advanced) dans le dashboard. Ajoutez ou supprimez des entrées, puis cliquez sur Save — les modifications prennent effet en une minute environ.
