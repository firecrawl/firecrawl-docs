...
Pour les sites web dotés d’une protection antibot avancée, Firecrawl propose un mode proxy furtif qui améliore le taux de réussite lors de l’exploration de sites difficiles.
