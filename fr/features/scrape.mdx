...
* Vidéo (`video`) - extrait la vidéo de meilleure qualité à partir d’URL vidéo prises en charge, par ex. YouTube ou TikTok (retourne une URL GCS signée, expire après 1 heure)
...
Le format `video` extrait la vidéo en meilleure qualité à partir des sites web pris en charge (par ex. YouTube et TikTok) et renvoie une URL signée Google Cloud Storage. Cela permet de créer des pipelines de traitement vidéo, des outils de modération ou des workflows d’archivage multimédia.
