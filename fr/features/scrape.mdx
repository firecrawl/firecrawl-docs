...
<div id="scraping-a-url-with-firecrawl">
  ## Extraire le contenu d’une URL avec Firecrawl {#scraping-a-url-with-firecrawl}
</div>

<div id="scrape-endpoint">
  ### point de terminaison /scrape {#scrape-endpoint}
</div>
...
### Métadonnées de réponse et codes d’état {#response-metadata-and-status-codes}
...
## Formats de scraping {#scrape-formats}
...
<div id="extract-structured-data">
  ## Extraire des données structurées {#extract-structured-data}
</div>

### Point de terminaison /scrape (avec json) {#scrape-with-json-endpoint}
...
<div id="json-format-options">
  ### Options du format JSON {#json-format-options}
</div>
...
<div id="extract-brand-identity">
  ## Extraire l’identité de marque {#extract-brand-identity}
</div>

<div id="scrape-with-branding-endpoint">
  ### endpoint /scrape (avec branding) {#scrape-with-branding-endpoint}
</div>
...
<div id="branding-profile-structure">
  ### Structure du profil de marque {#branding-profile-structure}
</div>
...
<div id="combining-with-other-formats">
  ### Combiner avec d’autres formats {#combining-with-other-formats}
</div>
...
## Extraire les données produit {#extract-product-data}
...
### point de terminaison /scrape (avec le paramètre product) {#scrape-with-product-endpoint}
...
### Structure de l’objet `product` {#product-object-structure}
...
### Fonctionnement de l’extraction de produit {#how-product-extraction-works}
...
### Combiner avec d’autres formats {#combining-with-other-formats-2}
...
<div id="audio-extraction">
  ## Extraction audio {#audio-extraction}
</div>
...
<div id="video-extraction">
  ## Extraction vidéo {#video-extraction}
</div>
...
<div id="highlights-format">
  ## Format highlights {#highlights-format}
</div>
...
## Masquage des données personnelles identifiables {#pii-redaction}
...
<div id="interacting-with-the-page-with-actions">
  ## Interagir avec la page à l’aide des actions {#interacting-with-the-page-with-actions}
</div>
...
<div id="location-and-language">
  ## Localisation et langue {#location-and-language}
</div>
...
## Mise en cache et maxAge {#caching-and-maxage}
...
### Fraîcheur et état des éléments {#freshness-and-item-status}
...
<div id="batch-scraping-multiple-urls">
  ## Extraction par lots de plusieurs URL {#batch-scraping-multiple-urls}
</div>
...
<div id="zero-data-retention-zdr">
  ## Rétention zéro des données (ZDR) {#zero-data-retention-zdr}
</div>
