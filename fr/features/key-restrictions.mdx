...
Lorsqu&#39;une clé comporte une liste de formats autorisés, tous les points de terminaison qui produisent du contenu via scrape l&#39;appliquent : `/v2/scrape`, `/v2/batch/scrape`, `/v2/crawl` (via `scrapeOptions`) et `/v2/search` (via `scrapeOptions`), ainsi que leurs équivalents v1.
...
* Les restrictions de clé sont indépendantes des restrictions basées sur l&#39;IP ; une clé peut cumuler les deux.