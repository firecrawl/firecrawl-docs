...
## Ce que vous pouvez restreindre {#what-you-can-restrict}
...
## Configurer une clé {#configuring-a-key}
...
## Restrictions de format {#format-restrictions}
...
### Actions qui renvoient du contenu {#actions-that-return-content}
...
## Restrictions des points de terminaison {#endpoint-restrictions}
