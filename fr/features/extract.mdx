...
## Utiliser `/extract` {#using-extract}
...
## Statut et achèvement du job {#job-status-and-completion}
...
<div id="example-response-with-web-search">
  ### Exemple de réponse avec recherche web {#example-response-with-web-search}
</div>
...
<div id="extracting-without-urls">
  ## Extraire sans URL {#extracting-without-urls}
</div>
...
<div id="known-limitations-beta">
  ## Limitations connues (bêta) {#known-limitations-beta}
</div>
