...
<div id="common-maxage-values">
  ## Valeurs courantes de maxAge {#common-maxage-values}
</div>
...
### Cas où la mise en cache est ignorée {#when-caching-is-bypassed}
...
### Critères de correspondance d’un hit de cache {#cache-hit-matching}
...
## Crawl plus rapide {#faster-crawling}
