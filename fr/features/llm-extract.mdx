...
<div id="scrape-and-extract-structured-data-with-firecrawl">
  ## Extraire et structurer des données avec Firecrawl {#scrape-and-extract-structured-data-with-firecrawl}
</div>
...
<div id="json-mode-via-scrape">
  ### Mode JSON via /scrape {#json-mode-via-scrape}
</div>
...
<div id="structured-data-without-schema">
  ### Données structurées sans schéma {#structured-data-without-schema}
</div>
...
<div id="real-world-example-extracting-company-information">
  ### Exemple concret : extraction d’informations d’entreprise {#real-world-example-extracting-company-information}
</div>
...
### Détection des injections de prompts {#prompt-injection-detection}
...
## Conseils pour une extraction cohérente {#tips-for-consistent-extraction}
