...
- **Feuilles de calcul Excel** (`.xlsx`, `.xls`)
  ...
  - Les feuilles sont séparées par des titres H2 contenant le nom de la feuille
  - Préserve le format des cellules et les types de données

- **Documents Word** (`.docx`, `.doc`)
  - Extrait le contenu texte tout en préservant la structure du document
  - Conserve les titres, paragraphes, listes et tableaux
  - Préserve la mise en forme de base

- **Documents PDF** (`.pdf`)
  - Extrait le contenu texte avec les informations de mise en page
  - Préserve la structure du document, y compris les sections et les paragraphes
  - Gère les PDF textuels et numérisés (avec prise en charge de l’OCR)
