...
## Formats de documents pris en charge {#supported-document-formats}
...
## Comment utiliser l’analyse de documents {#how-to-use-document-parsing}
...
### Importer des documents avec `/v2/parse` {#upload-documents-with-v2parse}
...
<div id="example-scraping-an-excel-file">
  ### Exemple : extraction d’un fichier Excel {#example-scraping-an-excel-file}
</div>

<ScrapeXLSX />

<div id="example-scraping-a-word-document">
  ### Exemple : Scraper un document Word {#example-scraping-a-word-document}
</div>
