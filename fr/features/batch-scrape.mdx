...
<div id='batch-scrape-with-webhooks'>## Scraping par lot avec webhooks</div>
...
Pour une documentation complète sur les webhooks — y compris les types d’événements, la structure des payloads et des exemples d’implémentation — consultez la [documentation des webhooks](/fr/webhooks/overview).
...
<Note>
  ...
  pratiques de sécurité et le dépannage, consultez la [documentation
