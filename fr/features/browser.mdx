...
## Lancer une session {#launch-a-session}
...
### Gestion des téléchargements de fichiers {#handling-file-downloads}
...
## agent-browser (Mode Bash) {#agent-browser-bash-mode}
...
### Sessions persistantes {#persistent-sessions}
...
### Lister les sessions {#list-sessions}
...
### Configuration du TTL {#ttl-configuration}
...
### Clore une session {#close-a-session}
...
### Vue en direct interactive {#interactive-live-view}
...
## Connexion via CDP {#connecting-via-cdp}
...
## Quand utiliser Browser {#when-to-use-browser}
