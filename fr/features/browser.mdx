...
Par défaut, chaque session de navigateur commence avec un état vierge. Avec `profile`, vous pouvez enregistrer l&#39;état du navigateur entre les sessions. C&#39;est pratique pour rester connecté, conserver les préférences ou reprendre des flux de travail en plusieurs étapes.
