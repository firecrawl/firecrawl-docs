...
La tarification dépend du mode de pilotage de la session : 7 crédits par minute de browser si la session utilise un `prompt`, ou 2 crédits par minute de browser dans le cas contraire (avec du `code` Playwright uniquement). La facturation s&#39;effectue à la minute de browser, avec un minimum d&#39;une minute. Les utilisateurs de l&#39;offre Free bénéficient de 5 heures d&#39;utilisation gratuite.
