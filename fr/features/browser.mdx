...
Le Firecrawl Browser Sandbox offre à vos agents un environnement de navigateur sécurisé et entièrement géré. Aucune configuration locale, aucune installation de Chromium, aucun problème de compatibilité de pilotes. Chaque session s’exécute dans un bac à sable isolé et éphémère, qui peut passer d’un navigateur unique à des centaines, sans avoir à gérer d’infrastructure.
...
| `activityTtl` | 60s | Fermeture automatique après inactivité (10-3600s) |
...
Tarification simple : 100 crédits par heure de navigateur. Les utilisateurs du plan gratuit disposent de 5 heures d&#39;utilisation offertes.
