...
description: "Un bac à sable Browser sécurisé où les agents peuvent interagir avec le web."
og:title: "Browser | Firecrawl"
og:description: "Un bac à sable Browser sécurisé où les agents peuvent interagir avec le web."
icon: "browser"
...
<Info>
  Browser Sandbox s’appelle désormais [Interact](/fr/features/interact), qui offre les mêmes fonctionnalités et peut aussi être contrôlé via des prompts.
</Info>

Firecrawl Browser Sandbox offre à vos agents un environnement de navigateur sécurisé où ils peuvent interagir avec le web. Remplissez des formulaires, cliquez sur des boutons, authentifiez-vous, et plus encore.
...
Pour ajouter la prise en charge du navigateur à un agent de codage IA (Claude Code, Codex, Open Code, Cursor, etc.), installez la compétence Firecrawl :
...
Le nombre de sessions de navigateur simultanées autorisées est déterminé par la limite de concurrence de votre plan d&#39;équipe.
