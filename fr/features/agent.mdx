...
Téléversez votre fichier CSV, rédigez un prompt décrivant les données que vous souhaitez que l’agent trouve pour chaque ligne, définissez vos champs de sortie, puis lancez l’exécution. L’agent traite chaque ligne en parallèle et renseigne les résultats.
