...
Nous offrons 5 exécutions gratuites par jour. Pendant la phase de Research Preview, la tarification est dynamique et basée sur le nombre de tokens utilisés par `/agent`, qui sont ensuite convertis en crédits. Essayez-le [ici](/fr/app/agent).