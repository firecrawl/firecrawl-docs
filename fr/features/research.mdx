...
<Note>
  Pour donner à votre agent accès à l&#39;Index de recherche, nous vous recommandons vivement d&#39;utiliser notre [CLI](/fr/sdks/cli) ou [MCP](/fr/mcp-server/agent-mcp), associé à notre [**skill de recherche dédié**](https://github.com/firecrawl/skills/blob/main/skills/firecrawl-research-index/SKILL.md), que vous pouvez installer avec :
