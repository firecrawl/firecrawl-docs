...
## Comparaison avec `/search` {#how-this-relates-to-search}
...
## Rechercher des articles scientifiques {#search-papers}
...
### Exemple biomédical {#biomedical-example}
...
## Examiner un article {#inspect-a-paper}
...
## Lire des passages d’articles {#read-paper-passages}
...
## Trouver des articles connexes {#find-related-papers}
