...
Utilisez l’index de recherche pour vos recherches bibliographiques : trouver des publications, les lire et suivre les citations. Utilisez [`categories: ["research"]`](/fr/features/search#search-categories) si vous recherchez des pages Web classiques hébergées sur des domaines académiques.
