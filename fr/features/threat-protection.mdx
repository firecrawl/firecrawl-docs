...
## Paramètres de la politique {#policy-controls}
...
### Connexion de votre tenant {#connecting-your-tenant}
...
### Capacité et fonctionnement {#capacity-and-behavior}
...
## Configuration de la politique {#configuring-the-policy}
...
## Dérogations par requête {#per-request-overrides}
...
## Lorsqu’une URL est bloquée {#when-a-url-is-blocked}
