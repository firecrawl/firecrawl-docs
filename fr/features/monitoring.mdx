...
peut extraire des résultats pertinents du webhook `monitor.page` :
...
L&#39;intervalle minimal est de 15 minutes. Les réponses de l&#39;API renvoient toujours l&#39;expression cron normalisée. Les planifications en texte libre sont réparties selon l&#39;identifiant du moniteur avant d&#39;être converties en cron, afin que de nombreux moniteurs ne s&#39;exécutent pas tous au même instant.
