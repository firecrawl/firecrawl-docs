...
## Choisissez le bon modèle d’interaction {#choose-the-right-interaction-model}
...
## Interagir par prompt {#interact-via-prompting}
...
### Gardez les prompts courts et ciblés {#keep-prompts-small-and-focused}
...
## Exécution de code {#running-code}
...
## Profils persistants avec Scrape + Interact {#persistent-profiles-with-scrape-interact}
...
### Vérifier la persistance {#validate-persistence}
...
### Corps de la requête (POST) {#request-body-post}
