---
title: 'Parse'
description: 'Importez un document local ou non public et convertissez-le en données propres, prêtes pour les LLM'
og:title: "Parse | Firecrawl"
og:description: "Convertissez des PDF, DOCX, XLSX, HTML locaux et bien plus encore en Markdown ou en JSON structuré"
icon: "file-magnifying-glass"
version: "v2"
sidebarTitle: "Parse"
---

<div id="introducing-parse">
