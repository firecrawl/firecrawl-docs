...
## Markdown par page (PDF) {#per-page-markdown-pdf}
...
## Marqueurs de page (PDF) {#page-markers-pdf}
...
## Blocs de mise en page (PDF) {#layout-blocks-pdf}
...
### Ancrage : d’une réponse à la page {#grounding-from-an-answer-back-to-the-page}
...
## Sortie JSON structurée {#structured-json-output}
...
## Options pour les PDF {#pdf-options}
...
## Référence de la requête {#request-reference}
