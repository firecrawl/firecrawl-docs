---
title: 'Parse'
description: 'Convertissez des documents — PDF, Word, Excel, PowerPoint et bien d’autres — en markdown propre, contenu par page, blocs de mise en page et JSON structuré'
...
chaîne markdown ne suffit pas : le [markdown par page](#per-page-markdown-pdf) et les
[blocs de mise en page](#layout-blocks-pdf) pour les documents PDF, et le
[JSON structuré](#structured-json-output) pour tous les formats.
...
| `pages`    | `boolean`                   | `false`         | Renvoie également le [Markdown par page](#per-page-markdown-pdf). Aucun coût supplémentaire.                                    |
