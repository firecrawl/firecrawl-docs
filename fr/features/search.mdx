...
L’API de recherche de Firecrawl vous permet d’effectuer des recherches sur le web avec Google et, si vous le souhaitez, de scraper les résultats en une seule opération.
