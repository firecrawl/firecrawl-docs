...
L’utilisation de ce point de terminaison coûte 1 crédit par résultat de recherche. Il n’y a pas de frais supplémentaires pour les scrapes de base de chaque résultat de recherche.
