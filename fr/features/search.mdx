...
Utilisez les opérateurs d'images pour trouver des images en haute résolution :
...
- **Stealth proxy mode** : 4 crédits supplémentaires par page web
...
- Utilisez `proxy: "basic"` plutôt que `"stealth"` lorsque possible, ou réglez-le sur `"auto"`
