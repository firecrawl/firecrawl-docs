...
<div id="performing-a-search-with-firecrawl">
  ## Effectuer une recherche avec Firecrawl {#performing-a-search-with-firecrawl}
</div>

<div id="search-endpoint">
  ### point de terminaison /search {#search-endpoint}
</div>
...
<div id="search-result-types">
  ## Types de résultats de recherche {#search-result-types}
</div>
...
## Catégories de recherche {#search-categories}
...
### Recherche par catégorie {#research-category-search}
...
### Recherche par catégorie dans l’index développeur {#developer-category-search}
...
<div id="mixed-category-search">
  ### Recherche multi-catégories {#mixed-category-search}
</div>
...
<div id="domain-filters">
  ## Filtres de domaines {#domain-filters}
</div>
...
<div id="include-domains">
  ### Domaines à inclure {#include-domains}
</div>
...
<div id="exclude-domains">
  ### Domaines à exclure {#exclude-domains}
</div>
...
### Format de réponse par catégorie {#category-response-format}
...
<div id="hd-image-search-with-size-filtering">
  ### Recherche d’images HD avec filtre de taille {#hd-image-search-with-size-filtering}
</div>
...
<div id="search-with-content-scraping">
  ## Recherche avec extraction de contenu {#search-with-content-scraping}
</div>
...
<div id="response-with-scraped-content">
  ### Réponse avec contenu extrait {#response-with-scraped-content}
</div>
...
<div id="search-then-scrape-two-step-pattern">
  ## Recherche puis scraping (schéma en deux étapes) {#search-then-scrape-two-step-pattern}
</div>
...
<div id="advanced-search-options">
  ## Options de recherche avancées {#advanced-search-options}
</div>
...
<div id="location-customization">
  ### Personnalisation de la localisation {#location-customization}
</div>
...
### Recherche par plage temporelle {#time-based-search}
...
### Délai d’attente personnalisé {#custom-timeout}
...
<div id="end-to-end-zdr">
  ### ZDR de bout en bout {#end-to-end-zdr}
</div>
...
### Combiner la recherche ZDR avec Scrape ZDR {#combining-search-zdr-with-scrape-zdr}
...
<div id="cost-implications">
  ## Impact sur les coûts {#cost-implications}
</div>
...
<div id="advanced-scraping-options">
  ## Options de scraping avancées {#advanced-scraping-options}
</div>
...
## Performances mesurées {#measured-performance}
...
## Commentaires sur la recherche {#search-feedback}
