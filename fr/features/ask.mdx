...
## Deux points de terminaison {#two-endpoints}
...
### Déboguer un crawl qui échoue {#debug-a-failing-crawl}
...
### Rechercher dans la documentation {#search-the-docs}
...
## Déboguer une tâche ayant échoué {#debug-a-failed-job}
...
### Ce qu’Ask vérifie en cas d’échecs courants {#what-ask-checks-for-common-failures}
...
### Déboguer depuis les journaux d’activité {#debug-from-activity-logs}
...
## Utiliser Ask dans votre agent {#using-ask-in-your-agent}
...
### Exemple en Python {#python-example}
...
### Exemple en Node.js {#nodejs-example}
...
### réponse de `/support/ask` {#supportask-response}
...
### réponse de `/support/docs-search` {#supportdocs-search-response}
