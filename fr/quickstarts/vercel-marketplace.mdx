...
## Ce que fait l’intégration {#what-the-integration-does}
...
## Installer depuis Vercel {#install-from-vercel}
...
## Interagir avec des pages dynamiques {#interact-with-dynamic-pages}
...
## Utiliser Firecrawl avec le Vercel AI SDK {#use-firecrawl-with-the-vercel-ai-sdk}
