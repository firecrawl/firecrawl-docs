...
## Scraper + résumer avec n’importe quel modèle OpenRouter {#scrape-summarize-with-any-openrouter-model}
...
## Appel d’outils : le modèle décide quand scraper {#tool-calling-model-decides-when-to-scrape}
