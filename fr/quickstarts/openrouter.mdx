...
* Bon nombre des principales applications OpenRouter (Cline, Roo Code, Kilo, Cursor, Continue) sont elles-mêmes des intégrations pour agent capables d’utiliser Firecrawl MCP — voir [Agent MCP](/fr/mcp-server/agent-mcp) pour intégrer directement Firecrawl à celles-ci.
