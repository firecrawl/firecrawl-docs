...
* De nombreuses applications OpenRouter de premier plan (Cline, Roo Code, Kilo, Cursor, Continue) sont elles-mêmes des frameworks d’agents pouvant utiliser Firecrawl MCP — voir [MCP Server](/fr/mcp-server) pour y connecter directement Firecrawl.
* Pour les tâches de grande ampleur, utilisez [scraper par lot](/fr/features/batch-scrape) pour rester dans le budget de contexte du LLM.