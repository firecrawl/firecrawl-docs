...
### Étape 1 — Scrapez pour démarrer une session {#step-1-scrape-to-start-a-session}
...
### Étape 2 — Envoyer les interactions {#step-2-send-interactions}
...
### Étape 3 — Mettre fin à la session {#step-3-stop-the-session}
...
## Fonction utilitaire réutilisable {#reusable-helper}
