...
<div id="scrape-formats">
  ## Formats de scrape {#scrape-formats}
</div>
...
<div id="introducing-map-alpha">
  ## Présentation de /map (Alpha) {#introducing-map-alpha}
</div>
...
<div id="new-crawl-webhook">
  ## Nouveau webhook de crawl {#new-crawl-webhook}
</div>
...
<div id="webhook-events">
  ### Événements de webhook {#webhook-events}
</div>
...
<div id="webhook-response">
  ### Réponse du webhook {#webhook-response}
</div>
...
<div id="migrating-from-v0">
  ## Migration depuis V0 {#migrating-from-v0}
</div>
...
<div id="details-on-the-new-request-body">
  ### Détails sur le nouveau corps de requête {#details-on-the-new-request-body}
</div>
...
<div id="crawl-endpoint">
  ## point de terminaison /crawl {#crawl-endpoint}
</div>
...
<div id="details-on-the-new-request-body-2">
  ### Détails sur le nouveau corps de requête {#details-on-the-new-request-body-2}
</div>
