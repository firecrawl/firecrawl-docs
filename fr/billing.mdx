...
Si vous avez occasionnellement besoin de plus de crédits que ceux inclus dans votre offre, vous pouvez activer la **recharge automatique** depuis le tableau de bord. Lorsque vos crédits restants passent sous zéro, Firecrawl achète automatiquement un pack de crédits supplémentaire et l&#39;ajoute à votre solde. Notez que cette vérification a lieu lorsque vous effectuez une requête API — votre solde ne sera pas réapprovisionné tant qu&#39;une nouvelle requête ne déclenchera pas la recharge.
