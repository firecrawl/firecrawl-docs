...
| Mode              | Point de terminaison | Idéal pour                                                       | Identifiants                                |
| ----------------- | -------------------- | ---------------------------------------------------------------- | ------------------------------------------- |
| Compte            | `/v2/mcp-oauth`      | Clients interactifs pouvant effectuer l’OAuth dans le navigateur | Jetons OAuth gérés par le client            |
| Sans intervention | `/v2/mcp`            | CI, serveurs et scripts                                          | `Authorization: Bearer <FIRECRAWL_API_KEY>` |
| Sans clé          | `/v2/mcp`            | Un essai limité                                                  | Aucun                                       |
