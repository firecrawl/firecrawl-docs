...
Ces outils ne sont pas disponibles dans l&#39;offre hébergée sans clé. Pour les tickets GitHub, les pull requests fusionnées et les README, utilisez [`firecrawl_developer_search`](#12b-developer-search-tool-firecrawl_developer_search).
...
Interrogez directement le [Developer Index](/fr/features/developer) : tickets GitHub, pull requests fusionnées, README de dépôts et sites de documentation sélectionnés. En lecture seule, il renvoie des résultats classés avec les passages correspondants.
