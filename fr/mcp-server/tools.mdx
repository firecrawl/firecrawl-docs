...
Commencez par [Agent MCP](/fr/mcp-server/agent-mcp) ou [Human MCP](/fr/mcp-server/human-mcp) pour choisir un accès OAuth, par clé API ou sans clé. Certains outils facultatifs peuvent être désactivés par l’environnement ou la politique de l’équipe.
