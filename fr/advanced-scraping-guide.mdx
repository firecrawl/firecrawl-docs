...
| `model`                 | `string`  | `"spark-2"`       | Modèle d&#39;IA à utiliser : `"spark-2"` (par défaut, le moins cher et le plus rapide), `"spark-1-mini"` (60 % moins cher que Pro) ou `"spark-1-pro"` (meilleure précision).                                                                                                |
