...
## Scraping basique {#basic-scraping}
...
<div id="mobile-scraping">
  ### Scraping mobile {#mobile-scraping}
</div>
...
<div id="content-filtering">
  ### Filtrage du contenu {#content-filtering}
</div>
...
<div id="timing-and-cache">
  ### Timing et cache {#timing-and-cache}
</div>
...
<div id="action-execution-notes">
  #### Notes sur l’exécution des actions {#action-execution-notes}
</div>
...
<div id="advanced-action-examples">
  #### Exemples d’actions avancées {#advanced-action-examples}
</div>
...
<div id="full-scrape-example">
  ### Exemple d’extraction complète {#full-scrape-example}
</div>
...
## Extraction de JSON via `formats` {#json-extraction-via-formats}
...
<div id="agent-endpoint">
  ## Point de terminaison de l’agent {#agent-endpoint}
</div>
...
<div id="check-agent-status">
  ### Vérifier l&#39;état de l&#39;agent {#check-agent-status}
</div>
...
## Crawl de plusieurs pages {#crawling-multiple-pages}
...
### Vérifier l’état d’une tâche de crawl {#check-crawl-job}
...
### Aperçu du prompt et des paramètres de crawl {#crawl-prompt-and-params-preview}
...
<div id="path-filtering">
  #### Filtrage des chemins {#path-filtering}
</div>
...
<div id="sitemap-and-deduplication">
  #### Sitemap et déduplication {#sitemap-and-deduplication}
</div>
...
<div id="scrape-options-for-crawl">
  #### Options de scrape pour le crawl {#scrape-options-for-crawl}
</div>
...
<div id="crawl-example">
  ### Exemple de crawl {#crawl-example}
</div>
...
## Cartographie des liens d’un site web {#mapping-website-links}
...
<div id="whitelisting-firecrawl">
  ## Autoriser Firecrawl {#whitelisting-firecrawl}
</div>

### Autoriser Firecrawl à scraper votre site web {#allowing-firecrawl-to-scrape-your-website}
...
<div id="allowing-your-application-to-call-the-firecrawl-api">
  ### Autoriser votre application à appeler l&#39;API Firecrawl {#allowing-your-application-to-call-the-firecrawl-api}
</div>
