...
## Présentation de l’intégration Dify {#dify-integration-overview}
...
## Outils Firecrawl dans Dify {#firecrawl-tools-in-dify}
...
## Dify et les autres plateformes {#dify-vs-other-platforms}
...
## Synchroniser des sites web dans la base de connaissances de Dify {#sync-websites-into-the-dify-knowledge-base}
...
### Configuration de Firecrawl {#configuring-firecrawl}
...
### Scraper la page web cible {#scrape-the-target-webpage}
