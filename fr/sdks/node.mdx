...
<div id="crawling-a-website">
  ### Crawl d’un site web {#crawling-a-website}
</div>
...
<div id="sitemap-only-crawl">
  ### Crawl uniquement via le sitemap {#sitemap-only-crawl}
</div>
...
### Exécuter un agent {#running-an-agent}
...
### Crawler un site web avec WebSockets {#crawling-a-website-with-websockets}
...
<div id="simple-crawl-auto-pagination-default">
  ##### Exploration simple (pagination automatique, par défaut) {#simple-crawl-auto-pagination-default}
</div>
...
<div id="manual-crawl-with-pagination-control-single-page">
  ##### Crawl manuel avec contrôle de la pagination (page unique) {#manual-crawl-with-pagination-control-single-page}
</div>
...
<div id="simple-batch-scrape-auto-pagination-default">
  ##### Collecte par lots simple (pagination automatique, par défaut) {#simple-batch-scrape-auto-pagination-default}
</div>
...
<div id="manual-batch-scrape-with-pagination-control-single-page">
  ##### Scraping par lots manuel avec contrôle de la pagination (page unique) {#manual-batch-scrape-with-pagination-control-single-page}
</div>
...
<div id="manual-batch-scrape-with-limits-auto-pagination-early-stop">
  ##### Scrape manuel par lots avec limites (pagination automatique + arrêt anticipé) {#manual-batch-scrape-with-limits-auto-pagination-early-stop}
</div>
...
### Session interactive liée au scraping {#scrape-bound-interactive-session}
