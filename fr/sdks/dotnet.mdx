...
### Effectuer un crawl sur un site web {#crawling-a-website}
...
#### Extraction par lot avec clé d’idempotence {#batch-scrape-with-idempotency-key}
...
## Compatibilité async {#async-support}
