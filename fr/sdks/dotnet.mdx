...
Le SDK .NET officiel est maintenu dans le monorepo de Firecrawl à l’emplacement [apps/.net-sdk](https://github.com/firecrawl/firecrawl/tree/main/apps/.net-sdk).
...
<Tabs>
  ...
  <Tab title="Gestionnaire de packages">`powershell Install-Package firecrawl-sdk `</Tab>
