...
Effectuez des recherches, scrapez et interagissez avec le web directement depuis le terminal. La CLI Firecrawl fonctionne de manière autonome ou comme une skill que des agents de codage IA comme Claude Code, Antigravity et OpenCode peuvent découvrir et utiliser automatiquement.
