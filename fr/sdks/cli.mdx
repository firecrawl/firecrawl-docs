...
### Afficher la configuration {#view-configuration}
...
### Connecter la CLI à Firecrawl auto-hébergé {#connect-the-cli-to-self-hosted-firecrawl}
...
#### Options de la commande Map {#map-options}
...
#### Consulter l&#39;état du crawl {#check-crawl-status}

<CrawlStatus />

#### Options de crawl {#crawl-options}
...
### Utilisation des crédits {#credit-usage}
...
## Gestion de la sortie {#output-handling}
...
### Comportement des formats {#format-behavior}
...
### Exploration complète du site {#full-site-crawl}
...
### Découverte de sites web {#site-discovery}
...
### Flux de recherche {#research-workflow}
...
### Combiner avec d&#39;autres outils {#combine-with-other-tools}
