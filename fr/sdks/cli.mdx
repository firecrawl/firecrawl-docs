...
| `--model <model>`           | Modèle à utiliser : `spark-1-pro` (par défaut, meilleure précision), `spark-1-mini` (60 % moins cher que Pro) ou `spark-2` (le moins cher et le plus rapide) |
