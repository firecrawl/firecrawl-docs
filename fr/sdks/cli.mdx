---
title: 'Skills + CLI'
description: "Firecrawl Skills est un moyen simple pour les agents IA d'utiliser Firecrawl via la CLI. Ils peuvent ainsi obtenir des données web via une interface plus efficace et mieux optimisée pour le contexte."
icon: 'terminal'
...
Si vous l&#39;utilisez dans un agent IA comme Claude Code, vous pouvez installer le skill Firecrawl et l&#39;agent pourra le télécharger et le configurer pour vous.
