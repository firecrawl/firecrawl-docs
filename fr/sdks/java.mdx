...
### Analyse des fichiers importés {#parsing-uploaded-files}
...
#### Extraction de JSON {#json-extraction}
...
### Effectuer un crawl d’un site web {#crawling-a-website}
...
### Vérification de l’état d’un crawl {#checking-crawl-status}
...
### Mapping d’un site web {#mapping-a-website}
...
### Session interactive liée à un scrape {#scrape-bound-interactive-session}
...
### Lister &amp; fermer les sessions {#list-close-sessions}
