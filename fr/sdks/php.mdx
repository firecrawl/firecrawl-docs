...
### Intégration Laravel {#laravel-integration}
...
### Utiliser la façade Laravel {#using-the-laravel-facade}
...
### Effectuer le crawl d’un site web {#crawling-a-website}
...
### Vérification de l’état du crawl {#checking-crawl-status}
...
### Rechercher sur le Web {#searching-the-web}
...
## Outils du Laravel AI SDK {#laravel-ai-sdk-tools}
...
### Paramètres de l’outil {#tool-parameters}
...
### Comportement de l’outil {#tool-behavior}
...
### Résultats du crawl {#crawl-results}
...
### Lister et fermer les sessions {#list-close-sessions}
