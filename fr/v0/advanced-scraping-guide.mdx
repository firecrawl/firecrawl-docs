...
## Scraping simple avec Firecrawl (/scrape) {#basic-scraping-with-firecrawl-scrape}
...
<div id="scraping-pdfs">
  ## Extraction des PDF {#scraping-pdfs}
</div>
...
<div id="getting-cleaner-content-with-onlymaincontent">
  ### Obtenir un contenu plus propre avec `onlyMainContent` {#getting-cleaner-content-with-onlymaincontent}
</div>
...
<div id="getting-the-html-with-includehtml">
  ### Obtenir le HTML avec `includeHtml` {#getting-the-html-with-includehtml}
</div>
...
<div id="getting-the-raw-html-with-includerawhtml">
  ### Récupérer le HTML brut avec `includeRawHtml` {#getting-the-raw-html-with-includerawhtml}
</div>
...
<div id="getting-a-screenshot-of-the-page-with-screenshot">
  ### Obtenir une capture d’écran de la page avec `screenshot` {#getting-a-screenshot-of-the-page-with-screenshot}
</div>
...
<div id="waiting-for-the-page-to-load-with-waitfor">
  ### Attendre le chargement de la page avec `waitFor` {#waiting-for-the-page-to-load-with-waitfor}
</div>
...
<div id="extractor-options">
  ## Options de l’extracteur {#extractor-options}
</div>
...
<div id="example-usage-2">
  ### Exemple d’usage {#example-usage-2}
</div>
...
<div id="adjusting-timeout">
  ## Régler le délai d’expiration {#adjusting-timeout}
</div>
...
<div id="check-crawl-job">
  ### Vérifier un job de crawl {#check-crawl-job}
</div>
...
<div id="example-usage-4">
  ### Exemple d’usage {#example-usage-4}
</div>
...
<div id="page-options-crawler-options">
  ## Options de page + options du crawler {#page-options-crawler-options}
</div>
...
<div id="example-usage-5">
  ### Exemple d’utilisation {#example-usage-5}
</div>
...
<div id="extractor-options-crawler-options">
  ## Options de l’extracteur + options du crawler {#extractor-options-crawler-options}
</div>
