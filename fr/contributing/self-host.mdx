...
## Choisir entre l’auto-hébergement et Firecrawl Cloud {#choose-self-hosting-or-firecrawl-cloud}

### Auto-hébergez Firecrawl si {#self-host-firecrawl-when}
...
### Ce qu’implique l’auto-hébergement {#what-self-hosting-requires}
...
## Auto-hébergez Firecrawl avec Docker Compose {#self-host-firecrawl-with-docker-compose}

### Commencez avec ces valeurs par défaut {#start-with-these-defaults}
...
### Clonez la version validée {#clone-the-verified-release}
...
### Configurer le déploiement d’évaluation {#configure-the-evaluation-deployment}
...
### Créer et démarrer Firecrawl {#build-and-start-firecrawl}
...
### Vérifier l’accessibilité de l’API {#check-api-reachability}
...
### Effectuer un test de validation fonctionnel {#run-a-functional-smoke-test}
...
## Prise en charge des fonctionnalités en auto-hébergement {#self-hosted-feature-support}
...
## Avant la production {#before-production}
...
## Étapes suivantes {#where-to-go-next}
...
### Vous contournez l’authentification {#youre-bypassing-authentication}
...
### Les conteneurs Docker ne démarrent pas {#docker-containers-fail-to-start}
...
### Problèmes de connexion à Redis {#connection-issues-with-redis}
...
### Le point de terminaison de l’API ne répond pas {#api-endpoint-does-not-respond}
...
### La requête de scrape expire {#scrape-request-times-out}
