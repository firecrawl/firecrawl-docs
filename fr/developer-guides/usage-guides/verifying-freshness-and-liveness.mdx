...
## Le compromis fraîcheur/latence (`maxAge`) {#the-freshness-tradeoff-maxage}
...
### Cas d’application de `maxAge` {#where-maxage-applies}
...
## La fraîcheur ne garantit pas l’activité {#freshness-is-not-liveness}
...
## Liste de contrôle pour les actions sensibles à la fraîcheur des données {#freshness-sensitive-action-checklist}
...
## Exemple détaillé : collecter les éléments de preuve de la page actuelle {#worked-example-collect-current-page-evidence}
