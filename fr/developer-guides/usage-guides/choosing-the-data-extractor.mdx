...
### Cas d’usage idéal : recherche et découverte autonomes {#best-use-case-autonomous-research-discovery}
...
### Caractéristiques clés {#key-characteristics-2}
...
### La limitation liée aux URL {#the-url-limitation}
...
### Cas d’utilisation idéal : extraction ciblée sur plusieurs pages {#best-use-case-targeted-multi-page-extraction}
...
## 3. Endpoint `/scrape` avec mode JSON {#3-scrape-endpoint-with-json-mode}
...
### Caractéristiques principales {#key-characteristics-3}
...
### Cas d’utilisation idéal : extraction précise sur une seule page {#best-use-case-single-page-precision-extraction}
...
### Recommandations par scénario {#recommendations-by-scenario}
...
### Exemple : « Trouver les fondateurs de Firecrawl » {#example-find-the-founders-of-firecrawl}
