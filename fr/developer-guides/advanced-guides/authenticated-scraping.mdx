...
description: "Apprenez à extraire du contenu derrière une authentification à l'aide de cookies"
---
...
const result = await app.scrape("https://firecrawl-auth.vercel.app/dashboard", {
  ...
  waitFor: 3000, // Attendre 3 secondes supplémentaires pour le chargement de la page
});
