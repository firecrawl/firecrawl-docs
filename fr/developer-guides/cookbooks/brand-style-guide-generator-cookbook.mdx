...
<div id="what-youll-build">
  ## Ce que vous allez créer {#what-youll-build}
</div>
...
### Comprendre le code {#understanding-the-code}
    </div>
...
<div id="extraction-process">
  ### Processus d'extraction {#extraction-process}
</div>
...
<div id="pdf-generation-process">
  ### Processus de génération de PDF {#pdf-generation-process}
</div>
...
<div id="automatic-color-extraction">
  ### Extraction automatique des couleurs {#automatic-color-extraction}
</div>
...
<div id="typography-documentation">
  ### Documentation de la typographie {#typography-documentation}
</div>
...
<div id="add-component-documentation">
  ### Ajouter la documentation des composants {#add-component-documentation}
</div>
...
<div id="export-multiple-formats">
  ### Exporter plusieurs formats {#export-multiple-formats}
</div>
...
<div id="custom-pdf-themes">
  ### Thèmes PDF personnalisés {#custom-pdf-themes}
</div>
