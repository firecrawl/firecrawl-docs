...
### Installer les packages de l’AI SDK {#install-ai-sdk-packages}
...
### Installer AI Elements {#install-ai-elements}
...
### Installer le fournisseur OpenAI {#install-openai-provider}
...
### Comprendre le Frontend {#understanding-the-frontend}
...
### Installer le SDK Firecrawl {#install-firecrawl-sdk}
...
### Créer le fichier des outils {#create-the-tools-file}
...
### Comprendre les outils {#understanding-the-tools}
...
<div id="message-flow">
  ### Flux des messages {#message-flow}
</div>
...
<div id="tool-calling-process">
  ### Processus d’appel d’outils {#tool-calling-process}
</div>
...
<div id="web-search-toggle">
  ### Interrupteur de recherche web {#web-search-toggle}
</div>
...
<div id="customization-ideas">
  ## Idées de personnalisation {#customization-ideas}
</div>

<div id="add-more-tools">
  ### Ajouter d’autres outils {#add-more-tools}
</div>
...
<div id="change-the-ai-model">
  ### Changer le modèle d’IA {#change-the-ai-model}
</div>
...
<div id="customize-the-ui">
  ### Personnaliser l’interface {#customize-the-ui}
</div>
