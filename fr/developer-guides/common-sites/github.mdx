...
Extrayez des données structurées à partir de dépôts en utilisant des schémas Zod.
...
Découvrez toutes les URL disponibles dans un dépôt ou un site de documentation. Remarque : Cartographie renvoie uniquement des URL, sans contenu.
...
Explorer plusieurs pages depuis un dépôt ou une documentation.
...
Récupérez plusieurs URL GitHub simultanément.
