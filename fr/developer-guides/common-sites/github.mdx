...
Extrayez des données structurées depuis des dépôts à l&#39;aide de schémas Zod.
...
Recherchez des dépôts, des tickets ou de la documentation sur GitHub.
...
Découvrez toutes les URL disponibles dans un dépôt ou un site de documentation. Remarque : Map renvoie uniquement les URL, sans contenu.
...
Explorez plusieurs pages depuis un dépôt ou une documentation.
...
Extrayez le contenu de plusieurs URL GitHub simultanément.
...
<div id="batch-scrape-with-json-mode">
  ## Extraction en lot avec le mode JSON
</div>

Extrayez des données structurées à partir de plusieurs dépôts simultanément.
