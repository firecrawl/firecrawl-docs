...
<CardGroup cols={2}>
  <Card title="Guide complet pour créer des agents IA avec Google Agent Development Kit (ADK) et Firecrawl" href="https://www.firecrawl.dev/blog/google-adk-multi-agent-tutorial">
    Découvrez comment créer des systèmes d’IA multi-agents performants en utilisant le framework ADK de Google, avec Firecrawl pour le web scraping.
  </Card>

  <Card title="Documentation du serveur MCP" href="https://docs.firecrawl.dev/mcp-server/agent-mcp">
