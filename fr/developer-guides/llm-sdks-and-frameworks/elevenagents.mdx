...
Donnez à vos agents vocaux et conversationnels [ElevenAgents](https://elevenlabs.io/agents) la capacité de scraper, de rechercher et de crawl le web en temps réel avec Firecrawl. Ce guide couvre deux approches d&#39;intégration :
...
* [serveur MCP Firecrawl](https://docs.firecrawl.dev/mcp-server/agent-mcp)