...
* Utilisez **Get Agent Status** pour sonder les résultats lorsque vous utilisez le mode Async
...
* **Agent (Sync)** démarre la tâche et attend le résultat en une seule étape — le plus simple pour la plupart des cas d’usage.
...
* [Firecrawl Discord](https://discord.gg/gSmWdAkdwd) - Obtenez de l’aide sur Firecrawl et discutez de web scraping
