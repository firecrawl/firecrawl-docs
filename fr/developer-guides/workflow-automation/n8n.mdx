...
<Tip>
  **Utilisateurs de n8n Cloud :** Au lieu de saisir manuellement une clé API, vous pouvez utiliser le bouton OAuth **« Connect to Firecrawl »** en un clic lors de l’ajout du nœud Firecrawl. Cela crée automatiquement une nouvelle équipe Firecrawl liée à votre compte n8n et vous accorde **100 000 crédits gratuits**. Pour consulter ces crédits dans le [tableau de bord Firecrawl](https://www.firecrawl.dev/app/usage), assurez-vous de basculer vers votre équipe liée à n8n à l’aide du sélecteur d’équipe dans le coin supérieur gauche.
</Tip>
