...
Vous choisissez la configuration au moment de créer l&#39;intégration. Ajouter ou retirer Gateway par la suite nécessite de contacter Firecrawl. Consultez la [page Partner API](https://www.firecrawl.dev/partner-program) pour une vue d&#39;ensemble.
