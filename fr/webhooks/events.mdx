...
## Structure du payload {#payload-structure}
...
## Événements de crawl {#crawl-events}
...
## Événements de scraping par lot {#batch-scrape-events}
...
## Événements de Monitor {#monitor-events}
...
## Événements d’extraction {#extract-events}
...
## Événements des agents {#agent-events}
