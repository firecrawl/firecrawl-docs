...
<div id="scraping-a-url-with-firecrawl">
  ## Scraper une URL avec Firecrawl {#scraping-a-url-with-firecrawl}
</div>
...
<div id="extracting-without-schema-new">
  ### Extraction sans schéma (Nouveau) {#extracting-without-schema-new}
</div>
...
<div id="json-options-object">
  ### Objet d’options JSON {#json-options-object}
</div>
...
<div id="using-fire-1-with-scrape">
  ## Utiliser FIRE-1 avec Scrape {#using-fire-1-with-scrape}
</div>
...
<div id="example-usage-with-scrape-endpoint">
  ### Exemple d’utilisation avec le point de terminaison /scrape {#example-usage-with-scrape-endpoint}
</div>
