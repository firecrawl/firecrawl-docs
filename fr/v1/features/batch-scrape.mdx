...
Pour une documentation complète sur les webhooks, incluant les types d’événements, la structure des charges utiles et des exemples d’implémentation, consultez la [documentation des webhooks](/fr/features/webhooks).
...
<Note>
  Pour connaître la configuration détaillée des webhooks, les bonnes pratiques de sécurité et les procédures de dépannage, consultez la [documentation sur les webhooks](/fr/features/webhooks).
</Note>
