...
<div id="git-diff-results-example">
  ### Exemple de résultats Git diff : {#git-diff-results-example}
</div>
...
<div id="json-comparison-results-example">
  ### Exemple de résultats de comparaison au format JSON : {#json-comparison-results-example}
</div>
...
<div id="typescript-interface">
  ### Interface TypeScript {#typescript-interface}
</div>
...
<div id="advanced-options-2">
  ### Options avancées {#advanced-options-2}
</div>
...
<div id="python-data-model">
  ### Modèle de données Python {#python-data-model}
</div>
...
<div id="important-facts">
  ## Faits importants {#important-facts}
</div>
...
<div id="basic-scrape-example">
  ### Exemple de scraping simple {#basic-scrape-example}
</div>
...
<div id="tracking-product-price-changes">
  ### Suivi des variations de prix des produits {#tracking-product-price-changes}
</div>
...
<div id="monitoring-content-changes-with-git-diff">
  ### Suivi des modifications de contenu avec git diff {#monitoring-content-changes-with-git-diff}
</div>
