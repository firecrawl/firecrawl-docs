...
<div id="faster-crawling">
  ## Exploration plus rapide {#faster-crawling}
</div>
...
<div id="crawl-websocket">
  ## WebSocket de crawl {#crawl-websocket}
</div>
...
<div id="crawl-webhook">
  ## Webhook de crawl {#crawl-webhook}
</div>
