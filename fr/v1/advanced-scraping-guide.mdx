...
<div id="basic-scraping-with-firecrawl-scrape">
  ## Scraping de base avec Firecrawl (/scrape) {#basic-scraping-with-firecrawl-scrape}
</div>
...
<div id="scraping-pdfs">
  ## Extraction de PDF {#scraping-pdfs}
</div>
...
<div id="scrape-options">
  ## Options de scraping {#scrape-options}
</div>
...
<div id="setting-the-content-formats-on-response-with-formats">
  ### Définir les formats de contenu dans la réponse avec `formats` {#setting-the-content-formats-on-response-with-formats}
</div>
...
<div id="getting-the-full-page-content-as-markdown-with-onlymaincontent">
  ### Obtenir l’intégralité du contenu de la page en markdown avec `onlyMainContent` {#getting-the-full-page-content-as-markdown-with-onlymaincontent}
</div>
...
<div id="setting-the-tags-to-include-with-includetags">
  ### Définir les balises à inclure avec `includeTags` {#setting-the-tags-to-include-with-includetags}
</div>
...
<div id="setting-the-tags-to-exclude-with-excludetags">
  ### Définir les balises à exclure avec `excludeTags` {#setting-the-tags-to-exclude-with-excludetags}
</div>
...
<div id="waiting-for-the-page-to-load-with-waitfor">
  ### Attente du chargement de la page avec `waitFor` {#waiting-for-the-page-to-load-with-waitfor}
</div>
...
<div id="setting-the-maximum-timeout">
  ### Définition du `timeout` maximum {#setting-the-maximum-timeout}
</div>
...
<div id="parsing-pdf-files-with-parsepdf">
  ### Analyse des fichiers PDF avec `parsePDF` {#parsing-pdf-files-with-parsepdf}
</div>
...
<div id="extractor-options">
  ## Options d’extraction {#extractor-options}
</div>
...
<div id="using-the-llm-extraction">
  ### Utiliser l’extraction LLM {#using-the-llm-extraction}
</div>
...
<div id="example-usage-2">
  ### Exemple d’utilisation {#example-usage-2}
</div>
...
<div id="crawling-multiple-pages">
  ## Explorer plusieurs pages {#crawling-multiple-pages}
</div>
...
<div id="check-crawl-job">
  ### Vérifier une tâche de crawl {#check-crawl-job}
</div>
...
<div id="paginationnext-url">
  #### Pagination/URL suivante {#paginationnext-url}
</div>
...
<div id="crawler-options">
  ### Options du crawler {#crawler-options}
</div>
...
<div id="example-usage-3">
  ### Exemple d’utilisation {#example-usage-3}
</div>
...
<div id="mapping-website-links-with-map">
  ## Cartographie des liens d&#39;un site web avec `/map` {#mapping-website-links-with-map}
</div>
...
<div id="map-options">
  ### Options de cartographie {#map-options}
</div>
