---
title: "Deep Research"
openapi: '/fr/api-reference/v1-openapi.json V1-OPENAPI POST /deep-research'
---
...
Vous cherchez le point de terminaison de statut ? Consultez [Deep Research Status](/fr/api-reference/endpoint/deep-research-get).
...
* Chaque URL = 1 crédit
* Contrôlez l’usage avec le paramètre `maxUrls`