---
title: "Exécuter du code dans le navigateur"
description: "Exécutez du code Playwright dans une session de navigateur cloud active."
openapi: '/fr/api-reference/v2-openapi.json POST /browser/{sessionId}/execute'
---
...
|-----------|------|-------------|-------------------|-------------|
| `code` | string | Oui | - | Code Playwright à exécuter (1-100 000 caractères) |
