...
## Comment `repos` et `sources` définissent le périmètre d’une recherche {#how-repos-and-sources-scope-a-search}
...
## Comment les filtres de dépôt définissent le périmètre d’une recherche {#how-the-repository-filters-scope-a-search}
...
## Valeurs acceptées par `sources` {#which-values-sources-accepts}
