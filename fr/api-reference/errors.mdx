...
| 402  | `Payment Required: Insufficient credits`               | Les crédits de l’offre sont épuisés ou la facturation n’est pas configurée.                                                                                           | Activez la recharge automatique ou passez à une offre supérieure.                                                                                                                                               | Non                           |
