...
<div id="getting-your-claude-and-firecrawl-api-keys">
  ## Obtenir vos clés d’API Claude et Firecrawl {#getting-your-claude-and-firecrawl-api-keys}
</div>
...
<div id="load-website-with-firecrawl">
  ## Charger un site web avec Firecrawl {#load-website-with-firecrawl}
</div>
...
<div id="combination-and-generation">
  ## Combinaison et génération {#combination-and-generation}
</div>
