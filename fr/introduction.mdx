...
<Note>
  **Pour les agents IA :** Ajoutez `.md` à n’importe quelle URL de la documentation pour obtenir la version markdown, par ex. [introduction.md](/fr/introduction.md).
</Note>
...
<Note>
  Redémarrez votre agent après avoir installé la skill. Pour la configuration complète, consultez [Skill + CLI](/fr/sdks/cli).
</Note>
