...
<Visibility for="agents">
  Connectez-vous via Streamable HTTP. L’URL du serveur sans clé (Search, Scrape et Parse ; aucune information d’identification requise) est `https://mcp.firecrawl.dev/v2/mcp`.
  ...
  * ChatGPT ou Claude.ai (connexion au compte) : collez `https://mcp.firecrawl.dev/v2/mcp-oauth` dans les paramètres du connecteur du client.

  Tous les modes de connexion, la configuration de la clé API et les instructions de dépannage : [Configuration MCP](/fr/mcp-server.md).
</Visibility>
...
<CardGroup cols={2}>
  ...
  <Card title="Parse" icon="file-magnifying-glass" href="/fr/features/parse">
    Convertissez des PDF, DOCX, XLSX, HTML locaux et plus encore en Markdown ou en JSON structuré
  </Card>
