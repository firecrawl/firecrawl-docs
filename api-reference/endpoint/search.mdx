...
Eligible keyless responses may include an invitation to submit [endpoint feedback](/api-reference/endpoint/feedback). Use the returned `id` and observations already available from your task. Submitting feedback is optional.
