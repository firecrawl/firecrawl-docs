...
Team endpoints are served under `/v2/team/...`, but their docs slugs drop the `team` prefix. Use this table to map an operation to the right HTTP path and docs page.
...
| Token usage | `GET /v2/team/token-usage` | [`token-usage`](/api-reference/endpoint/token-usage) |
| Token usage (historical) | `GET /v2/team/token-usage/historical` | [`token-usage-historical`](/api-reference/endpoint/token-usage-historical) |
