...
<CardGroup cols={3}>
  <Card title="Scrape" icon="markdown" href="/api-reference/v2-endpoint/scrape" color="FF713C">
    Extract content from any webpage in markdown or json format.
  </Card>
  <Card title="Crawl" icon="spider" href="/api-reference/v2-endpoint/crawl-post" color="FF713C">
    Crawl entire websites, extract their content and metadata.
  </Card>
  <Card title="Map" icon="map" href="/api-reference/v2-endpoint/map" color="FF713C">
    Get a complete list of URLs from any website quickly and reliably.
  </Card>
  <Card title="Search" icon="magnifying-glass" href="/api-reference/v2-endpoint/search" color="FF713C">
...
<CardGroup cols={3}>
  <Card title="Extract" icon="barcode-read" href="/api-reference/v2-endpoint/extract" color="FF713C">
    Extract structured data from entire webpages using natural language.
  </Card>
  {/* <Card title="Deep Research" icon="brain-circuit" href="/api-reference/v2-endpoint/deep-research" color="FF713C">
