...
You can now search web, images, and news all at once:
...
v1 gave you a flat list of results. v2 organizes them by source type:
...
### New Features
- Filter by time ranges like "past week" or "past month" 
- Target specific countries/regions
- Smart filtering keeps results under 500 during alpha
