...
<Note>
**A spend limit applies to credit usage and does not stop Search.** Search requests are metered on a separate search credit meter, so they do not count toward a key's credit limit. Search still consumes your credits: it draws from your search credit allowance first, then from your main credit balance.
</Note>
