...
Auto-reload buys credits in batches of &#36;5. Firecrawl buys a batch when your credit balance reaches zero, and charges your card on file.

Auto-reload needs a paid self-serve plan. You cannot use auto-reload on the free plan.

You can also buy credits yourself at any time. Use **Load more credits** in your [billing settings](https://www.firecrawl.dev/app/settings?tab=billing). Enter a multiple of 5 USD. Firecrawl charges your card on file. This works whether auto-reload is on or off.
...
Enter one of these values, then save:
...
To turn auto-reload on again, enter a multiple of 5 USD.

### How the limit caps your monthly spend

Your limit is the most that auto-reload can spend in one month. Firecrawl rounds it down to whole &#36;5 batches. There is no maximum.
