...
<AccordionGroup>
  ...
  <Accordion title="How does the monthly auto-reload limit work?">
    Your limit caps what auto-reload spends each month. Firecrawl rounds it down to whole &#36;5 batches. A limit of &#36;25 allows five batches each month. Leave your limit blank, and auto-reload has no monthly limit. Set your limit to `0`, and auto-reload turns off.
  </Accordion>
  ...
  <Accordion title="How do I manage my subscription, change plans, or cancel?">
    ...
    To change plans, click **Change Plan** and pick a new tier. Upgrades take effect immediately. Firecrawl schedules downgrades for the end of your current billing period, and you can undo one until then — see [Upgrading and Downgrading](#upgrading-and-downgrading).
