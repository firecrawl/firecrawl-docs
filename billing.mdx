...
Suppose you're on **Hobby 5k** (USD 19 / month or USD 190 / year) and Smart Upgrade moves you to **Hobby 6.5k** (USD 28 / month or USD 290 / year). You receive **1,500 additional credits** immediately (the delta to 6.5k), and the upgrade charge depends on your billing cadence:

- **Monthly plan:** You're billed the full **USD 9** monthly difference (28 − 19) today. Your renewal date is unchanged.
- **Yearly plan, 4 months remaining in your 12-month cycle:** You're billed `(4 ÷ 12) × 100 ≈ USD 33.33` today, where USD 100 is the annual price difference (290 − 190). The remaining 4 months on Hobby 6.5k are covered by this charge, and your renewal date is unchanged.
