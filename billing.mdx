...
<AccordionGroup>
  ...
  <Accordion title="How do I manage my subscription, change plans, or cancel?">
    ...
    To cancel, click **Cancel Subscription**. Your plan stays active until the end of your current billing period, and you can resume it before then. Scale contract tiers and Enterprise plans aren't self-serve — email [help@firecrawl.dev](mailto:help@firecrawl.dev) to change or cancel one.
  </Accordion>
