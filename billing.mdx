...
<Note>
**Capabilities differ from standard scraping.** Grok returns AI-processed results, which may include summaries, key metrics, thread context, and more — not a raw HTML dump. For raw structured data at scale, use the [official X Enterprise API](https://developer.x.com/).
</Note>
