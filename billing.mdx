...
Auto-reload buys credits in batches of &#36;5. When your credit balance reaches zero, auto-reload buys a batch and charges your card on file.
...
Your limit is the most that auto-reload can spend in one month. It rounds down to whole &#36;5 batches. There is no maximum.

For example, a limit of &#36;25 allows five batches each month. A limit of &#36;22 allows four batches, because &#36;22 rounds down to &#36;20.
...
If auto-reload is on, it buys a new &#36;5 batch of credits when your balance reaches zero. Your requests continue.
...
<AccordionGroup>
  ...
  <Accordion title="How does the monthly auto-reload limit work?">
    Your limit caps what auto-reload spends each month. It rounds down to whole &#36;5 batches. A limit of &#36;25 allows five batches each month. Leave your limit blank, and auto-reload has no monthly limit. Set your limit to `0`, and auto-reload turns off.
  </Accordion>
