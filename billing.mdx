...
- **Monthly plan:** You're billed the full **\$9** monthly difference (37 − 28) today. Your renewal date is unchanged.
- **Yearly plan, 4.5 months remaining in your 12-month cycle:** You're billed `(4.5 ÷ 12) × 100 = $37.50` today, where the annual price difference is \$100 (390 − 290). The remaining 4.5 months on Hobby 8k are covered by this charge, and your renewal date is unchanged.
