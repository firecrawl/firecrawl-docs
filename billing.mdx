...
You can also buy credits yourself at any time. Use **Load more credits** in your [billing settings](https://www.firecrawl.dev/app/settings?tab=billing). Enter a multiple of 5 USD. Firecrawl charges the card on file. This works whether auto-reload is on or off.
