...
If you need an invoice reissued with updated billing details (for example, after adding a VAT number, company name, or new billing address), team admins can regenerate any paid invoice directly from the dashboard.

### How to regenerate an invoice

1. Open your [billing settings](https://www.firecrawl.dev/app/settings?tab=billing) and scroll to **Billing History**.
2. Click **Manage Subscriptions** first if you need to update your billing address, company name, or VAT number. Save your changes in the Stripe portal — they will be used for the regenerated PDF.
3. Find the invoice you want to regenerate and click **Regenerate**.
4. Review the **Invoice Details** and **Customer Details** shown in the confirmation modal — these are the values that will appear on the new PDF.
5. Click **Regenerate Invoice**. The updated PDF is downloaded automatically once it is ready.

<Note>
Only **team admins** can regenerate invoices. Other team members will not see the Regenerate action on the Billing History rows.
</Note>

### When to use this

- You added or corrected a **VAT or tax ID** and need it shown on a past invoice.
- You updated your **company name** or **billing address** and want it reflected on previously issued invoices.
- You need a **clean PDF** for accounting, reimbursement, or expense reports with the latest billing details.

If you run into an error while regenerating, or the invoice you need is not paid yet, contact [help@firecrawl.dev](mailto:help@firecrawl.dev).
...
<AccordionGroup>
  ...
  <Accordion title="How do I add a VAT number, company name, or billing address to my invoices?">
    Go to your [billing settings](https://www.firecrawl.dev/app/settings?tab=billing), click **Manage Subscriptions**, and update your billing address, company name, and VAT number in the Stripe portal. Future invoices will automatically include the updated details. To update a past invoice with the new information, use the **Regenerate** action next to the invoice in your Billing History (team admins only). See [Regenerating Invoices](#regenerating-invoices) for details.
  </Accordion>
  <Accordion title="Can I regenerate a past invoice with updated billing details?">
    Yes. Team admins can regenerate any paid invoice from **Settings → Billing → Billing History** by clicking **Regenerate**. The new PDF picks up your current customer details (name, address, VAT/tax IDs). See [Regenerating Invoices](#regenerating-invoices) for the full flow.
  </Accordion>
</AccordionGroup>
