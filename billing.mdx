...
Suppose you're on **Hobby 5k** ($19/month or $190/year) and Smart Upgrade moves you to **Hobby 6.5k** ($28/month or $290/year):

- **Monthly plan:** You're billed the full **$9** monthly difference ($28 − $19) today and receive **1,500 additional credits** (the delta to 6.5k). Your renewal date is unchanged.
- **Yearly plan, 4 months remaining in your 12-month cycle:** You're billed `(4 ÷ 12) × $100 ≈ $33.33` today (where $100 is the annual price difference: $290 − $190) and receive **1,500 additional credits**. The remaining 4 months on Hobby 6.5k are covered by this charge, and your renewal date is unchanged.
