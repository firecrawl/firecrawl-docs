...
If you occasionally need more credits than your plan includes, you can enable **auto-recharge** from the dashboard. When your remaining credits drop below a configurable threshold, Firecrawl automatically purchases an additional credit pack and adds it to your balance. The threshold is a **credit balance** — for example, setting it to 1000 means a recharge is triggered whenever your balance falls below 1,000 credits (it is not a spending limit).
